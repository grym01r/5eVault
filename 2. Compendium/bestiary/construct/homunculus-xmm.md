...
aliases:
- Homunculus
image: ![Homunculi are as varied as...](0.%20DM%20Screen/bestiary/construct/img/homunculus.webp#right "Homunculi are as varied as the magic-users who create them")
tags: monster
---
# Homunculus
...
>      \ DC 12. *Failure:* The target has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
...
>      \ for 1 minute. While [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned), the\
>      \ target has the [Unconscious](0.%20DM%20Screen/conditions.md#Unconscious) condition,\
>      \ which ends early if the target takes any damage."
>    "name": "Bite"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/construct/token/homunculus-xmm.webp"
>```
^statblock
