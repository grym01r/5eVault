...
aliases:
- Brazen Gorgon
image: 2. Compendium/bestiary/construct/img/brazen-gorgon.webp
tags: monster
---
# Brazen Gorgon
...
>"condition_immunities": "[exhaustion](0.%20DM%20Screen/conditions.md#Exhaustion),\
...
>"cr": "9"
>"traits":
>  - "desc": "At the end of each of the gorgon's turns, each creature in a 5-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the gorgon takes 13 (3d8) Fire damage."
>    "name": "Flame Aura"
>  - "desc": "The gorgon sheds [Bright Light](0.%20DM%20Screen/variant-rules/bright-light-xphb.md)\
>      \ in a 10-foot radius and [Dim Light](0.%20DM%20Screen/variant-rules/dim-light-xphb.md)\
...
>    "name": "Gore"
>  - "desc": "The gorgon moves up to its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
...
>      \ and the target is pulled into the gorgon's space and has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ condition (escape DC 14); if the gorgon already has a creature [Grappled](0.%20DM%20Screen/conditions.md#Grappled),\
>      \ the target has the [Prone](0.%20DM%20Screen/conditions.md#Prone) condition\
>      \ instead. Until the grapple ends, the target has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
>      \ condition. When the gorgon moves, the [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ target moves with it, costing no extra movement."
>    "name": "Smelting Charge (Recharge 5-6)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/construct/token/brazen-gorgon-xmm.webp"
>```
^statblock
