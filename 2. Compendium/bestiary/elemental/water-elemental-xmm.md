...
aliases:
- Water Elemental
image: 2. Compendium/books/monster-manual-2025/img/water-elemental.webp
tags: monster
---
# Water Elemental
...
>"cr": "5"
>"traits":
>  - "desc": "If the elemental takes Cold damage, its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
...
>      \ damage. If the target is a Medium or smaller creature, it has the [Prone](0.%20DM%20Screen/conditions.md#Prone)\
>      \ condition."
>    "name": "Slam"
...
>      \ smaller creature, it has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ condition (escape DC 14). Until the grapple ends, the target has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
...
>      \ can pull a creature out of it by succeeding on a DC 14 Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics))\
>      \ check. *Success:* Half damage only."
>    "name": "Whelm (Recharge 4-6)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/elemental/token/water-elemental-xmm.webp"
>```
^statblock
