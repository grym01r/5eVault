...
aliases:
- Marid
image: 2. Compendium/books/monster-manual-2025/img/marid.webp
tags: monster
---
# Marid
...
>  - "desc": "The marid has a 30 percent chance of knowing the [Wish](2.%20Compendium/spells/wish-xphb.md)\
...
>      \ pushed up to 20 feet straight away from the marid and has the [Prone](0.%20DM%20Screen/conditions.md#Prone)\
>      \ condition. *Success:* Half damage only."
>    "name": "Water Jet"
>  - "desc": "The marid casts one of the following spells, requiring no Material components\
>      \ and using Charisma as the spellcasting ability (spell save DC 16):\n\n**At\
>      \ will:** [Create or Destroy Water](2.%20Compendium/spells/create-or-destroy-water-xphb.md),\
>      \ [Detect Evil and Good](2.%20Compendium/spells/detect-evil-and-good-xphb.md),\
>      \ [Detect Magic](2.%20Compendium/spells/detect-magic-xphb.md), [Purify Food\
>      \ and Drink](2.%20Compendium/spells/purify-food-and-drink-xphb.md)\n\n**1/day\
>      \ each:** [Control Water](2.%20Compendium/spells/control-water-xphb.md), [Gaseous\
>      \ Form](2.%20Compendium/spells/gaseous-form-xphb.md), [Invisibility](2.%20Compendium/spells/invisibility-xphb.md),\
>      \ [Plane Shift](2.%20Compendium/spells/plane-shift-xphb.md), [Tongues](2.%20Compendium/spells/tongues-xphb.md)"
>    "name": "Spellcasting"
>"bonus_actions":
>  - "desc": "The marid casts [Fog Cloud](2.%20Compendium/spells/fog-cloud-xphb.md),\
>      \ using the same spellcasting ability as Spellcasting.\n"
>    "name": "Misty Veil (Recharge 5-6)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/elemental/token/marid-xmm.webp"
>```
^statblock
