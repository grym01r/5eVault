...
image: 2. Compendium/bestiary/elemental/img/salamander-inferno-master.webp
tags: monster
---
# Salamander Inferno Master
...
>      \ choice in a 10-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the salamander takes 10 (3d6) Fire damage."
>    "name": "Fire Aura"
>  - "desc": "The salamander has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>    "name": "Flame Trident"
>  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 30-foot-radius [Sphere](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md)\
>      \ centered on a point the salamander can see within 120 feet. *Failure:* 35\
>      \ (10d6) Fire damage, and the target starts [burning](0.%20DM%20Screen/traps-hazards/burning-xphb.md),\
>      \ taking 5 (1d10) Fire damage at the start of each of its turns instead of\
>      \ the normal [burning](0.%20DM%20Screen/traps-hazards/burning-xphb.md) damage.\
>      \ The target gains 1 [Exhaustion](0.%20DM%20Screen/conditions.md#Exhaustion)\
>      \ level whenever it takes this [burning](0.%20DM%20Screen/traps-hazards/burning-xphb.md)\
>      \ damage. *Success:* Half damage only."
>    "name": "Inferno Blast (Recharge 5-6)"
>"bonus_actions":
>  - "desc": "The salamander moves up to its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
>      \ without provoking [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack).\
>      \ During this movement, fire fills a 5-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the salamander. When the [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/elemental/token/salamander-inferno-master-xmm.webp"
>```
^statblock
