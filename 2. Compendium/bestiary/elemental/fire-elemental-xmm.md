...
aliases:
- Fire Elemental
image: 2. Compendium/bestiary/elemental/img/fire-elemental.webp
tags: monster
---
# Fire Elemental
...
>      \ flammable objects in the [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ start [burning](0.%20DM%20Screen/traps-hazards/burning-xphb.md)."
>    "name": "Fire Aura"
...
>      \ 5 (1d10) Fire damage."
>    "name": "Fire Form"
>  - "desc": "The elemental sheds [Bright Light](0.%20DM%20Screen/variant-rules/bright-light-xphb.md)\
>      \ in a 30-foot radius and [Dim Light](0.%20DM%20Screen/variant-rules/dim-light-xphb.md)\
...
>      \ If the target is a creature or a flammable object, it starts [burning](0.%20DM%20Screen/traps-hazards/burning-xphb.md)."
>    "name": "Burn"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/elemental/token/fire-elemental-xmm.webp"
>```
^statblock
