...
aliases:
- Elemental Cataclysm
image: 2. Compendium/books/monster-manual-2025/img/elemental-cataclysm.webp
tags: monster
---
# Elemental Cataclysm
...
>"condition_immunities": "[blinded](0.%20DM%20Screen/conditions.md#Blinded), [charmed](0.%20DM%20Screen/conditions.md#Charmed),\
>  \ [deafened](0.%20DM%20Screen/conditions.md#Deafened), [exhaustion](0.%20DM%20Screen/conditions.md#Exhaustion),\
>  \ [frightened](0.%20DM%20Screen/conditions.md#Frightened), [grappled](0.%20DM%20Screen/conditions.md#Grappled),\
...
>  \ [restrained](0.%20DM%20Screen/conditions.md#Restrained), [stunned](0.%20DM%20Screen/conditions.md#Stunned),\
>  \ [unconscious](0.%20DM%20Screen/conditions.md#Unconscious)"
>"senses": "[truesight](0.%20DM%20Screen/senses.md#Truesight) 150 ft., passive Perception\
>  \ 12"
...
>      \ a 60-foot-radius [Sphere](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md)\
...
>      \ [burning](0.%20DM%20Screen/traps-hazards/burning-xphb.md).  \n- **2 Freezing\
>      \ Waves.** *Strength Saving Throw:* DC 23, each creature in a 90-foot [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md).\
>      \ *Failure:* 22 (5d8) Bludgeoning damage plus 22 (5d8) Cold damage, and\
>      \ the target has the [Prone](0.%20DM%20Screen/conditions.md#Prone) condition.\
>      \ *Success:* Half damage only. *Failure or Success:* The target's [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
>      \ is reduced to 0 until the end of its next turn.  \n- **3 Raging Storm.** A\
>      \ storm cloud fills a 60-foot-radius [Sphere](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md)\
...
>      \ entirely in the cloud have the [Blinded](0.%20DM%20Screen/conditions.md#Blinded)\
>      \ and [Deafened](0.%20DM%20Screen/conditions.md#Deafened) conditions and can't\
...
>      \ Throw:* DC 23, each creature in a 90-foot [Cube](0.%20DM%20Screen/variant-rules/cube-area-of-effect-xphb.md)\
>      \ originating from a point on the ground within 150 feet. *Failure:* 18 (4d8)\
>      \ Bludgeoning damage plus 18 (4d8) Acid damage, and the target has the [Prone](0.%20DM%20Screen/conditions.md#Prone)\
>      \ condition and is buried under rubble. A buried target has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
>      \ condition, has [Total Cover](0.%20DM%20Screen/variant-rules/cover-xphb.md),\
>      \ and is suffocating. As an action, a buried creature or another creature within\
>      \ 5 feet of it can make a DC 18 Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics))\
>      \ check. On a successful check, the creature is no longer buried. *Success:*\
>      \ Half damage only.  "
>    "name": "Cataclysmic Event (Recharge 4-6)"
>  - "desc": "The cataclysm casts the [Control Weather](2.%20Compendium/spells/control-weather-xphb.md)\
...
>    "name": "Eruption"
>  - "desc": "The cataclysm moves up to its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md),\
>      \ [Fly Speed](0.%20DM%20Screen/variant-rules/fly-speed-xphb.md), or [Swim Speed](0.%20DM%20Screen/variant-rules/swim-speed-xphb.md)\
>      \ without provoking [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack).\
...
>      \ target has the [Prone](0.%20DM%20Screen/conditions.md#Prone) condition. *Failure\
>      \ or Success:* The cataclysm can't take this action again until the start of\
>      \ its next turn."
>    "name": "Rumbling Movement"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/elemental/token/elemental-cataclysm-xmm.webp"
>```
^statblock
