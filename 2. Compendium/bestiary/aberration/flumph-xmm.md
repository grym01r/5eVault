...
aliases:
- Flumph
image: 2. Compendium/books/monster-manual-2025/img/flumph.webp
tags: monster
---
# Flumph
...
>  - "desc": "If the flumph receives the [Prone](0.%20DM%20Screen/conditions.md#Prone)\
>      \ condition, roll a die. On an odd number, it has the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated)\
>      \ condition. At the end of each of its turns, the flumph makes a DC 10 Dexterity\
>      \ saving throw, ending the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated)\
...
>      \ a stench for 1d4 hours, and has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ condition while the stench lasts. Other creatures have the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ condition while in a 5-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the coated target. The target can remove the stench on itself\
>      \ if it bathes during a [Short](0.%20DM%20Screen/variant-rules/short-rest-xphb.md)\
>      \ or [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md)."
>    "name": "Stench Spray (1/Day)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/aberration/token/flumph-xmm.webp"
>```
^statblock
