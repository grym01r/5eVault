...
aliases:
- Kuo-toa
image: 2. Compendium/bestiary/aberration/img/kuo-toa.webp
tags: monster
---
# Kuo-toa
...
>      \ can see within 15 feet. *Failure:* The target has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
>      \ condition until the net is destroyed (AC 10; HP 5; [Immunity](0.%20DM%20Screen/variant-rules/immunity-xphb.md)\
>      \ to Bludgeoning, Poison, and Psychic damage). A creature can take an action\
>      \ to make a DC 10 Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics))\
...
>      \ doesn't let go of the weapon, the target has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ condition while the weapon is stuck (escape DC 11). While stuck, the weapon\
>      \ can't be used. The target can take an action to make a DC 11 Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics))\
>      \ check, freeing the weapon on a success."
>    "name": "Sticky Shield"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/aberration/token/kuo-toa-xmm.webp"
>```
^statblock
