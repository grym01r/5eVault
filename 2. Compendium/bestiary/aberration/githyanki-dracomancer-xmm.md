...
>  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 90-foot [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md).\
...
>      \ (self only), [Plane Shift](2.%20Compendium/spells/plane-shift-xphb.md), [Tongues](2.%20Compendium/spells/tongues-xphb.md)"
>    "name": "Spellcasting"
>"bonus_actions":
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/aberration/token/githyanki-dracomancer-xmm.webp"
>```
^statblock
