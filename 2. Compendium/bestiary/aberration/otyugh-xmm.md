...
aliases:
- Otyugh
image: 2. Compendium/books/monster-manual-2025/img/otyugh.webp
tags: monster
---
# Otyugh
...
>      \ condition. Whenever the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ target finishes a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md),\
>      \ it is subjected to the following effect. *Constitution Saving Throw:* DC 15.\
>      \ *Failure:* The target's [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ maximum decreases by 5 (1d10) and doesn't return to normal until the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ condition ends on the target. *Success:* The [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ condition ends."
>    "name": "Bite"
...
>    "name": "Tentacle"
>  - "desc": "*Constitution Saving Throw:* DC 14, each creature [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/aberration/token/otyugh-xmm.webp"
>```
^statblock
