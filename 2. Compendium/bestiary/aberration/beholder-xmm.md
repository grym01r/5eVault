...
aliases:
- Beholder
image: 2. Compendium/bestiary/aberration/img/beholder.webp
tags: monster
---
# Beholder
...
>    "desc": "+12"
>"condition_immunities": "[prone](0.%20DM%20Screen/conditions.md#Prone)"
>"senses": "[darkvision](0.%20DM%20Screen/senses.md#Darkvision) 120 ft., passive Perception\
>  \ 22"
...
>      \ has the [Charmed](0.%20DM%20Screen/conditions.md#Charmed) condition for 1\
>      \ hour or until it takes damage. *Success:* Half damage only.  \n- **2 Paralyzing\
>      \ Ray.** *Constitution Saving Throw:* DC 16. *Failure:* The target has the [Paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed)\
>      \ condition and repeats the save at the end of each of its turns, ending the\
>      \ effect on itself on a success. After 1 minute, it succeeds automatically.\
>      \  \n- **3 Fear Ray.** *Wisdom Saving Throw:* DC 16. *Failure:* 14 (4d6) Psychic\
>      \ damage, and the target has the [Frightened](0.%20DM%20Screen/conditions.md#Frightened)\
...
>      \ Necrotic damage. Until the end of the target's next turn, the target's [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
>      \ is halved; the target can't take Reactions; and it can take either an action\
>      \ or a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md) on\
>      \ its turn, not both. *Success:* Half damage only.  \n- **5 Enervation Ray.**\
>      \ *Constitution Saving Throw:* DC 16. *Failure:* 13 (3d8) Poison damage, and\
>      \ the target has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned) condition\
>      \ until the end of its next turn. While [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned),\
>      \ the target can't regain [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md).\
...
>      \ the [Restrained](0.%20DM%20Screen/conditions.md#Restrained) condition until\
>      \ the start of the beholder's next turn or until the beholder has the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated)\
...
>      \ it is a Construct or an Undead). *Failure:* The target has the [Unconscious](0.%20DM%20Screen/conditions.md#Unconscious)\
...
>      \ [Restrained](0.%20DM%20Screen/conditions.md#Restrained) condition and repeats\
>      \ the save at the end of its next turn if it is still [Restrained](0.%20DM%20Screen/conditions.md#Restrained),\
>      \ ending the effect on itself on a success. *2Nd Failure:* The target has the\
>      \ [Petrified](0.%20DM%20Screen/conditions.md#Petrified) condition instead of\
>      \ the [Restrained](0.%20DM%20Screen/conditions.md#Restrained) condition.  \n\
...
>      \ force, a 10-foot [Cube](0.%20DM%20Screen/variant-rules/cube-area-of-effect-xphb.md)\
>      \ of it disintegrates into dust. *Success:* Half damage. *Failure or Success:*\
>      \ If the target is a creature and this damage reduces it to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md),\
...
>      \ or Success:* The target dies if the ray reduces it to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md).\
>      \  "
>    "name": "Eye Rays"
>"bonus_actions":
>  - "desc": "The beholder's central eye emits an antimagic wave in a 150-foot [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md).\
>      \ Until the start of the beholder's next turn, that area acts as an [Antimagic\
>      \ Field](2.%20Compendium/spells/antimagic-field-xphb.md) spell, and that area\
...
>      \ and its allies) that finishes a [Short Rest](0.%20DM%20Screen/variant-rules/short-rest-xphb.md)\
...
>      \ 1 mile of the lair that makes a [D20 Test](0.%20DM%20Screen/variant-rules/d20-test-xphb.md)\
>      \ and rolls a 1 has the [Prone](0.%20DM%20Screen/conditions.md#Prone) condition.\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/aberration/token/beholder-xmm.webp"
>```
^statblock
...
- **Habitat.** Underdark  
- **Treasure.** [Arcana](0.%20DM%20Screen/tables/random-magic-items-arcana.md)  
