...
aliases:
- Cloaker
image: 2. Compendium/books/monster-manual-2025/img/cloaker.webp
tags: monster
---
# Cloaker
...
>"cr": "8"
>"traits":
>  - "desc": "While in [Bright Light](0.%20DM%20Screen/variant-rules/bright-light-xphb.md),\
>      \ the cloaker has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
>      \ on attack rolls."
...
>      \ to it. While the cloaker is attached, the target has the [Blinded](0.%20DM%20Screen/conditions.md#Blinded)\
...
>      \ a DC 14 Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check."
>    "name": "Attach"
>  - "desc": "*Melee Attack Roll:* +6, reach 10 ft. *Hit:* 8 (1d10 + 3) Slashing\
>      \ damage."
>    "name": "Tail"
>"bonus_actions":
>  - "desc": "*Wisdom Saving Throw:* DC 13, each creature in a 60-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the cloaker. *Failure:* The target has the [Frightened](0.%20DM%20Screen/conditions.md#Frightened)\
...
>    "name": "Moan"
>  - "desc": "The cloaker casts the [Mirror Image](2.%20Compendium/spells/mirror-image-xphb.md)\
...
>      \ Light](0.%20DM%20Screen/variant-rules/bright-light-xphb.md).\n"
>    "name": "Phantasms (Recharge after a Short or Long Rest)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/aberration/token/cloaker-xmm.webp"
>```
^statblock
