...
>      \ of (A) the [Charmed](0.%20DM%20Screen/conditions.md#Charmed) condition until\
>      \ the start of the githzerai's next turn or (B) the [Prone](0.%20DM%20Screen/conditions.md#Prone)\
...
>      \ is Invisible)\n\n**1/day each:** [Plane Shift](2.%20Compendium/spells/plane-shift-xphb.md),\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/aberration/token/githzerai-psion-xmm.webp"
>```
^statblock
