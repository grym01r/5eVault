...
>      \ damage. If the target is a Medium or smaller creature, it has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ condition (escape DC 14) from all the mind flayer's tentacles, and the target\
>      \ has the [Stunned](0.%20DM%20Screen/conditions.md#Stunned) condition until\
>      \ the grapple ends."
>    "name": "Tentacles"
>  - "desc": "*Constitution Saving Throw:* DC 15, one creature that is [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
...
>      \ [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md), the mind\
>      \ flayer kills it and devours its brain."
>    "name": "Extract Brain"
>  - "desc": "*Intelligence Saving Throw:* DC 15, each creature in a 60-foot [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md).\
>      \ *Failure:* 31 (6d8 + 4) Psychic damage, and the target has the [Stunned](0.%20DM%20Screen/conditions.md#Stunned)\
...
>      \ DC 15):\n\n**At will:** [Detect Thoughts](2.%20Compendium/spells/detect-thoughts-xphb.md)\n\
>      \n**1/day each:** [Dominate Monster](2.%20Compendium/spells/dominate-monster-xphb.md),\
>      \ [Plane Shift](2.%20Compendium/spells/plane-shift-xphb.md) (self only)"
>    "name": "Spellcasting"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/aberration/token/mind-flayer-xmm.webp"
>```
^statblock
