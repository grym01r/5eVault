...
aliases:
- Aboleth
image: 2. Compendium/bestiary/aberration/img/aboleth.webp
tags: monster
---
# Aboleth
...
>      \ all its [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) in\
...
>      \ Throw:* DC 14, each creature in a 5-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
...
>      \ the target can breathe air and water, and it can't regain [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
...
>      \ damage. If the target is a Large or smaller creature, it has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ condition (escape DC 14) from one of four tentacles."
>    "name": "Tentacle"
>  - "desc": "*Intelligence Saving Throw:* DC 16, one creature within 30 feet that\
>      \ is [Charmed](0.%20DM%20Screen/conditions.md#Charmed) or [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
...
>      \ is a Humanoid and is reduced to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ by this action."
>    "name": "Consume Memories"
>  - "desc": "*Wisdom Saving Throw:* DC 16, one creature the aboleth can see within\
>      \ 30 feet. *Failure:* The target has the [Charmed](0.%20DM%20Screen/conditions.md#Charmed)\
>      \ condition until the aboleth dies or is on a different plane of existence from\
>      \ the target. While [Charmed](0.%20DM%20Screen/conditions.md#Charmed), the target\
...
>      \ have the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned) condition for\
>      \ 1 hour.  \n- **Psionic Projection.** While in its lair, the aboleth can cast\
>      \ [Project Image](2.%20Compendium/spells/project-image-xphb.md), requiring\
...
>    "name": "Lash"
>  - "desc": "If the aboleth has at least one creature [Charmed](0.%20DM%20Screen/conditions.md#Charmed)\
>      \ or [Grappled](0.%20DM%20Screen/conditions.md#Grappled), it uses Consume Memories\
>      \ and regains 5 (1d10) [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)."
>    "name": "Psychic Drain"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/aberration/token/aboleth-xmm.webp"
>```
^statblock
