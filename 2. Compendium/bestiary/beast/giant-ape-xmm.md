...
aliases:
- Giant Ape
image: 2. Compendium/bestiary/beast/img/giant-ape-and-giant-bat.webp
tags: monster
---
# Giant Ape
...
>      \ Saving Throw:* DC 17, each creature in a 5-foot-radius [Sphere](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md)\
>      \ centered on that point. *Failure:* 24 (7d6) Bludgeoning damage. If the target\
>      \ is a Large or smaller creature, it has the [Prone](0.%20DM%20Screen/conditions.md#Prone)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/beast/token/giant-ape-xmm.webp"
>```
^statblock
