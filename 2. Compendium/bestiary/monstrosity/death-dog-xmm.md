...
aliases:
- Death Dog
image: 2. Compendium/bestiary/monstrosity/img/death-dog.webp
tags: monster
---
# Death Dog
...
>  \ [deafened](0.%20DM%20Screen/conditions.md#Deafened), [frightened](0.%20DM%20Screen/conditions.md#Frightened),\
...
>      \ *Constitution Saving Throw:* DC 12. *1St Failure:* The target has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ condition. While [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned), the\
>      \ target's [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) maximum\
>      \ doesn't return to normal when finishing a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md),\
>      \ and it repeats the save every 24 hours that elapse, ending the effect on itself\
>      \ on a success. Subsequent Failures: The [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ target's [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) maximum\
>      \ decreases by 5 (1d10)."
>    "name": "Bite"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/death-dog-xmm.webp"
>```
^statblock
