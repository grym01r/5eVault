...
aliases:
- Medusa
image: 2. Compendium/bestiary/monstrosity/img/medusa.webp
tags: monster
---
# Medusa
...
>    "desc": "+6"
>"senses": "[darkvision](0.%20DM%20Screen/senses.md#Darkvision) 150 ft., passive Perception\
>  \ 14"
...
>    "name": "Poison Ray"
>"bonus_actions":
>  - "desc": "*Constitution Saving Throw:* DC 13, each creature in a 30-foot [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md).\
>      \ If the medusa sees its reflection in the [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md),\
>      \ the medusa must make this save. *1St Failure:* The target has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/medusa-xmm.webp"
>```
^statblock
