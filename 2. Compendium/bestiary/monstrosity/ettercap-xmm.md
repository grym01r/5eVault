...
aliases:
- Ettercap
image: 2. Compendium/books/monster-manual-2025/img/ettercap.webp
tags: monster
---
# Ettercap
...
>    "desc": "+4"
>  - "name": "[Survival](0.%20DM%20Screen/skills.md#Survival)"
>    "desc": "+3"
...
>      \ damage plus 2 (1d4) Poison damage, and the target has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
...
>      \ can see within 30 feet. *Failure:* The target has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
>      \ condition until the web is destroyed (AC 10; HP 5; [Vulnerability](0.%20DM%20Screen/variant-rules/vulnerability-xphb.md)\
>      \ to Fire damage; [Immunity](0.%20DM%20Screen/variant-rules/immunity-xphb.md)\
>      \ to Bludgeoning, Poison, and Psychic damage)."
>    "name": "Web Strand (Recharge 5-6)"
>"bonus_actions":
>  - "desc": "The ettercap pulls one creature within 30 feet of itself that is [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
>      \ by its Web Strand up to 25 feet straight toward itself."
>    "name": "Reel"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/ettercap-xmm.webp"
>```
^statblock
