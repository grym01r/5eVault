---
creature type: monstrosity (lycanthrope)
...
aliases:
- Weretiger
image: 2. Compendium/bestiary/monstrosity/img/weretiger.webp
tags: monster
---
# Weretiger
...
>      \ cursed target drops to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md),\
>      \ it instead becomes a Weretiger under the DM's control and has 10 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md).\
...
>"bonus_actions":
>  - "desc": "The weretiger moves up to its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/weretiger-xmm.webp"
>```
^statblock
