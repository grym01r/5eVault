...
aliases:
- Kraken
image: 2. Compendium/bestiary/monstrosity/img/kraken.webp
tags: monster
---
# Kraken
...
>"condition_immunities": "[frightened](0.%20DM%20Screen/conditions.md#Frightened),\
>  \ [grappled](0.%20DM%20Screen/conditions.md#Grappled), [paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed),\
...
>      \ damage. The target has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ condition (escape DC 20) from one of ten tentacles, and it has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
>      \ condition until the grapple ends."
>    "name": "Tentacle"
>  - "desc": "The kraken throws a Large or smaller creature [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
...
>      \ has the [Prone](0.%20DM%20Screen/conditions.md#Prone) condition. *Success:*\
>      \ Half damage only."
>    "name": "Fling"
...
>  - "desc": "*Dexterity Saving Throw:* DC 25, one creature [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
...
>      \ swallowed and no longer [Grappled](0.%20DM%20Screen/conditions.md#Grappled).\
>      \ A swallowed creature has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
...
>      \ the kraken with the [Prone](0.%20DM%20Screen/conditions.md#Prone) condition.\
>      \ If the kraken dies, any swallowed creature no longer has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
...
>      \ [Charmed](0.%20DM%20Screen/conditions.md#Charmed) condition while in that\
>      \ area.  \n- **Sea and Storms.** While in its lair, the kraken can cast [Control\
>      \ Weather](2.%20Compendium/spells/control-weather-xphb.md), requiring no spell\
...
>    "name": "Storm Bolt"
>  - "desc": "*Constitution Saving Throw:* DC 23, each creature in a 15-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the kraken while it is underwater. *Failure:* The target\
>      \ has the [Blinded](0.%20DM%20Screen/conditions.md#Blinded) and [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ conditions until the end of the kraken's next turn. The kraken then moves\
>      \ up to its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md). *Failure\
>      \ or Success:* The kraken can't take this action again until the start of its\
>      \ next turn."
>    "name": "Toxic Ink"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/kraken-xmm.webp"
>```
^statblock
