...
aliases:
- Peryton
image: 2. Compendium/bestiary/monstrosity/img/peryton.webp
tags: monster
---
# Peryton
...
>      \ damage. If the attack reduces a Humanoid target to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md),\
>      \ the peryton kills the target by removing its heart."
>    "name": "Talons"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/peryton-xmm.webp"
>```
^statblock
