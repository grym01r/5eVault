...
aliases:
- Hydra
image: 2. Compendium/bestiary/monstrosity/img/hydra.webp
tags: monster
---
# Hydra
...
>      \ [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) when it grows\
>      \ new heads."
>    "name": "Multiple Heads"
>  - "desc": "For each head the hydra has beyond one, it gets an extra [Reaction](0.%20DM%20Screen/variant-rules/reaction-xphb.md)\
>      \ that can be used only for [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack)."
>    "name": "Reactive Heads"
>"actions":
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/hydra-xmm.webp"
>```
^statblock
