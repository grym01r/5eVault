...
aliases:
- Troglodyte
image: 2. Compendium/bestiary/monstrosity/img/troglodyte.webp
tags: monster
---
# Troglodyte
...
>      \ that starts its turn in a 5-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the troglodyte. *Failure:* The target has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ condition until the start of its next turn. *Success:* The target is immune\
>      \ to the Stench of all troglodytes for 1 hour."
>    "name": "Stench"
>  - "desc": "While in sunlight, the troglodyte has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/troglodyte-xmm.webp"
>```
^statblock
