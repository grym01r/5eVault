...
aliases:
- Drider
image: 2. Compendium/books/monster-manual-2025/img/drider.webp
tags: monster
---
# Drider
...
>    "name": "Spider Climb"
>  - "desc": "While in sunlight, the drider has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
...
>    "name": "Poison Burst"
>"bonus_actions":
>  - "desc": "The drider casts [Darkness](2.%20Compendium/spells/darkness-xphb.md),\
>      \ [Faerie Fire](2.%20Compendium/spells/faerie-fire-xphb.md), or [Web](2.%20Compendium/spells/web-xphb.md),\
>      \ requiring no Material components and using Wisdom as the spellcasting ability\
>      \ (spell save DC 14).\n"
>    "name": "Magic of the Spider Queen (Recharge 5-6)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/drider-xmm.webp"
>```
^statblock
