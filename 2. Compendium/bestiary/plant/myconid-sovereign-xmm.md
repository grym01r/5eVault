...
aliases:
- Myconid Sovereign
image: 2. Compendium/bestiary/plant/img/myconids.webp
tags: monster
---
# Myconid Sovereign
...
>"cr": "2"
>"traits":
>  - "desc": "While in sunlight, the myconid has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
>      \ on [D20 Tests](0.%20DM%20Screen/variant-rules/d20-test-xphb.md). The myconid\
...
>      \ as a [Myconid Spore Servant](0.%20DM%20Screen/bestiary/plant/myconid-spore-servant-xmm.md).\
...
>      \ within 10 feet. *Failure:* The target has the [Stunned](0.%20DM%20Screen/conditions.md#Stunned)\
>      \ condition and repeats the save at the end of each of its turns, ending the\
>      \ effect on itself on a success. After 1 minute, it succeeds automatically."
>    "name": "Pacifying Spores"
>  - "desc": "The myconid expels spores in a 30-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/plant/token/myconid-sovereign-xmm.webp"
>```
^statblock
