...
aliases:
- Empyrean
image: 2. Compendium/bestiary/miscellaneous/img/empyreans.webp
tags: monster
---
# Empyrean
...
>  - "desc": "The empyrean has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>      \ damage, and the target has the [Stunned](0.%20DM%20Screen/conditions.md#Stunned)\
>      \ condition until the start of the empyrean's next turn. The target can choose\
>      \ not to be [Stunned](0.%20DM%20Screen/conditions.md#Stunned), in which case\
>      \ it takes an extra 21 Force damage that bypasses [Resistance](0.%20DM%20Screen/variant-rules/resistance-xphb.md)\
>      \ or [Immunity](0.%20DM%20Screen/variant-rules/immunity-xphb.md)."
>    "name": "Sacred Weapon"
...
>      \n**At will:** [Calm Emotions](2.%20Compendium/spells/calm-emotions-xphb.md),\
>      \ [Greater Restoration](2.%20Compendium/spells/greater-restoration-xphb.md),\
>      \ [Pass without Trace](2.%20Compendium/spells/pass-without-trace-xphb.md),\
>      \ [Water Breathing](2.%20Compendium/spells/water-breathing-xphb.md)\n\n**1/day\
>      \ each:** [Commune](2.%20Compendium/spells/commune-xphb.md), [Dispel Evil and\
>      \ Good](2.%20Compendium/spells/dispel-evil-and-good-xphb.md), [Plane Shift](2.%20Compendium/spells/plane-shift-xphb.md)"
>    "name": "Spellcasting"
...
>"legendary_actions":
>  - "desc": "The empyrean gains 10 [Temporary Hit Points](0.%20DM%20Screen/variant-rules/temporary-hit-points-xphb.md),\
>      \ and the empyrean and each ally within 30 feet of it gain [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
>      \ on [D20 Tests](0.%20DM%20Screen/variant-rules/d20-test-xphb.md) until the\
>      \ end of the empyrean's next turn. The empyrean can't take this action again\
>      \ until the start of its next turn."
>    "name": "Bolster"
>  - "desc": "*Constitution Saving Throw:* DC 23, each creature in a 30-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/miscellaneous/token/empyrean-xmm.webp"
>```
^statblock
