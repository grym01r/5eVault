...
aliases:
- Fire Giant
image: 2. Compendium/books/monster-manual-2025/img/fire-giant.webp
tags: monster
---
# Fire Giant
...
>      \ to 15 feet straight away from the giant and has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
>      \ on the next attack roll it makes before the end of its next turn."
>    "name": "Hammer Throw"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/giant/token/fire-giant-xmm.webp"
>```
^statblock
