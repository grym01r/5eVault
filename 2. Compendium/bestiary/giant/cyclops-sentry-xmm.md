...
>      \ it. _Response:_ The cyclops imposes [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
>      \ on the roll, and the cyclops gains [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
>      \ on attack rolls against the target until the end of the cyclops's next turn."
>    "name": "Limited Foresight (Recharge 6)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/giant/token/cyclops-sentry-xmm.webp"
>```
^statblock
