...
aliases:
- Frost Giant
image: 2. Compendium/bestiary/giant/img/frost-giant.webp
tags: monster
---
# Frost Giant
...
>      \ Piercing damage plus 7 (2d6) Cold damage, and the target's [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
...
>      \ 16 (2d10 + 5) [Temporary Hit Points](0.%20DM%20Screen/variant-rules/temporary-hit-points-xphb.md)\
>      \ and has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on attack\
>      \ rolls until the start of the giant's next turn."
>    "name": "War Cry (Recharge 5-6)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/giant/token/frost-giant-xmm.webp"
>```
^statblock
