...
aliases:
- Mummy Lord
image: 2. Compendium/bestiary/undead/img/mummy-lord.webp
tags: monster
---
# Mummy Lord
...
>  - "desc": "The mummy has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
>      \ on saving throws against spells and other magical effects."
>    "name": "Magic Resistance"
>  - "desc": "If destroyed, the mummy gains a new body in 24 hours if its heart is\
>      \ intact, reviving with all its [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md).\
>      \ The new body appears in an unoccupied space within the mummy's lair. The heart\
>      \ is a Tiny object that has AC 17, HP 10, and [Immunity](0.%20DM%20Screen/variant-rules/immunity-xphb.md)\
...
>      \ cursed. While cursed, the target can't regain [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md),\
>      \ it gains no benefit from finishing a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md),\
>      \ and its [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) maximum\
>      \ decreases by 10 (3d6) every 24 hours that elapse. A creature dies and turns\
>      \ to dust if reduced to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ by this attack."
>    "name": "Rotting Fist"
...
>      \ feet. *Failure:* 25 (6d6 + 4) Psychic damage, and the target has the [Paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed)\
...
>      \ with spell attacks):\n\n**At will:** [Dispel Magic](2.%20Compendium/spells/dispel-magic-xphb.md),\
>      \ [Thaumaturgy](2.%20Compendium/spells/thaumaturgy-xphb.md)\n\n**1/day each:**\
>      \ [Animate Dead](2.%20Compendium/spells/animate-dead-xphb.md), [Harm](2.%20Compendium/spells/harm-xphb.md),\
>      \ [Insect Plague](2.%20Compendium/spells/insect-plague-xphb.md) (level 7 version)"
>    "name": "Spellcasting"
>"reactions":
...
>      \ [Blinded](0.%20DM%20Screen/conditions.md#Blinded) condition until the end\
...
>      \ Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md), or [Reaction](0.%20DM%20Screen/variant-rules/reaction-xphb.md)\
>      \ used to cast the spell is wasted, but any resources used to cast it aren't\
>      \ expended.  \n- **Soul Drain.** Creatures within 1 mile of the lair have [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
...
>  - "desc": "The mummy casts [Command](2.%20Compendium/spells/command-xphb.md) (level\
>      \ 2 version), using the same spellcasting ability as Spellcasting. The mummy\
>      \ can't take this action again until the start of its next turn.\n"
>    "name": "Dread Command"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/mummy-lord-xmm.webp"
>```
^statblock
