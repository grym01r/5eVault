...
aliases:
- Vampire
image: 2. Compendium/bestiary/undead/img/vampire.webp
tags: monster
---
# Vampire
...
>    "desc": "+7"
>  - "name": "[Stealth](0.%20DM%20Screen/skills.md#Stealth)"
>    "desc": "+9"
...
>  - "desc": "If the vampire drops to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
...
>      \ has 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) in mist\
...
>      \ vampire form and has the [Paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed)\
>      \ condition until it regains any [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md),\
>      \ and it regains 1 [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
...
>      \ the vampire's heart while the vampire has the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated)\
>      \ condition in its resting place, the vampire has the [Paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed)\
...
>      \ has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on\
...
>      \ creature, it has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled) condition\
...
>      \ willing or that has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled),\
>      \ [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated), or [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
>      \ condition. *Failure:* 6 (1d4 + 4) Piercing damage plus 13 (3d8) Necrotic\
>      \ damage. The target's [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ maximum decreases by an amount equal to the Necrotic damage taken, and the\
>      \ vampire regains [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ equal to that amount. A Humanoid reduced to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ by this damage and then buried rises the following sunset as a [Vampire Spawn](0.%20DM%20Screen/bestiary/undead/vampire-spawn-xmm.md)\
>      \ under the vampire's control."
>    "name": "Bite (Bat or Vampire Form Only)"
>"bonus_actions":
>  - "desc": "If the vampire isn't in sunlight or running water, it shape-shifts into\
>      \ a Tiny bat ([Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md) 5 ft., [Fly\
>      \ Speed](0.%20DM%20Screen/variant-rules/fly-speed-xphb.md) 30 ft.) or a Medium\
>      \ cloud of mist ([Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md) 5 ft.,\
>      \ [Fly Speed](0.%20DM%20Screen/variant-rules/fly-speed-xphb.md) 20 ft. [hover]),\
...
>      \ than its size and [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md), are\
...
>      \ pass through liquid. It has [Resistance](0.%20DM%20Screen/variant-rules/resistance-xphb.md)\
>      \ to all damage, except the damage it takes from sunlight."
>    "name": "Shape-Shift"
>  - "desc": "The vampire casts [Charm Person](2.%20Compendium/spells/charm-person-xphb.md),\
...
>      \ smaller Beasts have the [Charmed](0.%20DM%20Screen/conditions.md#Charmed)\
...
>      \ the vampire and its allies) that finishes a [Short Rest](0.%20DM%20Screen/variant-rules/short-rest-xphb.md)\
...
>      \ of the lair is [Lightly Obscured](0.%20DM%20Screen/variant-rules/lightly-obscured-xphb.md)\
...
>"legendary_actions":
>  - "desc": "The vampire moves up to half its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md),\
>      \ and it makes one Grave Strike attack."
>    "name": "Deathless Strike"
>  - "desc": "The vampire casts [Command](2.%20Compendium/spells/command-xphb.md),\
>      \ requiring no spell components and using Charisma as the spellcasting ability\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/vampire-xmm.webp"
>```
^statblock
