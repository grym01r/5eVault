...
environment: desert, planar, shadowfell, swamp, underdark, urban
cr: 3
...
aliases:
- Wight
image: 2. Compendium/bestiary/undead/img/wight.webp
tags: monster
---
# Wight
...
>"cr": "3"
>"traits":
>  - "desc": "While in sunlight, the wight has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
...
>      \ 6 (1d8 + 2) Necrotic damage, and the target's [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ maximum decreases by an amount equal to the damage taken.\n\nA Humanoid slain\
>      \ by this attack rises 24 hours later as a [Zombie](0.%20DM%20Screen/bestiary/undead/zombie-xmm.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/wight-xmm.webp"
>```
^statblock
