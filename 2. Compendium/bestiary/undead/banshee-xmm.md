...
aliases:
- Banshee
image: 2. Compendium/bestiary/undead/img/banshee.webp
tags: monster
---
# Banshee
...
>      \ 60 feet that can see the banshee. *Failure:* The target has the [Frightened](0.%20DM%20Screen/conditions.md#Frightened)\
...
>      \ and isn't a Construct or an Undead. *Failure:* If the target has 25 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ or fewer, it drops to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md).\
>      \ Otherwise, the target takes 10 (3d6) Psychic damage."
>    "name": "Deathly Wail (1/Day)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/banshee-xmm.webp"
>```
^statblock
