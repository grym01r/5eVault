...
aliases:
- Lich
image: 2. Compendium/books/monster-manual-2025/img/lich.webp
tags: monster
---
# Lich
...
>      \ reviving with all its [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md).\
...
>      \ and the target has the [Paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed)\
...
>      \ [Detect Thoughts](2.%20Compendium/spells/detect-thoughts-xphb.md), [Dispel\
>      \ Magic](2.%20Compendium/spells/dispel-magic-xphb.md), [Fireball](2.%20Compendium/spells/fireball-xphb.md)\
>      \ (level 5 version), [Invisibility](2.%20Compendium/spells/invisibility-xphb.md),\
>      \ [Lightning Bolt](2.%20Compendium/spells/lightning-bolt-xphb.md) (level 5\
>      \ version), [Mage Hand](2.%20Compendium/spells/mage-hand-xphb.md), [Prestidigitation](2.%20Compendium/spells/prestidigitation-xphb.md)\n\
>      \n**2/day each:** [Animate Dead](2.%20Compendium/spells/animate-dead-xphb.md),\
>      \ [Dimension Door](2.%20Compendium/spells/dimension-door-xphb.md), [Plane Shift](2.%20Compendium/spells/plane-shift-xphb.md)\n\
>      \n**1/day each:** [Chain Lightning](2.%20Compendium/spells/chain-lightning-xphb.md),\
>      \ [Finger of Death](2.%20Compendium/spells/finger-of-death-xphb.md), [Power\
>      \ Word Kill](2.%20Compendium/spells/power-word-kill-xphb.md), [Scrying](2.%20Compendium/spells/scrying-xphb.md)"
>    "name": "Spellcasting"
>"reactions":
>  - "desc": "The lich casts [Counterspell](2.%20Compendium/spells/counterspell-xphb.md)\
>      \ or [Shield](2.%20Compendium/spells/shield-xphb.md) in response to the spell's\
...
>      \ cast [Clairvoyance](2.%20Compendium/spells/clairvoyance-xphb.md), requiring\
...
>      \ or [Wish](2.%20Compendium/spells/wish-xphb.md) spell.  \n\nIf the lich is\
...
>      \ in a 20-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
...
>    "name": "Disrupt Life"
>  - "desc": "The lich casts [Fear](2.%20Compendium/spells/fear-xphb.md), using the\
>      \ same spellcasting ability as Spellcasting. The lich can't take this action\
>      \ again until the start of its next turn.\n"
>    "name": "Frightening Gaze"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/lich-xmm.webp"
>```
^statblock
