...
aliases:
- Ghost
image: 2. Compendium/books/monster-manual-2025/img/ghost.webp
tags: monster
---
# Ghost
...
>      \ [Difficult Terrain](0.%20DM%20Screen/variant-rules/difficult-terrain-xphb.md).\
...
>  - "desc": "*Wisdom Saving Throw:* DC 13, each creature in a 60-foot [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md)\
...
>      \ and the target has the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated)\
...
>      \ game statistics are the same, except it uses the possessed target's [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md),\
>      \ as well as the target's Strength, Dexterity, and Constitution modifiers.\n\
>      \nThe possession lasts until the body drops to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ or the ghost leaves as a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md).\
>      \ When the possession ends, the ghost appears in an unoccupied space within\
>      \ 5 feet of the target, and the target is immune to this ghost's [Possession](0.%20DM%20Screen/variant-rules/possession-xphb.md)\
>      \ for 24 hours. *Success:* The target is immune to this ghost's [Possession](0.%20DM%20Screen/variant-rules/possession-xphb.md)\
>      \ for 24 hours."
>    "name": "Possession (Recharge 6)"
>  - "desc": "The ghost casts the [Etherealness](2.%20Compendium/spells/etherealness-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/ghost-xmm.webp"
>```
^statblock
