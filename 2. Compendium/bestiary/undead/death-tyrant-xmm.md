...
aliases:
- Death Tyrant
image: 2. Compendium/books/monster-manual-2025/img/death-tyrant.webp
tags: monster
---
# Death Tyrant
...
>  \ [paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed), [petrified](0.%20DM%20Screen/conditions.md#Petrified),\
>  \ [poisoned](0.%20DM%20Screen/conditions.md#Poisoned), [prone](0.%20DM%20Screen/conditions.md#Prone)"
...
>      \ target has the [Charmed](0.%20DM%20Screen/conditions.md#Charmed) condition\
...
>      \ has the [Paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed) condition and\
...
>      \ target has the [Frightened](0.%20DM%20Screen/conditions.md#Frightened) condition\
>      \ until the end of its next turn. *Success:* Half damage only.  \n- **4 Slowing\
>      \ Ray.** *Constitution Saving Throw:* DC 17. *Failure:* 18 (4d8) Necrotic\
>      \ damage. Until the end of the target's next turn, the target can't take Reactions;\
>      \ its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md) is halved; and it\
>      \ can take either an action or a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md)\
>      \ on its turn, not both. *Success:* Half damage only.  \n- **5 Enervation Ray.**\
>      \ *Constitution Saving Throw:* DC 17. *Failure:* 16 (3d10) Poison damage,\
>      \ and the target has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ condition until the end of its next turn. While [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned),\
...
>      \ has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained) condition\
>      \ until the start of the death tyrant's next turn or until the death tyrant\
>      \ has the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated) condition.\
...
>      \ Construct or an Undead). *Failure:* The target has the [Unconscious](0.%20DM%20Screen/conditions.md#Unconscious)\
...
>      \ negative energy in a 150-foot [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md).\
>      \ Creatures in that area can't regain [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ until the start of the death tyrant's next turn. An intact Humanoid corpse\
>      \ there instantly rises as a [Zombie](0.%20DM%20Screen/bestiary/undead/zombie-xmm.md)\
...
>      \ a creature within 1 mile of the lair regains [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ from a spell, it subtracts 1d10 from the number of [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
...
>      \ allies) that finishes a [Short Rest](0.%20DM%20Screen/variant-rules/short-rest-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/death-tyrant-xmm.webp"
>```
^statblock
