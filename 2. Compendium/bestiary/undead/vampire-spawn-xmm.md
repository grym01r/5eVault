...
aliases:
- Vampire Spawn
image: 2. Compendium/bestiary/undead/img/vampire-spawn.webp
tags: monster
---
# Vampire Spawn
...
>      \ damage is driven into the vampire's heart while the vampire has the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated)\
>      \ condition.  \n- **Sunlight.** The vampire takes 20 Radiant damage if it starts\
>      \ its turn in sunlight. While in sunlight, it has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/vampire-spawn-xmm.webp"
>```
^statblock
