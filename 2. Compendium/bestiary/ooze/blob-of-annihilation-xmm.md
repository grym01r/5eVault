...
image: 2. Compendium/bestiary/ooze/img/blob-of-annihilation.webp
tags: monster
---
# Blob of Annihilation
...
>"cr": "23"
>"traits":
>  - "desc": "If the blob is reduced to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md),\
...
>  - "desc": "The blob has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>      \ damage."
>    "name": "Pseudopod"
>  - "desc": "The blob moves up to its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
...
>      \ While engulfed, a target has [Total Cover](0.%20DM%20Screen/variant-rules/cover-xphb.md)\
...
>      \ Force damage at the start of each of its turns, is suffocating, has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
>      \ condition, and repeats the save at the end of each of its turns. An engulfed\
>      \ creature that is reduced to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
...
>      \ toward the blob, and the target has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/ooze/token/blob-of-annihilation-xmm.webp"
>```
^statblock
