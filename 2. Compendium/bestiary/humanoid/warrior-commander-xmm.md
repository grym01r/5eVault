...
aliases:
- Warrior Commander
image: 2. Compendium/bestiary/humanoid/img/warriors.webp
tags: monster
---
# Warrior Commander
...
>      \ The target has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
>      \ on its next attack roll before the start of the warrior's next turn.  \n-\
>      \ **Maneuver.** One ally who can see or hear the warrior can take a [Reaction](0.%20DM%20Screen/variant-rules/reaction-xphb.md)\
...
>    "name": "Longbow"
>"bonus_actions":
>  - "desc": "The warrior moves up to half its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
>      \ straight toward an enemy it can see without provoking [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack)."
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/humanoid/token/warrior-commander-xmm.webp"
>```
^statblock
