...
aliases:
- Scout Captain
image: 2. Compendium/bestiary/humanoid/img/scouts.webp
tags: monster
---
# Scout Captain
...
>      \ damage, plus 10 (3d6) Piercing damage if the attack was made with [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)."
>    "name": "Shortsword"
>  - "desc": "*Ranged Attack Roll:* +5, range 150/600 ft. *Hit:* 7 (1d8 + 3) Piercing\
>      \ damage, plus 10 (3d6) Piercing damage if the attack was made with [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)."
>    "name": "Longbow"
>"bonus_actions":
>  - "desc": "The scout has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/humanoid/token/scout-captain-xmm.webp"
>```
^statblock
