...
aliases:
- Elemental Cultist
image: 2. Compendium/bestiary/humanoid/img/aberrant-cultist-and-elemental-cultist.webp
tags: monster
---
# Elemental Cultist
...
>      \ [Mage Hand](2.%20Compendium/spells/mage-hand-xphb.md)"
>    "name": "Spellcasting"
>"reactions":
>  - "desc": "Trigger: The cultist takes Acid, Cold, Fire, Lightning, or Thunder damage.\
>      \ _Response:_ The cultist gives itself [Resistance](0.%20DM%20Screen/variant-rules/resistance-xphb.md)\
>      \ to that instance of damage and gains 10 [Temporary Hit Points](0.%20DM%20Screen/variant-rules/temporary-hit-points-xphb.md)."
>    "name": "Elemental Absorption (1/Day)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/humanoid/token/elemental-cultist-xmm.webp"
>```
^statblock
