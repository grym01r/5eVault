...
aliases:
- Performer Legend
image: 2. Compendium/bestiary/humanoid/img/performers.webp
tags: monster
---
# Performer Legend
...
>    "desc": "+7"
>  - "name": "[Performance](0.%20DM%20Screen/skills.md#Performance)"
>    "desc": "+13"
...
>  - "desc": "*Wisdom Saving Throw:* DC 17, each creature in a 20-foot-radius [Sphere](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md)\
>      \ centered on a point within 120 feet. *Failure:* 22 (4d8 + 4) Psychic damage,\
>      \ and the target has the [Charmed](0.%20DM%20Screen/conditions.md#Charmed) or\
>      \ [Frightened](0.%20DM%20Screen/conditions.md#Frightened) condition (performer's\
...
>      \n**At will:** [Mage Hand](2.%20Compendium/spells/mage-hand-xphb.md), [Minor\
>      \ Illusion](2.%20Compendium/spells/minor-illusion-xphb.md), [Prestidigitation](2.%20Compendium/spells/prestidigitation-xphb.md)\n\
>      \n**1/day each:** [Major Image](2.%20Compendium/spells/major-image-xphb.md),\
>      \ [Project Image](2.%20Compendium/spells/project-image-xphb.md)"
>    "name": "Spellcasting"
>"reactions":
...
>      \ roll misses the performer, and the target has the [Charmed](0.%20DM%20Screen/conditions.md#Charmed)\
>      \ condition until the end of the performer's next turn."
>    "name": "Warding Charm"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/humanoid/token/performer-legend-xmm.webp"
>```
^statblock
...
- **Habitat.** Any  
- **Treasure.** [Implements](0.%20DM%20Screen/tables/random-magic-items-implements.md), Individual  
