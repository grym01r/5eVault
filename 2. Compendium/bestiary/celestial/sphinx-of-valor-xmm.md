...
aliases:
- Sphinx of Valor
image: 2. Compendium/bestiary/celestial/img/sphinx-of-valor.webp
tags: monster
---
# Sphinx of Valor
...
>    "desc": "+12"
>  - "name": "[Religion](0.%20DM%20Screen/skills.md#Religion)"
>    "desc": "+15"
>"damage_resistances": "necrotic, radiant"
>"damage_immunities": "psychic"
>"condition_immunities": "[charmed](0.%20DM%20Screen/conditions.md#Charmed), [frightened](0.%20DM%20Screen/conditions.md#Frightened)"
>"senses": "[truesight](0.%20DM%20Screen/senses.md#Truesight) 120 ft., passive Perception\
>  \ 22"
>"languages": "Celestial, Common"
>"cr": "17"
>"traits":
>  - "desc": "No magic can observe the sphinx remotely or detect its thoughts without\
>      \ its permission. Wisdom ([Insight](0.%20DM%20Screen/skills.md#Insight)) checks\
>      \ made to ascertain its intentions or sincerity are made with [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)."
>    "name": "Inscrutable"
...
>      \ effect, as detailed below (the sequence resets when it takes a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md)):\n\
>      \n- **First Roar.** *Wisdom Saving Throw:* DC 20, each enemy in a 500-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the sphinx. *Failure:* The target has the [Frightened](0.%20DM%20Screen/conditions.md#Frightened)\
>      \ condition for 1 minute.  \n- **Second Roar.** *Wisdom Saving Throw:* DC 20,\
>      \ each enemy in a 500-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the sphinx. *Failure:* The target has the [Paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed)\
...
>      \ [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the sphinx. *Failure:* 44 (8d10) Thunder damage, and the\
>      \ target has the [Prone](0.%20DM%20Screen/conditions.md#Prone) condition. *Success:*\
>      \ Half damage only.  "
>    "name": "Roar (3/Day)"
...
>      \ [Detect Evil and Good](2.%20Compendium/spells/detect-evil-and-good-xphb.md),\
>      \ [Thaumaturgy](2.%20Compendium/spells/thaumaturgy-xphb.md)\n\n**1/day each:**\
>      \ [Detect Magic](2.%20Compendium/spells/detect-magic-xphb.md), [Dispel Magic](2.%20Compendium/spells/dispel-magic-xphb.md),\
>      \ [Greater Restoration](2.%20Compendium/spells/greater-restoration-xphb.md),\
>      \ [Heroes' Feast](2.%20Compendium/spells/heroes-feast-xphb.md), [Zone of Truth](2.%20Compendium/spells/zone-of-truth-xphb.md)"
>    "name": "Spellcasting"
>"regional_effects":
...
>      \ While in its lair, the sphinx can cast [Clairvoyance](2.%20Compendium/spells/clairvoyance-xphb.md),\
...
>      \ a [Study](0.%20DM%20Screen/actions.md#Study) action while within 1 mile of\
...
>      \ 120 feet. *Failure:* The target gains 1 [Exhaustion](0.%20DM%20Screen/conditions.md#Exhaustion)\
>      \ level. While the target has any [Exhaustion](0.%20DM%20Screen/conditions.md#Exhaustion)\
>      \ levels, it appears 3d10 years older. *Failure or Success:* The sphinx can't\
>      \ take this action again until the start of its next turn."
>    "name": "Weight of Years"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/celestial/token/sphinx-of-valor-xmm.webp"
>```
^statblock
