...
aliases:
- Solar
image: 2. Compendium/bestiary/celestial/img/solar.webp
tags: monster
---
# Solar
...
>      \ gains a new body instantly, reviving with all its [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ somewhere in Mount Celestia."
>    "name": "Exalted Restoration"
>  - "desc": "If the solar fails a saving throw, it can choose to succeed instead."
>    "name": "Legendary Resistance (4/Day)"
>  - "desc": "The solar has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>      \ 600 feet. *Failure:* If the creature has 100 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
...
>      \n**1/day each:** [Commune](2.%20Compendium/spells/commune-xphb.md), [Control\
>      \ Weather](2.%20Compendium/spells/control-weather-xphb.md), [Dispel Evil and\
>      \ Good](2.%20Compendium/spells/dispel-evil-and-good-xphb.md), [Resurrection](2.%20Compendium/spells/resurrection-xphb.md)"
>    "name": "Spellcasting"
>"bonus_actions":
>  - "desc": "The solar casts [Cure Wounds](2.%20Compendium/spells/cure-wounds-xphb.md)\
>      \ (level 2 version), [Lesser Restoration](2.%20Compendium/spells/lesser-restoration-xphb.md),\
>      \ or [Remove Curse](2.%20Compendium/spells/remove-curse-xphb.md), using the\
...
>      \ 120 feet. *Failure:* The target has the [Blinded](0.%20DM%20Screen/conditions.md#Blinded)\
...
>      \ *Dexterity Saving Throw:* DC 25, each creature in a 10-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/celestial/token/solar-xmm.webp"
>```
^statblock
