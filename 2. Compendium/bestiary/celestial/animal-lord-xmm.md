...
aliases:
- Animal Lord
image: 2. Compendium/bestiary/celestial/img/animal-lord.webp
tags: monster
---
# Animal Lord
...
>  - "wisdom": !!int "12"
>"skillsaves":
>  - "name": "[Acrobatics](0.%20DM%20Screen/skills.md#Acrobatics)"
>    "desc": "+13"
>  - "name": "[Athletics](0.%20DM%20Screen/skills.md#Athletics)"
>    "desc": "+13"
...
>      \ [Charmed](0.%20DM%20Screen/conditions.md#Charmed) condition until the end\
>      \ of its next turn. While [Charmed](0.%20DM%20Screen/conditions.md#Charmed),\
>      \ the target has the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated)\
>      \ condition.  \n- **Fearful (Hunter Only).** The target has the [Frightened](0.%20DM%20Screen/conditions.md#Frightened)\
...
>  - "desc": "The animal lord has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>      - **Fortify (Forager Only).** The animal lord gains 20 [Temporary Hit Points](0.%20DM%20Screen/variant-rules/temporary-hit-points-xphb.md).\
>      \  \n- **Marked as Prey (Hunter Only).** The animal lord has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
>      \ on attack rolls against the target until the start of the animal lord's next\
>      \ turn.  \n- **Pesky Swarm (Sage Only).** The target has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
...
>      \n**At will:** [Animal Friendship](2.%20Compendium/spells/animal-friendship-xphb.md),\
>      \ [Animal Messenger](2.%20Compendium/spells/animal-messenger-xphb.md), [Speak\
>      \ with Animals](2.%20Compendium/spells/speak-with-animals-xphb.md)\n\n**2/day\
>      \ each:** [Awaken](2.%20Compendium/spells/awaken-xphb.md), [Greater Restoration](2.%20Compendium/spells/greater-restoration-xphb.md)\n\
>      \n**1/day each:** [Animal Shapes](2.%20Compendium/spells/animal-shapes-xphb.md),\
>      \ [Sunburst](2.%20Compendium/spells/sunburst-xphb.md)"
>    "name": "Spellcasting"
>"bonus_actions":
...
>"legendary_actions":
>  - "desc": "The animal lord moves up to its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/celestial/token/animal-lord-xmm.webp"
>```
^statblock
...
- **Treasure.** [Relics](0.%20DM%20Screen/tables/random-magic-items-relics.md)  
