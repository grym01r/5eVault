...
aliases:
- Shadow Dragon
image: 2. Compendium/bestiary/dragon/img/shadow-dragons.webp
tags: monster
---
# Shadow Dragon
...
>  - "desc": "While in [Dim Light](0.%20DM%20Screen/variant-rules/dim-light-xphb.md)\
>      \ or [Darkness](0.%20DM%20Screen/variant-rules/darkness-xphb.md), the dragon\
>      \ has [Resistance](0.%20DM%20Screen/variant-rules/resistance-xphb.md) to damage\
>      \ that isn't Force, Psychic, or Radiant."
>    "name": "Living Shadow"
>  - "desc": "While in sunlight, the dragon has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
...
>    "name": "Rend"
>  - "desc": "*Dexterity Saving Throw:* DC 17, each creature in a 60-foot [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md).\
>      \ *Failure:* 35 (10d6) Necrotic damage. *Success:* Half damage. *Failure or\
>      \ Success:* A Humanoid reduced to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ by this damage dies, and a [Shadow](0.%20DM%20Screen/bestiary/undead/shadow-xmm.md)\
>      \ rises from the corpse. The shadow is under the dragon's control and shares\
>      \ the dragon's [Initiative](0.%20DM%20Screen/variant-rules/initiative-xphb.md)\
...
>      \ normally create [Bright Light](0.%20DM%20Screen/variant-rules/bright-light-xphb.md)\
>      \ instead create [Dim Light](0.%20DM%20Screen/variant-rules/dim-light-xphb.md),\
>      \ and creatures there have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
>      \ on Dexterity ([Stealth](0.%20DM%20Screen/skills.md#Stealth)) checks.  \n\n\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/dragon/token/shadow-dragon-xmm.webp"
>```
^statblock
