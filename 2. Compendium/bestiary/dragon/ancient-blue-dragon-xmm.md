...
aliases:
- Ancient Blue Dragon
image: 2. Compendium/bestiary/dragon/img/ancient-blue-dragon.webp
tags: monster
---
# Ancient Blue Dragon
...
>      \ use of Spellcasting to cast [Shatter](2.%20Compendium/spells/shatter-xphb.md)\
>      \ (level 3 version)."
>    "name": "Multiattack"
...
>      \ will:** [Detect Magic](2.%20Compendium/spells/detect-magic-xphb.md), [Invisibility](2.%20Compendium/spells/invisibility-xphb.md),\
>      \ [Mage Hand](2.%20Compendium/spells/mage-hand-xphb.md), [Shatter](2.%20Compendium/spells/shatter-xphb.md)\
>      \ (level 3 version)\n\n**1/day each:** [Scrying](2.%20Compendium/spells/scrying-xphb.md),\
>      \ [Sending](2.%20Compendium/spells/sending-xphb.md)"
>    "name": "Spellcasting"
>"regional_effects":
...
>      \ in that area other than the dragon and its allies finishes a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md),\
...
>      \ within 1 mile of the lair. The area is [Lightly Obscured](0.%20DM%20Screen/variant-rules/lightly-obscured-xphb.md).\
...
>"legendary_actions":
>  - "desc": "The dragon uses Spellcasting to cast [Invisibility](2.%20Compendium/spells/invisibility-xphb.md)\
>      \ on itself, and it can fly up to half its [Fly Speed](0.%20DM%20Screen/variant-rules/fly-speed-xphb.md).\
>      \ The dragon can't take this action again until the start of its next turn."
>    "name": "Cloaked Flight"
>  - "desc": "The dragon uses Spellcasting to cast [Shatter](2.%20Compendium/spells/shatter-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/dragon/token/ancient-blue-dragon-xmm.webp"
>```
^statblock
