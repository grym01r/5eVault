...
aliases:
- Wyvern
image: 2. Compendium/bestiary/dragon/img/wyvern.webp
tags: monster
---
# Wyvern
...
>      \ damage plus 24 (7d6) Poison damage, and the target has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ condition until the start of the wyvern's next turn."
>    "name": "Sting"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/dragon/token/wyvern-xmm.webp"
>```
^statblock
