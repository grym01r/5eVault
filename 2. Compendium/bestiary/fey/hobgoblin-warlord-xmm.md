...
environment: desert, forest, grassland, hill, mountain, planar, acheron, underdark
cr: 6
...
aliases:
- Hobgoblin Warlord
image: 2. Compendium/bestiary/fey/img/hobgoblin-warlord.webp
tags: monster
---
# Hobgoblin Warlord
...
>"cr": "6"
>"traits":
>  - "desc": "While in a 30-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the hobgoblin, the hobgoblin and its allies have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
>      \ on attack rolls and saving throws, provided the hobgoblin doesn't have the\
>      \ [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated) condition."
...
>      \ *Hit:* 11 (2d6 + 4) Piercing damage, and the target's [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fey/token/hobgoblin-warlord-xmm.webp"
>```
^statblock
