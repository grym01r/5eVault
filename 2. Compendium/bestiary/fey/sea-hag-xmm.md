...
aliases:
- Sea Hag
image: 2. Compendium/books/monster-manual-2025/img/sea-hag.webp
tags: monster
---
# Sea Hag
...
>      \ save DC 11): [Augury](2.%20Compendium/spells/augury-xphb.md), [Find Familiar](2.%20Compendium/spells/find-familiar-xphb.md),\
...
>      \ damage."
>    "name": "Claw"
>  - "desc": "*Wisdom Saving Throw:* DC 11, one [Frightened](0.%20DM%20Screen/conditions.md#Frightened)\
>      \ creature the hag can see within 30 feet. *Failure:* If the target has 20 [Hit\
>      \ Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) or fewer, it drops\
>      \ to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md). Otherwise,\
>      \ the target takes 13 (3d8) Psychic damage."
>    "name": "Death Glare (Recharge 5-6)"
>  - "desc": "The hag casts [Disguise Self](2.%20Compendium/spells/disguise-self-xphb.md),\
>      \ using Constitution as the spellcasting ability (spell save DC 13). The spell's\
>      \ duration is 24 hours.\n"
>    "name": "Illusory Appearance"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fey/token/sea-hag-xmm.webp"
>```
^statblock
