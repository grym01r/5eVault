...
aliases:
- Satyr Revelmaster
image: 2. Compendium/bestiary/fey/img/satyrs.webp
tags: monster
---
# Satyr Revelmaster
...
>"cr": "6"
>"traits":
>  - "desc": "The satyr has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>      \ damage, and the target has the [Charmed](0.%20DM%20Screen/conditions.md#Charmed)\
...
>      \ DC 14, each enemy in a 60-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the satyr. *Failure:* The target is subjected to the song's\
>      \ effect:\n\n- **Charming.** The target has the [Charmed](0.%20DM%20Screen/conditions.md#Charmed)\
>      \ condition for 1 minute. While [Charmed](0.%20DM%20Screen/conditions.md#Charmed),\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fey/token/satyr-revelmaster-xmm.webp"
>```
^statblock
