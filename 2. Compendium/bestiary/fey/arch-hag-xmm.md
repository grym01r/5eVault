...
aliases:
- Arch-hag
image: 2. Compendium/bestiary/fey/img/arch-hag.webp
tags: monster
---
# Arch-hag
...
>  - "wisdom": !!int "11"
>"skillsaves":
>  - "name": "[Deception](0.%20DM%20Screen/skills.md#Deception)"
>    "desc": "+14"
>  - "name": "[Perception](0.%20DM%20Screen/skills.md#Perception)"
>    "desc": "+11"
>  - "name": "[Persuasion](0.%20DM%20Screen/skills.md#Persuasion)"
>    "desc": "+21"
...
>"senses": "[truesight](0.%20DM%20Screen/senses.md#Truesight) 60 ft., passive Perception\
>  \ 21"
>"languages": "all"
>"cr": "21"
>"traits":
...
>      \ save DC 19): [Augury](2.%20Compendium/spells/augury-xphb.md), [Find Familiar](2.%20Compendium/spells/find-familiar-xphb.md),\
>      \ [Identify](2.%20Compendium/spells/identify-xphb.md), [Locate Object](2.%20Compendium/spells/locate-object-xphb.md),\
>      \ [Scrying](2.%20Compendium/spells/scrying-xphb.md), or [Unseen Servant](2.%20Compendium/spells/unseen-servant-xphb.md).\
>      \ The hag must finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md)\
>      \ before using this trait to cast that spell again.\n"
>    "name": "Coven Magic"
>  - "desc": "If the hag fails a saving throw, it can choose to succeed instead."
>    "name": "Legendary Resistance (4/Day, or 5/Day in Lair)"
>  - "desc": "The hag has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
>      \ on saving throws against spells and other magical effects."
>    "name": "Magic Resistance"
>  - "desc": "When the hag drops to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md),\
>      \ it dies only if it is within 30 feet of its anathema (a thing the DM chooses\
>      \ as the hag's most hated thing). Otherwise, the hag drops to 1 [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
...
>      \ [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on ability\
...
>      \ it has the [Prone](0.%20DM%20Screen/conditions.md#Prone) condition."
>    "name": "Spectral Claw"
>  - "desc": "*Dexterity Saving Throw:* DC 22, each creature in a 60-foot [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md).\
...
>      \ will:** [Detect Thoughts](2.%20Compendium/spells/detect-thoughts-xphb.md),\
>      \ [Dimension Door](2.%20Compendium/spells/dimension-door-xphb.md), [Dispel\
>      \ Magic](2.%20Compendium/spells/dispel-magic-xphb.md), [Hypnotic Pattern](2.%20Compendium/spells/hypnotic-pattern-xphb.md)\n\
>      \n**2/day each:** [Mass Suggestion](2.%20Compendium/spells/mass-suggestion-xphb.md),\
>      \ [Modify Memory](2.%20Compendium/spells/modify-memory-xphb.md), [Plane Shift](2.%20Compendium/spells/plane-shift-xphb.md)"
>    "name": "Spellcasting"
>"bonus_actions":
...
>    "name": "Witch Strike"
>"reactions":
>  - "desc": "The hag casts [Counterspell](2.%20Compendium/spells/counterspell-xphb.md)\
...
>      \ ability check they make when they take the [Influence](0.%20DM%20Screen/actions.md#Influence)\
>      \ action.  \n- **Meddlesome Magic.** Whenever a creature other than the hag\
>      \ or its allies finishes a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md)\
>      \ while within 1 mile of the lair, the next time that creature casts a spell\
>      \ using a spell slot, it also casts [Confusion](2.%20Compendium/spells/confusion-xphb.md)\
>      \ centered on itself. The spell uses the creature's spellcasting ability and\
>      \ doesn't require [Concentration](0.%20DM%20Screen/conditions.md#Concentration).\
...
>    "name": "Hag's Swipe"
>  - "desc": "The hag uses Spellcasting to cast [Dimension Door](2.%20Compendium/spells/dimension-door-xphb.md)\
>      \ or [Hypnotic Pattern](2.%20Compendium/spells/hypnotic-pattern-xphb.md). The\
>      \ hag can't take this action again until the start of its next turn."
>    "name": "Malicious Magic"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fey/token/arch-hag-xmm.webp"
>```
^statblock
