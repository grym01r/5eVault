...
aliases:
- Night Hag
image: 2. Compendium/books/monster-manual-2025/img/night-hag.webp
tags: monster
---
# Night Hag
...
>"condition_immunities": "[charmed](0.%20DM%20Screen/conditions.md#Charmed)"
...
>      \ save DC 14): [Augury](2.%20Compendium/spells/augury-xphb.md), [Find Familiar](2.%20Compendium/spells/find-familiar-xphb.md),\
...
>      \ use its Nightmare Haunting action.\n\nThe bag has AC 15, HP 20, and [Resistance](0.%20DM%20Screen/variant-rules/resistance-xphb.md)\
>      \ to all damage. The bag turns to dust if reduced to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md).\
...
>      **At will:** [Detect Magic](2.%20Compendium/spells/detect-magic-xphb.md), [Etherealness](2.%20Compendium/spells/etherealness-xphb.md),\
>      \ [Magic Missile](2.%20Compendium/spells/magic-missile-xphb.md) (level 4 version)\n\
>      \n**2/day each:** [Phantasmal Killer](2.%20Compendium/spells/phantasmal-killer-xphb.md),\
>      \ [Plane Shift](2.%20Compendium/spells/plane-shift-xphb.md) (self only)"
>    "name": "Spellcasting"
>  - "desc": "While on the Ethereal Plane, the hag casts [Dream](2.%20Compendium/spells/dream-xphb.md),\
...
>      \ the effect of the [Protection from Evil and Good](2.%20Compendium/spells/protection-from-evil-and-good-xphb.md)\
>      \ spell or within a [Magic Circle](2.%20Compendium/spells/magic-circle-xphb.md)\
>      \ spell.\n\nIf the target takes damage from the [Dream](2.%20Compendium/spells/dream-xphb.md)\
>      \ spell, the target's [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fiend/token/night-hag-xmm.webp"
>```
^statblock
