...
aliases:
- Pit Fiend
image: 2. Compendium/bestiary/fiend/img/pit-fiend.webp
tags: monster
---
# Pit Fiend
...
>      \ [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) somewhere\
>      \ in the Nine Hells."
>    "name": "Diabolical Restoration"
>  - "desc": "The pit fiend emanates an aura in a 20-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ while it doesn't have the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated)\
>      \ condition. *Wisdom Saving Throw:* DC 21, any enemy that starts its turn in\
>      \ the aura. *Failure:* The target has the [Frightened](0.%20DM%20Screen/conditions.md#Frightened)\
...
>  - "desc": "The pit fiend has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>      \ *Constitution Saving Throw:* DC 21. *Failure:* The target has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ condition. While [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned), the\
>      \ target can't regain [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
...
>    "name": "Fiery Mace"
>  - "desc": "The pit fiend casts [Fireball](2.%20Compendium/spells/fireball-xphb.md)\
>      \ (level 5 version) twice, requiring no Material components and using Charisma\
>      \ as the spellcasting ability (spell save DC 21). It can replace one [Fireball](2.%20Compendium/spells/fireball-xphb.md)\
>      \ with [Hold Monster](2.%20Compendium/spells/hold-monster-xphb.md) (level 7\
>      \ version) or [Wall of Fire](2.%20Compendium/spells/wall-of-fire-xphb.md).\n"
>    "name": "Hellfire Spellcasting (Recharge 4-6)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fiend/token/pit-fiend-xmm.webp"
>```
^statblock
