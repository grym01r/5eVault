...
aliases:
- Chain Devil
image: 2. Compendium/bestiary/fiend/img/chain-devil.webp
tags: monster
---
# Chain Devil
...
>"senses": "[darkvision](0.%20DM%20Screen/senses.md#Darkvision) 120 ft. (unimpeded\
>  \ by magical [Darkness](0.%20DM%20Screen/variant-rules/darkness-xphb.md)), passive\
>  \ Perception 11"
...
>  - "desc": "The devil has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>      \ condition (escape DC 14) from one of two chains, and it has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
...
>      \ (2d4 + 4) Fire damage, and the target has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
...
>      \ the triggering creature. *Failure:* The target has the [Frightened](0.%20DM%20Screen/conditions.md#Frightened)\
>      \ condition until the end of its turn. *Success:* The target is immune to this\
>      \ devil's Unnerving Gaze for 24 hours."
>    "name": "Unnerving Gaze"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fiend/token/chain-devil-xmm.webp"
>```
^statblock
