...
aliases:
- Nalfeshnee
image: 2. Compendium/books/monster-manual-2025/img/nalfeshnee.webp
tags: monster
---
# Nalfeshnee
...
>  - "desc": "The nalfeshnee has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>    "name": "Teleport"
>"bonus_actions":
>  - "desc": "*Wisdom Saving Throw:* DC 15, each creature in a 15-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fiend/token/nalfeshnee-xmm.webp"
>```
^statblock
