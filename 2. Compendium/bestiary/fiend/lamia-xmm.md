...
aliases:
- Lamia
image: 2. Compendium/bestiary/fiend/img/lamia.webp
tags: monster
---
# Lamia
...
>      \ hour. Until the curse ends, the target has the [Charmed](0.%20DM%20Screen/conditions.md#Charmed)\
>      \ and [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned) conditions."
>    "name": "Corrupting Touch"
>  - "desc": "The lamia casts one of the following spells, requiring no Material components\
>      \ and using Charisma as the spellcasting ability (spell save DC 13):\n\n**At\
>      \ will:** [Disguise Self](2.%20Compendium/spells/disguise-self-xphb.md) (can\
>      \ appear as a Large or Medium biped), [Minor Illusion](2.%20Compendium/spells/minor-illusion-xphb.md)\n\
>      \n**1/day each:** [Geas](2.%20Compendium/spells/geas-xphb.md), [Major Image](2.%20Compendium/spells/major-image-xphb.md),\
>      \ [Scrying](2.%20Compendium/spells/scrying-xphb.md)"
>    "name": "Spellcasting"
>"bonus_actions":
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fiend/token/lamia-xmm.webp"
>```
^statblock
