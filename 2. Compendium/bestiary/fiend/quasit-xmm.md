...
aliases:
- Quasit
image: 2. Compendium/books/monster-manual-2025/img/quasit.webp
tags: monster
---
# Quasit
...
>"cr": "1"
>"traits":
>  - "desc": "The quasit has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>    "name": "Scare (1/Day)"
>  - "desc": "The quasit shape-shifts to resemble a bat ([Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
...
>      \ same in each form, except for its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md).\
>      \ Any equipment it is wearing or carrying isn't transformed."
>    "name": "Shape-Shift"
>  - "desc": "The quasit casts [Invisibility](2.%20Compendium/spells/invisibility-xphb.md)\
...
>  - "XMM"
>  - "XPHB"
>"image": "2.%20Compendium/bestiary/fiend/token/quasit-xmm.webp"
>```
^statblock
