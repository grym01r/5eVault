...
aliases:
- Vrock
image: 2. Compendium/bestiary/fiend/img/vrock.webp
tags: monster
---
# Vrock
...
>  - "desc": "The vrock has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>    "name": "Shred"
>  - "desc": "*Constitution Saving Throw:* DC 15, each creature in a 20-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the vrock. *Failure:* The target has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ condition and repeats the save at the end of each of its turns, ending the\
>      \ effect on itself on a success. While [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned),\
...
>      \ Thunder damage, and the target has the [Stunned](0.%20DM%20Screen/conditions.md#Stunned)\
>      \ condition until the end of the vrock's next turn."
>    "name": "Stunning Screech (1/Day)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fiend/token/vrock-xmm.webp"
>```
^statblock
