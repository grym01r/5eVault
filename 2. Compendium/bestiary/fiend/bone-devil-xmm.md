...
aliases:
- Bone Devil
image: 2. Compendium/bestiary/fiend/img/bone-devil.webp
tags: monster
---
# Bone Devil
...
>      \ damage plus 18 (4d8) Poison damage, and the target has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ condition until the start of the devil's next turn. While [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned),\
>      \ the target can't regain [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)."
>    "name": "Infernal Sting"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fiend/token/bone-devil-xmm.webp"
>```
^statblock
