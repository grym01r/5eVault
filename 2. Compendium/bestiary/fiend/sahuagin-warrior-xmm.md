...
aliases:
- Sahuagin Warrior
image: 2. Compendium/bestiary/fiend/img/sahuagin-warrior.webp
tags: monster
---
# Sahuagin Warrior
...
>    "name": "Claw"
>"bonus_actions":
>  - "desc": "The sahuagin swims up to its [Swim Speed](0.%20DM%20Screen/variant-rules/swim-speed-xphb.md)\
>      \ straight toward an enemy it can see."
>    "name": "Aquatic Charge"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fiend/token/sahuagin-warrior-xmm.webp"
>```
^statblock
