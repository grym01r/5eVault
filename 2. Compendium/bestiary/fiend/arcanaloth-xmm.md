...
aliases:
- Arcanaloth
image: 2. Compendium/bestiary/fiend/img/arcanaloth.webp
tags: monster
---
# Arcanaloth
...
>"condition_immunities": "[charmed](0.%20DM%20Screen/conditions.md#Charmed), [poisoned](0.%20DM%20Screen/conditions.md#Poisoned)"
...
>      \ and it gains a new body instantly and revives with all its [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ in Gehenna."
>    "name": "Fiendish Restoration"
>  - "desc": "The arcanaloth has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>      \ 35; and [Immunity](0.%20DM%20Screen/variant-rules/immunity-xphb.md) to Necrotic,\
>      \ Poison, and Psychic damage. The tome regains all its [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
...
>      \ create a new one when it finishes a [Short](0.%20DM%20Screen/variant-rules/short-rest-xphb.md)\
>      \ or [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md)."
>    "name": "Soul Tome"
>"actions":
...
>      \ to the tome and can escape only if the tome is reduced to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)."
...
>      \ DC 17):\n\n**At will:** [Alter Self](2.%20Compendium/spells/alter-self-xphb.md),\
>      \ [Detect Magic](2.%20Compendium/spells/detect-magic-xphb.md), [Identify](2.%20Compendium/spells/identify-xphb.md),\
>      \ [Mage Hand](2.%20Compendium/spells/mage-hand-xphb.md), [Prestidigitation](2.%20Compendium/spells/prestidigitation-xphb.md)\n\
>      \n**1/day each:** [Contact Other Plane](2.%20Compendium/spells/contact-other-plane-xphb.md),\
>      \ [Detect Thoughts](2.%20Compendium/spells/detect-thoughts-xphb.md), [Dimension\
>      \ Door](2.%20Compendium/spells/dimension-door-xphb.md), [Mind Blank](2.%20Compendium/spells/mind-blank-xphb.md)"
>    "name": "Spellcasting"
>"bonus_actions":
...
>    "name": "Teleport"
>"reactions":
>  - "desc": "The arcanaloth casts [Counterspell](2.%20Compendium/spells/counterspell-xphb.md)\
>      \ in response to that spell's trigger, using the same spellcasting ability as\
>      \ Spellcasting.\n"
>    "name": "Counterspell"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fiend/token/arcanaloth-xmm.webp"
>```
^statblock
