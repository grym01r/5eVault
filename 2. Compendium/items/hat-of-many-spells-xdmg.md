...
While holding the hat, you can use it as a [Spellcasting Focus](0.%20DM%20Screen/variant-rules/spellcasting-focus-xphb.md) for your Wizard spells. Any spell you cast using the hat gains a special Somatic component: you must reach into the hat and "pull" the spell out of it.

## Unknown Spell

While holding the hat, you can try to cast a level 1+ spell you don't know. The spell must be on the Wizard spell list, it must be of a level you can cast, and it can't have Material components costing more than 1,000 GP. Once you decide on the spell, you must expend a spell slot of the spell's level. Then, to determine whether you cast the spell, make an Intelligence ([Arcana](0.%20DM%20Screen/skills.md#Arcana)) check (DC 10 plus the spell's level). On a successful check, you cast the spell using its normal casting time, and you can't use this property again until you finish a [Short](0.%20DM%20Screen/variant-rules/short-rest-xphb.md) or [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md). On a failed check, you fail to cast the spell and a random effect occurs instead, determined by rolling on the following table.
...
| 51-55 | You have the [Stunned](0.%20DM%20Screen/conditions.md#Stunned) condition until the end of your next turn, believing something awesome just happened. |
| 56-60 | A harmless swarm of butterflies fills a 10-foot [Cube](0.%20DM%20Screen/variant-rules/cube-area-of-effect-xphb.md) within 30 feet of yourself. The swarm disperses after 1 minute. |
...
| 66-70 | You suffer a bout of "magic sickness" and have the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned) condition for 1 hour. |
| 71-75 | You have the [Petrified](0.%20DM%20Screen/conditions.md#Petrified) condition until the end of your next turn. |
...
| 81-85 | A creature appears in an unoccupied space as close to you as possible. The creature isn't under your control and acts as it normally would, and it disappears after 1 hour or when it drops to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md). Roll `1d4` to determine the creature: on a **1**, a [Camel](camel-xmm.md); on a **2**, a [Constrictor Snake](constrictor-snake-xmm.md); on a **3**, an [Elephant](elephant-xmm.md); on a **4**, a [Mule](mule-xmm.md). |
| 86-90 | A [Hostile](0.%20DM%20Screen/variant-rules/hostile-attitude-xphb.md) [Swarm of Bats](swarm-of-bats-xmm.md) flies out of the hat, occupies your space, and attacks you. |
