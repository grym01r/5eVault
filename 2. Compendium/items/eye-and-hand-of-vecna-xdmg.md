...
image: 2. Compendium/items/img/eye-and-hand-of-vecna.webp
tags: Item
---
# Eye and Hand of Vecna
...
- 1 [minor beneficial](0.%20DM%20Screen/tables/artifact-properties-minor-beneficial-properties-xdmg.md) property  
- 1 [major beneficial](0.%20DM%20Screen/tables/artifact-properties-major-beneficial-properties-xdmg.md) property  
...
- **Truesight.** You have [Truesight](0.%20DM%20Screen/senses.md#Truesight) out to 240 feet.  
...
- **Spellcasting.** The hand has 8 charges and regains `1d4 + 4` expended charges daily at dawn. You can cast a spell on the [Hand of Vecna](hand-of-vecna-xdmg.md) Spells table from the hand (save DC 18). The table indicates how many charges you must expend to cast the spell. Each time you cast a spell from it, the hand casts [Suggestion](suggestion-xphb.md) on you (save DC 18; no [Concentration](0.%20DM%20Screen/conditions.md#Concentration) required), demanding that you commit an evil act. The hand might have a specific act in mind or leave it up to you.  
...
- **Danger Sense.** You have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on [Initiative](0.%20DM%20Screen/variant-rules/initiative-xphb.md) rolls.  
- **Necrotic Reduction.** As a [Magic](0.%20DM%20Screen/actions.md#Magic) action, you can target one creature you can see within 5 feet of yourself. The target makes a DC 18 Constitution saving throw, taking `7d6` Necrotic damage on a failed save or half as much damage on a successful one. A creature reduced to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) by this damage is transformed into [green slime](green-slime-xdmg.md) (see chapter 3) that covers the ground in its space, each 5-foot square of slime representing a separate patch. Nonmagical objects worn or carried by the target that are made of metal or organic material are destroyed by the slime.  
- **Poison Immunity.** You have [Immunity](0.%20DM%20Screen/variant-rules/immunity-xphb.md) to Poison damage and the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned) condition.  
- **Regeneration.** If you start your turn with at least 1 [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md), you regain `1d10` [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md).  
