...
image: 2. Compendium/items/img/amulet-of-the-planes.webp
tags: Item
---
# Amulet of the Planes
...
While wearing this amulet, you can take a [Magic](0.%20DM%20Screen/actions.md#Magic) action to name a location that you are familiar with on another plane of existence. Then make a DC 15 Intelligence ([Arcana](0.%20DM%20Screen/skills.md#Arcana)) check. On a successful check, you cast [Plane Shift](plane-shift-xphb.md). On a failed check, you and each creature and object within 15 feet of you travel to a random destination determined by rolling `1d100` and consulting the following table.
