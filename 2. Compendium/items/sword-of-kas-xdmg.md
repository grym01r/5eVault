...
aliases: 
- "Sword of Kas"
image: 2. Compendium/items/img/sword-of-kas.webp
tags: Item
---
# Sword of Kas
...
You gain a +3 bonus to attack rolls and damage rolls made with the sword, which scores a [Critical Hit](0.%20DM%20Screen/variant-rules/critical-hit-xphb.md) on a roll of 19 or 20 on the `d20` and deals an extra `2d10` Slashing damage to Undead.
...
- **Battle Hunger.** You add `1d10` to your [Initiative](0.%20DM%20Screen/variant-rules/initiative-xphb.md) rolls.  
- **Blade of Defense.** When you take an action to attack with the sword, you can transfer some or all of its attack bonus to your [Armor Class](0.%20DM%20Screen/variant-rules/armor-class-xphb.md) instead. The adjusted bonuses remain in effect until the start of your next turn.  
- **Necrotic Resistance.** You have [Resistance](0.%20DM%20Screen/variant-rules/resistance-xphb.md) to Necrotic damage.  

## Sentience

The Sword of Kas is a sentient Chaotic Evil weapon with an Intelligence of 15, a Wisdom of 13, and a Charisma of 16. It has hearing and [Darkvision](0.%20DM%20Screen/senses.md#Darkvision) out to 120 feet.
