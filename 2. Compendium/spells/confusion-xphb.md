...
| 7-8 | The target doesn't move, and it takes the [Attack](0.%20DM%20Screen/actions.md#Attack) action to make one melee attack against a random creature within reach. If none are within reach, the target takes no action. |
| 9-10 | The target chooses its behavior. |
^1-behavior-for-the-turn

At the end of each of its turns, an affected target repeats the save, ending the spell on itself on a success.

**Using a Higher-Level Spell Slot.** The [Sphere](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md)'s radius increases by 5 feet for each spell slot level above 4.

**References**:

- [Sorcerer](0.%20DM%20Screen/lists/list-spells-classes-sorcerer.md)
- [Bard](0.%20DM%20Screen/lists/list-spells-classes-bard.md)
- [Cleric (Trickery Domain)](0.%20DM%20Screen/lists/list-spells-classes-trickery-domain-xphb.md "subclass=XPHB;class=XPHB")
...
*Player's Handbook (2024) p. 253. Available in the <span title='Systems Reference Document (5.2)'>SRD</span> and the Free Rules (2024)*