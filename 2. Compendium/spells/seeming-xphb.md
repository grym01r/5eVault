...
A creature that takes the [Study](0.%20DM%20Screen/actions.md#Study) action to examine a target can make an Intelligence ([Investigation](0.%20DM%20Screen/skills.md#Investigation)) check against your spell save DC. If it succeeds, it becomes aware that the target is disguised.
