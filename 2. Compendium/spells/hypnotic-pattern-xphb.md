...
You create a twisting pattern of colors in a 30-foot [Cube](0.%20DM%20Screen/variant-rules/cube-area-of-effect-xphb.md) within range. The pattern appears for a moment and vanishes. Each creature in the area who can see the pattern must succeed on a Wisdom saving throw or have the [Charmed](0.%20DM%20Screen/conditions.md#Charmed) condition for the duration. While [Charmed](0.%20DM%20Screen/conditions.md#Charmed), the creature has the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated) condition and a [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md) of 0.
