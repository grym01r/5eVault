...
The wall is an object that can be damaged and thus breached. It has AC 12 and 30 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) per 10-foot section, and it has [Immunity](0.%20DM%20Screen/variant-rules/immunity-xphb.md) to Cold, Poison, and Psychic damage and [Vulnerability](0.%20DM%20Screen/variant-rules/vulnerability-xphb.md) to Fire damage. Reducing a 10-foot section of wall to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) destroys it and leaves behind a sheet of frigid air in the space the wall occupied.
