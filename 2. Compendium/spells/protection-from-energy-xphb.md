...
For the duration, the willing creature you touch has [Resistance](0.%20DM%20Screen/variant-rules/resistance-xphb.md) to one damage type of your choice: Acid, Cold, Fire, Lightning, or Thunder.
...
- [Sorcerer (Clockwork Sorcery)](0.%20DM%20Screen/lists/list-spells-classes-clockwork-sorcery-xphb.md "subclass=XPHB;class=XPHB")
...
*Player's Handbook (2024) p. 309. Available in the <span title='Systems Reference Document (5.2)'>SRD</span> and the Free Rules (2024)*