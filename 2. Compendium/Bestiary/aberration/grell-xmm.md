...
aliases:
- Grell
image: 2. Compendium/books/monster-manual-2025/img/grell.webp
tags: monster
---
# Grell
...
>"condition_immunities": "[blinded](0.%20DM%20Screen/conditions.md#Blinded), [prone](0.%20DM%20Screen/conditions.md#Prone)"
...
>      \ target has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned) condition\
>      \ and repeats the save at the end of each of its turns, ending the effect on\
>      \ itself on a success. After 1 minute, it succeeds automatically. While [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned),\
>      \ the target has the [Paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed) condition."
>    "name": "Paralyzing Tentacles"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/aberration/token/grell-xmm.webp"
>```
^statblock
