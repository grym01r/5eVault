...
aliases:
- Roper
image: 2. Compendium/bestiary/aberration/img/roper.webp
tags: monster
---
# Roper
...
>      \ damage."
>    "name": "Bite"
>  - "desc": "*Melee Attack Roll:* +7, reach 60 ft. *Hit:* The target has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ condition (escape DC 14) from one of six tentacles, and the target has the\
>      \ [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned) condition until the grapple\
>      \ ends.\n\nThe tentacle can be damaged, freeing a creature it has [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ when destroyed (AC 20, HP 10, [Immunity](0.%20DM%20Screen/variant-rules/immunity-xphb.md)\
...
>    "name": "Tentacle"
>  - "desc": "The roper pulls each creature [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ by it up to 30 feet straight toward it."
>    "name": "Reel"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/aberration/token/roper-xmm.webp"
>```
^statblock
