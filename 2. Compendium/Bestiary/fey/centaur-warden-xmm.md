...
aliases:
- Centaur Warden
image: 2. Compendium/bestiary/fey/img/centaurs.webp
tags: monster
---
# Centaur Warden
...
>    "name": "Spellcasting"
>"bonus_actions":
>  - "desc": "The centaur moves up to its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
...
>      \ + 4) Bludgeoning damage, and the target has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
>      \ condition until the end of its next turn."
>    "name": "Entangling Trail (Recharge 5-6)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fey/token/centaur-warden-xmm.webp"
>```
^statblock
