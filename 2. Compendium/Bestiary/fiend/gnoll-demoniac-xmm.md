...
aliases:
- Gnoll Demoniac
image: 2. Compendium/bestiary/fiend/img/gnolls.webp
tags: monster
---
# Gnoll Demoniac
...
>    "name": "Abyssal Strike"
>  - "desc": "The gnoll conjures a 30-foot [Cube](0.%20DM%20Screen/variant-rules/cube-area-of-effect-xphb.md)\
>      \ of magical [Darkness](0.%20DM%20Screen/variant-rules/darkness-xphb.md) originating\
>      \ from a point it can see within 60 feet, which lasts for 1 minute or until\
>      \ the gnoll's [Concentration](0.%20DM%20Screen/conditions.md#Concentration)\
>      \ ends on it. This area is [Difficult Terrain](0.%20DM%20Screen/variant-rules/difficult-terrain-xphb.md).\
...
>      \ Hit Points](0.%20DM%20Screen/variant-rules/temporary-hit-points-xphb.md).\
>      \ *Success:* Half damage only."
>    "name": "Hunger of Yeenoghu (Recharge 5-6)"
>"bonus_actions":
>  - "desc": "Immediately after dealing damage to a creature that is already [Bloodied](0.%20DM%20Screen/conditions.md#Bloodied),\
>      \ the gnoll moves up to half its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md),\
>      \ and it makes one Abyssal Strike attack."
>    "name": "Rampage (2/Day)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fiend/token/gnoll-demoniac-xmm.webp"
>```
^statblock
