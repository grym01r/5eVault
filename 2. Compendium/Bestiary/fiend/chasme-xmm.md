...
aliases:
- Chasme
image: 2. Compendium/books/monster-manual-2025/img/chasme.webp
tags: monster
---
# Chasme
...
>  - "desc": "The chasme has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>    "name": "Proboscis"
>"bonus_actions":
>  - "desc": "*Constitution Saving Throw:* DC 12, each creature in a 30-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the chasme (demons automatically succeed on this save). *Failure:*\
>      \ The target has the [Unconscious](0.%20DM%20Screen/conditions.md#Unconscious)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fiend/token/chasme-xmm.webp"
>```
^statblock
