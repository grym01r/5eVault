...
aliases:
- Sahuagin Baron
image: 2. Compendium/bestiary/fiend/img/sahuagin.webp
tags: monster
---
# Sahuagin Baron
...
>"cr": "5"
>"traits":
>  - "desc": "The sahuagin has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
>      \ on attack rolls against any creature that doesn't have all its [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)."
>    "name": "Blood Frenzy"
...
>      \ Saving Throw:* DC 14, each creature of the sahuagin's choice in a 5-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the sahuagin. *Failure:* 10 (3d6) Acid damage, and the\
>      \ target is cursed until it finishes a [Short](0.%20DM%20Screen/variant-rules/short-rest-xphb.md)\
>      \ or [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md). While cursed,\
>      \ the target can't benefit from the [Invisible](0.%20DM%20Screen/conditions.md#Invisible)\
>      \ condition, its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md) decreases\
>      \ by 10 feet, and all Fiends within 120 feet of the target can sense its location\
>      \ regardless of interposing obstacles."
>    "name": "Fiendish Blood"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fiend/token/sahuagin-baron-xmm.webp"
>```
^statblock
