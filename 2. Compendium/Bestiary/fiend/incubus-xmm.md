...
aliases:
- Incubus
image: 2. Compendium/bestiary/fiend/img/incubus.webp
tags: monster
---
# Incubus
...
>"cr": "4"
>"traits":
>  - "desc": "When the incubus finishes a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md),\
>      \ it can shape-shift into a [Succubus](0.%20DM%20Screen/bestiary/fiend/succubus-xmm.md),\
...
>      \n**At will:** [Disguise Self](2.%20Compendium/spells/disguise-self-xphb.md),\
>      \ [Etherealness](2.%20Compendium/spells/etherealness-xphb.md)\n\n**1/day each:**\
>      \ [Dream](2.%20Compendium/spells/dream-xphb.md), [Hypnotic Pattern](2.%20Compendium/spells/hypnotic-pattern-xphb.md)"
>    "name": "Spellcasting"
>"bonus_actions":
>  - "desc": "*Wisdom Saving Throw:* DC 15, one creature the incubus can see within\
>      \ 60 feet. *Failure:* If the target has 20 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ or fewer, it has the [Unconscious](0.%20DM%20Screen/conditions.md#Unconscious)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/fiend/token/incubus-xmm.webp"
>```
^statblock
