...
>      \ were [Difficult Terrain](0.%20DM%20Screen/variant-rules/difficult-terrain-xphb.md).\
...
>      \ [Bless](2.%20Compendium/spells/bless-xphb.md), [Lesser Restoration](2.%20Compendium/spells/lesser-restoration-xphb.md)\
>      \ (as an action)"
>    "name": "Spellcasting"
>"bonus_actions":
>  - "desc": "The empyrean casts [Healing Word](2.%20Compendium/spells/healing-word-xphb.md),\
>      \ using the same spellcasting ability as Spellcasting.\n"
>    "name": "Healing Word (1/Day)"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/miscellaneous/token/empyrean-iota-xmm.webp"
>```
^statblock
