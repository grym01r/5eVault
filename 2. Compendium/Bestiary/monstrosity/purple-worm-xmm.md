...
aliases:
- Purple Worm
image: 2. Compendium/books/monster-manual-2025/img/purple-worm.webp
tags: monster
---
# Purple Worm
...
>  - "constitution": !!int "11"
>  - "wisdom": !!int "4"
>"senses": "[blindsight](0.%20DM%20Screen/senses.md#Blindsight) 30 ft., tremorsense\
>  \ 60 ft., passive Perception 9"
>"languages": ""
>"cr": "15"
>"traits":
>  - "desc": "The worm can burrow through solid rock at half its [Burrow Speed](0.%20DM%20Screen/variant-rules/burrow-speed-xphb.md)\
...
>      \ condition (escape DC 19), and it has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
...
>    "name": "Tail Stinger"
>"bonus_actions":
>  - "desc": "*Strength Saving Throw:* DC 19, one Large or smaller creature [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ by the worm (it can have up to three creatures swallowed at a time). *Failure:*\
>      \ The target is swallowed by the worm, and the [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
...
>      \ the [Prone](0.%20DM%20Screen/conditions.md#Prone) condition. If the worm dies,\
>      \ any swallowed creature no longer has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
>      \ condition and can escape from the corpse using 20 feet of movement, exiting\
>      \ [Prone](0.%20DM%20Screen/conditions.md#Prone)."
>    "name": "Swallow"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/purple-worm-xmm.webp"
>```
^statblock
