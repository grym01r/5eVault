...
aliases:
- Wereboar
image: 2. Compendium/bestiary/monstrosity/img/werebear-wereboar-and-wererat.webp
tags: monster
---
# Wereboar
...
>      \ it instead becomes a Wereboar under the DM's control and has 10 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md).\
...
>      \ extra 7 (2d6) Piercing damage and has the [Prone](0.%20DM%20Screen/conditions.md#Prone)\
>      \ condition."
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/wereboar-xmm.webp"
>```
^statblock
