...
aliases:
- Tarrasque
image: 2. Compendium/bestiary/monstrosity/img/tarrasque.webp
tags: monster
---
# Tarrasque
...
>"condition_immunities": "[charmed](0.%20DM%20Screen/conditions.md#Charmed), [deafened](0.%20DM%20Screen/conditions.md#Deafened),\
>  \ [frightened](0.%20DM%20Screen/conditions.md#Frightened), [paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed),\
>  \ [poisoned](0.%20DM%20Screen/conditions.md#Poisoned)"
>"senses": "[blindsight](0.%20DM%20Screen/senses.md#Blindsight) 120 ft., passive Perception\
>  \ 19"
>"languages": ""
>"cr": "30"
>"traits":
...
>  - "desc": "The tarrasque has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
>      \ on saving throws against spells and other magical effects."
>    "name": "Magic Resistance"
>  - "desc": "If the tarrasque is targeted by a [Magic Missile](2.%20Compendium/spells/magic-missile-xphb.md)\
...
>      \ damage, and the target has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ condition (escape DC 20). Until the grapple ends, the target has the [Restrained](0.%20DM%20Screen/conditions.md#Restrained)\
...
>      \ damage. If the target is a Huge or smaller creature, it has the [Prone](0.%20DM%20Screen/conditions.md#Prone)\
>      \ condition."
>    "name": "Tail"
>  - "desc": "*Constitution Saving Throw:* DC 27, each creature and each object that\
>      \ isn't being worn or carried in a 150-foot [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md).\
>      \ *Failure:* 78 (12d12) Thunder damage, and the target has the [Deafened](0.%20DM%20Screen/conditions.md#Deafened)\
>      \ and [Frightened](0.%20DM%20Screen/conditions.md#Frightened) conditions until\
>      \ the end of its next turn. *Success:* Half damage only."
>    "name": "Thunderous Bellow (Recharge 5-6)"
>"bonus_actions":
>  - "desc": "*Strength Saving Throw:* DC 27, one Large or smaller creature [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ by the tarrasque (it can have up to six creatures swallowed at a time). *Failure:*\
>      \ The target is swallowed, and the [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ condition ends. A swallowed creature has the [Blinded](0.%20DM%20Screen/conditions.md#Blinded)\
>      \ and [Restrained](0.%20DM%20Screen/conditions.md#Restrained) conditions and\
>      \ can't teleport, it has [Total Cover](0.%20DM%20Screen/variant-rules/cover-xphb.md)\
...
>      \ 10 feet of the tarrasque and has the [Prone](0.%20DM%20Screen/conditions.md#Prone)\
>      \ condition. If the tarrasque dies, any swallowed creature no longer has the\
>      \ [Restrained](0.%20DM%20Screen/conditions.md#Restrained) condition and can\
>      \ escape from the corpse using 20 feet of movement, exiting [Prone](0.%20DM%20Screen/conditions.md#Prone)."
>    "name": "Swallow"
...
>"legendary_actions":
>  - "desc": "The tarrasque moves up to half its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md),\
>      \ and it makes one Claw or Tail attack."
>    "name": "Onslaught"
>  - "desc": "The tarrasque moves up to its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md).\
>      \ At the end of this movement, the tarrasque creates an instantaneous shock\
>      \ wave in a 60-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from itself. Creatures in that area lose [Concentration](0.%20DM%20Screen/conditions.md#Concentration)\
>      \ and, if Medium or smaller, have the [Prone](0.%20DM%20Screen/conditions.md#Prone)\
>      \ condition. The tarrasque can't take this action again until the start of its\
>      \ next turn."
>    "name": "World-Shaking Movement"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/tarrasque-xmm.webp"
>```
^statblock
