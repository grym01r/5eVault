...
aliases:
- Harpy
image: 2. Compendium/books/monster-manual-2025/img/harpy.webp
tags: monster
---
# Harpy
...
>      \ damage."
>    "name": "Claw"
>  - "desc": "The harpy sings a magical melody, which lasts until the harpy's [Concentration](0.%20DM%20Screen/conditions.md#Concentration)\
...
>      \ the [Charmed](0.%20DM%20Screen/conditions.md#Charmed) condition until the\
>      \ song ends and repeats the save at the end of each of its turns. While [Charmed](0.%20DM%20Screen/conditions.md#Charmed),\
...
>      \ avoid [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack);\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/harpy-xmm.webp"
>```
^statblock
