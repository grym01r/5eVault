...
aliases:
- Yeti
image: 2. Compendium/bestiary/monstrosity/img/yeti.webp
tags: monster
---
# Yeti
...
>"cr": "3"
>"traits":
>  - "desc": "If the yeti takes Fire damage, it has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
...
>      \ 30 feet. *Failure:* 5 (2d4) Cold damage, and the target has the [Paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed)\
>      \ condition until the start of the yeti's next turn unless the target has [Immunity](0.%20DM%20Screen/variant-rules/immunity-xphb.md)\
>      \ to Cold damage. *Success:* The target is immune to the Chilling Gaze of all\
>      \ yetis (but not abominable yetis) for 1 hour."
>    "name": "Chilling Gaze"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/yeti-xmm.webp"
>```
^statblock
