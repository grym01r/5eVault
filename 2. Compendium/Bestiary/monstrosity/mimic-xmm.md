...
aliases:
- Mimic
image: 2. Compendium/books/monster-manual-2025/img/mimic.webp
tags: monster
---
# Mimic
...
>      \ adhered to the mimic has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
>      \ condition (escape DC 13). Ability checks made to escape this grapple have\
>      \ [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)."
>    "name": "Adhesive (Object Form Only)"
>"actions":
>  - "desc": "*Melee Attack Roll:* +5 (with [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
>      \ if the target is [Grappled](0.%20DM%20Screen/conditions.md#Grappled) by the\
>      \ mimic), reach 5 ft. *Hit:* 7 (1d8 + 3) Piercing damage—or 12 (2d8 + 3)\
>      \ Piercing damage if the target is [Grappled](0.%20DM%20Screen/conditions.md#Grappled)\
...
>      \ it has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled) condition (escape\
>      \ DC 13). Ability checks made to escape this grapple have [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)."
>    "name": "Pseudopod"
>"bonus_actions":
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/monstrosity/token/mimic-xmm.webp"
>```
^statblock
