...
aliases:
  - Giant Insect
image: 2. Compendium/bestiary/beast/img/giant-insect.webp
tags: monster
---
# Giant Insect
...
>      \ can see within 10 feet. *Failure:* The target has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ condition until the start of the insect's next turn."
>    "name": "Venomous Spew (Centipede Only)"
>"source":
>  - "XPHB"
>"image": "2.%20Compendium/bestiary/beast/token/giant-insect-xphb.webp"
>```
^statblock
