...
aliases:
- Magmin
image: 2. Compendium/books/monster-manual-2025/img/magmin.webp
tags: monster
---
# Magmin
...
>      \ creature in a 10-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
...
>      \ carried, it starts [burning](0.%20DM%20Screen/traps-hazards/burning-xphb.md)."
>    "name": "Touch"
>"bonus_actions":
>  - "desc": "The magmin sets itself ablaze or extinguishes its flames. While ablaze,\
>      \ the magmin sheds [Bright Light](0.%20DM%20Screen/variant-rules/bright-light-xphb.md)\
>      \ in a 10-foot radius and [Dim Light](0.%20DM%20Screen/variant-rules/dim-light-xphb.md)\
>      \ for an additional 10 feet."
>    "name": "Ignited Illumination"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/elemental/token/magmin-xmm.webp"
>```
^statblock
