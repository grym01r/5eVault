...
aliases:
- Xorn
image: 2. Compendium/books/monster-manual-2025/img/xorn.webp
tags: monster
---
# Xorn
...
>"condition_immunities": "[paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed), [petrified](0.%20DM%20Screen/conditions.md#Petrified),\
...
>    "name": "Claw"
>"bonus_actions":
>  - "desc": "The xorn moves up to its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md)\
>      \ or [Burrow Speed](0.%20DM%20Screen/variant-rules/burrow-speed-xphb.md) straight\
>      \ toward an enemy it can sense."
>    "name": "Charge"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/elemental/token/xorn-xmm.webp"
>```
^statblock
