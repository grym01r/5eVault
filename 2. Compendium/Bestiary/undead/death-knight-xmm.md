...
aliases:
- Death Knight
image: 2. Compendium/bestiary/undead/img/death-knights.webp
tags: monster
---
# Death Knight
...
>  \ [frightened](0.%20DM%20Screen/conditions.md#Frightened), [poisoned](0.%20DM%20Screen/conditions.md#Poisoned)"
...
>  - "desc": "The death knight has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
>      \ on saving throws against spells and other magical effects."
>    "name": "Magic Resistance"
>  - "desc": "Undead creatures of the death knight's choice (excluding itself) in a\
>      \ 60-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from it have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
>      \ on attack rolls and saving throws. It can't use this trait if it has the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated)\
>      \ condition."
>    "name": "Marshal Undead"
>  - "desc": "If the death knight is destroyed before it atones for its evil, it gains\
>      \ a new body in 1d10 days, reviving with all its [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md).\
...
>    "name": "Dread Blade"
>  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 20-foot-radius [Sphere](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md)\
...
>      \n**At will:** [Command](2.%20Compendium/spells/command-xphb.md), [Phantom\
>      \ Steed](2.%20Compendium/spells/phantom-steed-xphb.md)\n\n**2/day each:** [Destructive\
>      \ Wave](2.%20Compendium/spells/destructive-wave-xphb.md) (Necrotic), [Dispel\
>      \ Magic](2.%20Compendium/spells/dispel-magic-xphb.md)"
>    "name": "Spellcasting"
>"reactions":
...
>"legendary_actions":
>  - "desc": "The death knight uses Spellcasting to cast [Command](2.%20Compendium/spells/command-xphb.md).\
...
>      \ [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) maximum decreases\
>      \ by an amount equal to the damage taken. *Failure or Success:* The death knight\
>      \ can't take this action again until the start of its next turn."
>    "name": "Fell Word"
>  - "desc": "The death knight moves up to half its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md),\
>      \ and it makes one Dread Blade attack."
>    "name": "Lunge"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/death-knight-xmm.webp"
>```
^statblock
