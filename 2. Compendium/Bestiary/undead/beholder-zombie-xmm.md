...
aliases:
- Beholder Zombie
image: 2. Compendium/bestiary/undead/img/zombies.webp
tags: monster
---
# Beholder Zombie
...
>"cr": "5"
>"traits":
>  - "desc": "If damage reduces the zombie to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md),\
>      \ it makes a Constitution saving throw (DC 5 plus the damage taken) unless the\
>      \ damage is Radiant or from a [Critical Hit](0.%20DM%20Screen/variant-rules/critical-hit-xphb.md).\
>      \ On a successful save, the zombie drops to 1 [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ instead."
...
>      \ Saving Throw:* DC 14. *Failure:* The target has the [Paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed)\
...
>      \ has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned) condition until\
>      \ the end of its next turn. While [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned),\
...
>      \ object or a creation of magical force, a 10-foot [Cube](0.%20DM%20Screen/variant-rules/cube-area-of-effect-xphb.md)\
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/beholder-zombie-xmm.webp"
>```
^statblock
