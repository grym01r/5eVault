...
aliases:
  - Undead Spirit
image: 2. Compendium/bestiary/undead/img/undead-spirit.webp
tags: monster
---
# Undead Spirit
...
>      \ from the spirit. *Failure:* The creature has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
...
>      \ the [Frightened](0.%20DM%20Screen/conditions.md#Frightened) condition until\
...
>      \ the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned) condition, it has\
>      \ the [Paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed) condition until\
>      \ the end of its next turn."
>    "name": "Rotting Claw (Putrid Only)"
>"source":
>  - "XPHB"
>"image": "2.%20Compendium/bestiary/undead/token/undead-spirit-xphb.webp"
>```
^statblock
