...
aliases:
- Dracolich
image: 2. Compendium/books/monster-manual-2025/img/dracolich.webp
tags: monster
---
# Dracolich
...
>"senses": "[blindsight](0.%20DM%20Screen/senses.md#Blindsight) 60 ft., [darkvision](0.%20DM%20Screen/senses.md#Darkvision)\
...
>  - "desc": "Creatures within 60 feet of the dracolich can't regain [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)."
>    "name": "Life Suppression"
>  - "desc": "The dracolich has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md)\
...
>      \ body in 1d20 days, regaining all its [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ and appearing within 5 feet of the gem.\n\nThe gem is a Tiny object that has\
>      \ AC 20; HP 50; and [Immunity](0.%20DM%20Screen/variant-rules/immunity-xphb.md)\
>      \ to Necrotic, Poison, and Psychic damage. The gem regains all its [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ at the end of every turn, but it turns to dust if reduced to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md).\
...
>      \ a use of Spellcasting to cast [Ray of Sickness](2.%20Compendium/spells/ray-of-sickness-xphb.md)\
>      \ (level 2 version)."
>    "name": "Multiattack"
>  - "desc": "*Melee Attack Roll:* +13, reach 10 ft. *Hit:* 18 (2d10 + 7) Slashing\
>      \ damage plus 4 (1d8) Necrotic damage."
>    "name": "Rend"
>  - "desc": "*Constitution Saving Throw:* DC 20, each creature in a 60-foot [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md).\
...
>      \ +11 to hit with spell attacks):\n\n**At will:** [Detect Magic](2.%20Compendium/spells/detect-magic-xphb.md),\
>      \ [Ray of Sickness](2.%20Compendium/spells/ray-of-sickness-xphb.md) (level\
>      \ 2 version)\n\n**1/day each:** [Create Undead](2.%20Compendium/spells/create-undead-xphb.md)\
>      \ (level 8 version), [Finger of Death](2.%20Compendium/spells/finger-of-death-xphb.md)"
>    "name": "Spellcasting"
>"regional_effects":
...
>      \ lair is [Lightly Obscured](0.%20DM%20Screen/variant-rules/lightly-obscured-xphb.md)\
>      \ by pale fog. Whenever a creature other than the dracolich or one of its allies\
>      \ finishes a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md) in\
>      \ that area, it must succeed on a DC 15 Constitution saving throw or gain 1\
>      \ [Exhaustion](0.%20DM%20Screen/conditions.md#Exhaustion) level.  \n- **Soul\
>      \ Drain.** Creatures within 1 mile of the lair have [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md)\
...
>"legendary_actions":
>  - "desc": "The dracolich moves up to half its [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md),\
>      \ and it makes one Rend attack."
>    "name": "Pounce"
>  - "desc": "The dracolich uses Spellcasting to cast [Ray of Sickness](2.%20Compendium/spells/ray-of-sickness-xphb.md)\
>      \ (level 2 version). The dracolich can't take this action again until the start\
>      \ of its next turn."
>    "name": "Sickening Ray"
>  - "desc": "*Wisdom Saving Throw:* DC 19, each creature in a 30-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md)\
>      \ originating from the dracolich. *Failure:* 11 (2d10) Psychic damage, and\
>      \ the target has the [Frightened](0.%20DM%20Screen/conditions.md#Frightened)\
>      \ condition until the end of its next turn. *Failure or Success:* The dracolich\
>      \ can't take this action again until the start of its next turn."
>    "name": "Terrifying Presence"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/dracolich-xmm.webp"
>```
^statblock
