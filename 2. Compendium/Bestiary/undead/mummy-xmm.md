...
aliases:
- Mummy
image: 2. Compendium/bestiary/undead/img/mummies.webp
tags: monster
---
# Mummy
...
>      \ its [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) maximum\
...
>      \ feet. *Failure:* The target has the [Frightened](0.%20DM%20Screen/conditions.md#Frightened)\
>      \ condition until the end of the mummy's next turn. *Success:* The target is\
>      \ immune to this mummy's Dreadful Glare for 24 hours."
>    "name": "Dreadful Glare"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/mummy-xmm.webp"
>```
^statblock
