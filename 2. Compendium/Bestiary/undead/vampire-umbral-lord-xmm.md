...
aliases:
- Vampire Umbral Lord
image: 2. Compendium/bestiary/undead/img/vampire-umbral-lord.webp
tags: monster
---
# Vampire Umbral Lord
...
>      \ inside its resting place, it has the [Paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed)\
>      \ condition for 1 hour, after which it regains 1 [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)."
>    "name": "Shadow Escape"
...
>      \ damage, and the target has the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned)\
>      \ condition until the start of the vampire's next turn."
>    "name": "Sickening Ray"
>  - "desc": "The vampire casts [Hunger of Hadar](2.%20Compendium/spells/hunger-of-hadar-xphb.md)\
...
>      \ Necrotic damage. The target's [Hit Point](0.%20DM%20Screen/variant-rules/hit-points-xphb.md)\
>      \ maximum decreases by an amount equal to the damage taken, and the vampire\
>      \ regains [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) equal\
>      \ to that amount."
>    "name": "Sanguine Drain"
>"regional_effects":
...
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/vampire-umbral-lord-xmm.webp"
>```
^statblock
