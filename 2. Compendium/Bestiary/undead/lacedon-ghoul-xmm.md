...
aliases:
- Lacedon Ghoul
image: 2. Compendium/bestiary/undead/img/lacedon-ghoul.webp
tags: monster
---
# Lacedon Ghoul
...
>      \ and the target's [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md) decreases\
...
>      \ target has the [Paralyzed](0.%20DM%20Screen/conditions.md#Paralyzed) condition\
>      \ until the end of its next turn."
>    "name": "Claw"
>"bonus_actions":
>  - "desc": "While underwater, the ghoul moves up to half its [Swim Speed](0.%20DM%20Screen/variant-rules/swim-speed-xphb.md)\
>      \ without provoking [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack)."
>    "name": "Watery Rush"
>"source":
>  - "XMM"
>"image": "2.%20Compendium/bestiary/undead/token/lacedon-ghoul-xmm.webp"
>```
^statblock
