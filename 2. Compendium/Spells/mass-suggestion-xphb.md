...
Each target must succeed on a Wisdom saving throw or have the [Charmed](0.%20DM%20Screen/conditions.md#Charmed) condition for the duration or until you or your allies deal damage to the target. Each [Charmed](0.%20DM%20Screen/conditions.md#Charmed) target pursues the suggestion to the best of its ability. The suggested activity can continue for the entire duration, but if the suggested activity can be completed in a shorter time, the spell ends for a target upon completing it.
