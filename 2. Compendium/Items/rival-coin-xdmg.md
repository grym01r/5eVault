...
aliases:
  - Rival Coin
image: 2. Compendium/items/img/rival-coin.webp
tags: Item
---
# Rival Coin
*Wondrous item, common*  
![](rival-coin.webp#right)
...
The coin has 1 charge and regains its expended charge daily at dawn. You can take a [Magic](0.%20DM%20Screen/actions.md#Magic) action to toss the coin, expending its charge. Roll any die to determine whether the coin comes up heads (on an even number) or tails (on an odd number). The roll also determines the effect:
