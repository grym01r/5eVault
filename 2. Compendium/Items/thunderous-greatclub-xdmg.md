...
As a [Magic](0.%20DM%20Screen/actions.md#Magic) action, you can strike the weapon against a hard surface to create a loud clap of thunder audible out to 300 feet. You also create a 30-foot [Cone](cone-area-of-effect-xphb.md) of thunderous energy. Each creature in the [Cone](cone-area-of-effect-xphb.md) must succeed on a DC 15 Strength saving throw or have the [Prone](0.%20DM%20Screen/conditions.md#Prone) condition. Nonmagical objects in the [Cone](cone-area-of-effect-xphb.md) that aren't being worn or carried take `3d8` Thunder damage.
