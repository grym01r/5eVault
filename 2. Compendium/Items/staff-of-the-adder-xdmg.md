...
aliases:
  - Staff of the Adder
image: 2. Compendium/items/img/staff-of-the-adder.webp
tags: Item
---
# Staff of the Adder
...
When you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action, you can make one of the attack rolls using the animated snake head, which has a reach of 5 feet. Apply your [Proficiency Bonus](proficiency-xphb.md) and Wisdom modifier to the attack roll. On a hit, the target takes `1d6` Piercing damage and `3d6` Poison damage.
