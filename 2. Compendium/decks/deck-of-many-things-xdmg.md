...
### Balance
![](deck-of-many-things-03-balance.webp#card)
...
### Comet
![](deck-of-many-things-12-comet.webp#card)
The next time you enter combat against one or more [Hostile](0.%20DM%20Screen/variant-rules/hostile-attitude-xphb.md) creatures, you can select one of them as your foe when you roll [Initiative](0.%20DM%20Screen/variant-rules/initiative-xphb.md). If you reduce your foe to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) during that combat, you have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on Death Saving Throws for 1 year. If someone else reduces your chosen foe to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) or you don't choose a foe, this card has no effect.

### Donjon
![](deck-of-many-things-17-donjon.webp#card)
...
### Euryale
![](deck-of-many-things-22-euryale.webp#card)
...
### Fates
![](deck-of-many-things-08-fates.webp#card)
Reality's fabric unravels and spins anew, allowing you to avoid or erase one event as if it never happened. You can use the card's magic as soon as you draw the card or at any other time before you die.

### Flames
![](deck-of-many-things-20-flames.webp#card)
...
### Fool
![](deck-of-many-things-01-fool.webp#card)
You have [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on [D20 Tests](0.%20DM%20Screen/variant-rules/d20-test-xphb.md) for the next 72 hours. Draw another card; this draw doesn't count as one of your declared draws.

### Gem
![](deck-of-many-things-05-gem.webp#card)
Twenty-five pieces of jewelry worth 2,000 GP each or fifty gems worth 1,000 GP each appear at your feet.

### Jester
![](deck-of-many-things-14-jester.webp#card)
You have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on [D20 Tests](0.%20DM%20Screen/variant-rules/d20-test-xphb.md) for the next 72 hours, or you can draw two additional cards beyond your declared draws.

### Key
![](deck-of-many-things-02-key.webp#card)
...
### Moon
![](deck-of-many-things-11-moon.webp#card)
You gain the ability to cast [Wish](wish-xphb.md) `1d3` times.

### Puzzle
![](deck-of-many-things-04-puzzle.webp#card)
...
### Rogue
![](deck-of-many-things-06-rogue.webp#card)
An NPC of the DM's choice becomes [Hostile](0.%20DM%20Screen/variant-rules/hostile-attitude-xphb.md) toward you. You don't know the identity of this NPC until they or someone else reveals it. Nothing less than a [Wish](wish-xphb.md) spell or divine intervention can end the NPC's hostility toward you.

### Ruin
![](deck-of-many-things-16-ruin.webp#card)
...
### Sage
![](deck-of-many-things-07-sage.webp#card)
...
### Skull
![](deck-of-many-things-19-skull.webp#card)
An [Avatar of Death](avatar-of-death-xdmg.md) appears in an unoccupied space as close to you as possible. The avatar targets only you with its attacks, appearing as a ghostly skeleton clad in a tattered black robe and carrying a spectral scythe. The avatar disappears when it drops to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) or you die. If an ally of yours deals damage to the avatar, that ally summons another Avatar of Death. The new avatar appears in an unoccupied space as close to that ally as possible and targets only that ally with its attacks. You and your allies can each summon only one avatar as a consequence of this draw. A creature slain by an avatar can't be restored to life.

### Star
![](deck-of-many-things-13-star.webp#card)
Increase one of your ability scores by 2, to a maximum of 24.

### Sun
![](deck-of-many-things-10-sun.webp#card)
A magic item (chosen by the DM) appears on your person. In addition, you gain 10 [Temporary Hit Points](0.%20DM%20Screen/variant-rules/temporary-hit-points-xphb.md) daily at dawn until you die.

### Talons
![](deck-of-many-things-21-talons.webp#card)
Every magic item you wear or carry disintegrates. Artifacts in your possession vanish instead.


## Sources

*Dungeon Master's Guide (2024) p. 250. Available in the <span title='Systems Reference Document (5.2)'>SRD</span> (as "Mysterious Deck") and the Free Rules (2024)*