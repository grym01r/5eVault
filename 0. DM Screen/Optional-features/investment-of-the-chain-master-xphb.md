---
prequisite: [Warlock, Pact of the Chain]
level: 5
...
As a [Bonus Action](bonus-action-xphb.md), you can command the familiar to take the [Attack](0.%20DM%20Screen/actions.md#Attack) action.
...
When the familiar takes damage, you can take a [Reaction](reaction-xphb.md) to grant it [Resistance](0.%20DM%20Screen/Variant-rules/resistance-xphb.md) against that damage.
## Sources
