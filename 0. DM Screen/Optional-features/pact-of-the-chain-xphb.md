...
You learn the [Find Familiar](find-familiar-xphb.md) spell and can cast it as a [Magic](0.%20DM%20Screen/actions.md#Magic) action without expending a spell slot.
...
Additionally, when you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action, you can forgo one of your own attacks to allow your familiar to make one attack of its own with its [Reaction](reaction-xphb.md).
## Sources
