...
- **Prerequisites**: Ability to use an [Arcane Focus](arcane-focus-xphb.md) or tool as a [Spellcasting Focus](0.%20DM%20Screen/variant-rules/spellcasting-focus-xphb.md)
- **Space**: Vast (36 sq)
- **Hirelings**: 1
- **Order**: empower
