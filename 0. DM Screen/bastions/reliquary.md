---
level: 13
preqrequisite: [Holy Symbol, Druidic Focus]
space: [Cramped]
hirelings: 1
order: [harvest]
source: [XDMG]
...
- **Prerequisites**: Ability to use a [Holy Symbol](holy-symbol-xphb.md) or [Druidic Focus](druidic-focus-xphb.md) as a [Spellcasting Focus](0.%20DM%20Screen/variant-rules/spellcasting-focus-xphb.md)
- **Space**: Cramped (4 sq)
- **Hirelings**: 1
- **Order**: harvest
