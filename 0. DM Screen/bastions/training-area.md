...
|--------------|----------------|
| Battle Expert | When you take damage from an attack made with an [Unarmed Strike](0.%20DM%20Screen/variant-rules/unarmed-strike-xphb.md) or a weapon, you can take a Reaction to reduce this damage by `1d4`. |
| Skills Expert | You gain proficiency in one of the following skills of your choice: [Acrobatics](0.%20DM%20Screen/skills.md#Acrobatics), [Athletics](0.%20DM%20Screen/skills.md#Athletics), [Performance](0.%20DM%20Screen/skills.md#Performance), [Sleight of Hand](0.%20DM%20Screen/skills.md#Sleight%20of%20Hand), or [Stealth](0.%20DM%20Screen/skills.md#Stealth). |
| Tools Expert | You gain proficiency with one tool of your choice. |
| Unarmed Combat Expert | When you hit with your [Unarmed Strike](0.%20DM%20Screen/variant-rules/unarmed-strike-xphb.md) and deal damage, the attack deals an extra `1d4` Bludgeoning damage. |
