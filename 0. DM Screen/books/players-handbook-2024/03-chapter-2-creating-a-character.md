...
![World-traveling explorers ...](0.%20DM%20Screen/books/players-handbook-2024/img/012-02-001-world-traveling-explorers.webp#center "World-traveling explorers Hank, Bobby, Sheila, Diana, and Presto stand on the threshold of their next adventure")
...
> 
> The classic D&D party comprises a [Cleric](0.%20DM%20Screen/classes/cleric-xphb.md), [Fighter](0.%20DM%20Screen/classes/fighter-xphb.md), [Rogue](0.%20DM%20Screen/classes/rogue-xphb.md), and [Wizard](0.%20DM%20Screen/classes/wizard-xphb.md). Those four classes have the longest history in the game, but more importantly, they bring a balanced mix of capabilities to adventures. You're welcome to use that party setup or modify it using these guidelines:
> 
> - **Cleric.** Replace with [Bard](0.%20DM%20Screen/classes/bard-xphb.md) or [Druid](0.%20DM%20Screen/classes/druid-xphb.md)  
> - **Fighter.** Replace with [Barbarian](0.%20DM%20Screen/classes/barbarian-xphb.md), [Monk](0.%20DM%20Screen/classes/monk-xphb.md), [Paladin](0.%20DM%20Screen/classes/paladin-xphb.md), or [Ranger](0.%20DM%20Screen/classes/ranger-xphb.md)  
> - **Rogue.** Replace with [Bard](0.%20DM%20Screen/classes/bard-xphb.md) or [Ranger](0.%20DM%20Screen/classes/ranger-xphb.md)  
> - **Wizard.** Replace with [Bard](0.%20DM%20Screen/classes/bard-xphb.md), [Sorcerer](0.%20DM%20Screen/classes/sorcerer-xphb.md), or [Warlock](0.%20DM%20Screen/classes/warlock-xphb.md)  
^a-balanced-party

#### Write Your Level

Write your character's level on your character sheet. Typically, a character starts at level 1 and advances in level by adventuring and gaining [Experience Points](0.%20DM%20Screen/variant-rules/experience-points-xphb.md) (XP).
...
![Consider how your choices ...](0.%20DM%20Screen/books/players-handbook-2024/img/013-02-002-character-choices.webp#center "Consider how your choices combine to set your character on the path to adventure")

#### Choose a Species

Choose a species for your character. The following species options are detailed in "chapter 4": [Aasimar](0.%20DM%20Screen/races/aasimar-xphb.md), [Dragonborn](0.%20DM%20Screen/races/dragonborn-xphb.md), [Dwarf](0.%20DM%20Screen/races/dwarf-xphb.md), [Elf](0.%20DM%20Screen/races/elf-xphb.md), [Gnome](0.%20DM%20Screen/races/gnome-xphb.md), [Goliath](0.%20DM%20Screen/races/goliath-xphb.md), [Halfling](0.%20DM%20Screen/races/halfling-xphb.md), [Human](0.%20DM%20Screen/races/human-xphb.md), [Orc](0.%20DM%20Screen/races/orc-xphb.md), and [Tiefling](0.%20DM%20Screen/races/tiefling-xphb.md). Once you've chosen a species, write it on your character sheet. Then record your species' traits.

Your character's [size](0.%20DM%20Screen/variant-rules/size-xphb.md) and [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md) are determined by the character's species; record these in the appropriate places on your character sheet as well (you may write just the first letter of your size).
...
![](0.%20DM%20Screen/books/players-handbook-2024/img/014-02-003-strength-icon.webp#center)

![Describe Appearance and Personality; Strength](describe-appearance-and-personality-strength-xphb.md)

![](0.%20DM%20Screen/books/players-handbook-2024/img/015-02-004-dexterity-icon.webp#center)

![Describe Appearance and Personality; Dexterity](describe-appearance-and-personality-dexterity-xphb.md)

![](0.%20DM%20Screen/books/players-handbook-2024/img/016-02-005-constitution-icon.webp#center)

![Describe Appearance and Personality; Constitution](describe-appearance-and-personality-constitution-xphb.md)

![](0.%20DM%20Screen/books/players-handbook-2024/img/017-02-006-intelligence-icon.webp#center)

![Describe Appearance and Personality; Intelligence](describe-appearance-and-personality-intelligence-xphb.md)

![](0.%20DM%20Screen/books/players-handbook-2024/img/018-02-007-wisdom-icon.webp#center)

![Describe Appearance and Personality; Wisdom](describe-appearance-and-personality-wisdom-xphb.md)

![](0.%20DM%20Screen/books/players-handbook-2024/img/019-02-008-charisma-icon.webp#center)
...
![Alignments might be visual...](0.%20DM%20Screen/books/players-handbook-2024/img/020-02-009-alignments.webp#center "Alignments might be visualized as a grid like this—along with creatures that embody those alignments")
...
> 
> Most creatures that lack the capacity for rational thought don't have alignments; they are unaligned. [Sharks](reef-shark-xmm.md) are savage predators, for example, but they aren't evil; they are unaligned.
^unaligned-creatures
...
Sometimes your DM will determine whether your character notices something without asking you to make a Wisdom ([Perception](0.%20DM%20Screen/skills.md#Perception)) check; the DM uses your Passive Perception instead. Passive Perception is a score that reflects a general awareness of your surroundings when you're not actively looking for something. Use this formula to determine your Passive Perception score:

<span class='abilityGeneric'>**Passive Perception.**</span>

Include all modifiers that apply to your Wisdom ([Perception](0.%20DM%20Screen/skills.md#Perception)) checks. For example, if your character has a Wisdom of 15 and proficiency in the [Perception](0.%20DM%20Screen/skills.md#Perception) skill, you have a Passive Perception of 14 (10 + 2 for your Wisdom modifier + 2 for proficiency).
...
The character sheet includes room to note your current Hit Points when you take damage, as well as any [Temporary Hit Points](0.%20DM%20Screen/variant-rules/temporary-hit-points-xphb.md) you might gain. There's also space to track [Death Saving Throws](0.%20DM%20Screen/variant-rules/death-saving-throw-xphb.md).
...
Without armor or a shield, your base [Armor Class](0.%20DM%20Screen/variant-rules/armor-class-xphb.md) is 10 plus your Dexterity modifier. If your starting equipment includes armor or a Shield (or both), calculate your AC using the rules in "chapter 6". A class feature might give you a different way to calculate your AC.
...
![Adventuring equipment impr...](0.%20DM%20Screen/books/players-handbook-2024/img/021-02-010-adventuring-equipment.webp#center "Adventuring equipment improves as a character progresses through the tiers of play")

While going on adventures, your character gains experience, represented by [Experience Points](0.%20DM%20Screen/variant-rules/experience-points-xphb.md) (XP). A character who reaches a specified Experience Point total advances in capability. This advancement is called gaining a level.
...
If you have multiple ways to calculate your [Armor Class](0.%20DM%20Screen/variant-rules/armor-class-xphb.md), you can benefit from only one at a time. For example, a Monk/Sorcerer with a Monk's Unarmored Defense feature and a Sorcerer's Draconic Resilience feature must choose only one of those features as a way to calculate Armor Class.
...
This table might give you spell slots of a higher level than the spells you prepare. You can use those slots but only to cast your lower-level spells. If a lower-level spell that you cast, like [Burning Hands](burning-hands-xphb.md), has an enhanced effect when cast at a higher level, you can use the enhanced effect as normal.
...
![A character with Paladin a...](0.%20DM%20Screen/books/players-handbook-2024/img/022-02-011-paladin-warlock-multiclass.webp#center "A character with Paladin and Warlock levels might call on both a mighty oath and an otherworldly patron")
