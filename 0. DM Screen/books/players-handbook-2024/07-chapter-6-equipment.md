...
![In the skies of Eberron, t...](0.%20DM%20Screen/books/players-handbook-2024/img/168-07-001-inventor-vi.webp#center "In the skies of Eberron, the inventor Vi and her Fixers escape the Lord of Blades and a plummeting airship that burns with green flame!")
...
![Simple Melee Weapons](0.%20DM%20Screen/books/players-handbook-2024/img/169-07-058-simple-melee.webp#center)

![Simple Ranged Weapons](0.%20DM%20Screen/books/players-handbook-2024/img/170-07-059-simple-range.webp#center)

![Martial Melee Weapons](0.%20DM%20Screen/books/players-handbook-2024/img/171-07-061-martial-melee.webp#center)

![Martial Ranged Weapons](0.%20DM%20Screen/books/players-handbook-2024/img/172-07-060-martial-range.webp#center)
...
When you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action on your turn and attack with a Light weapon, you can make one extra attack as a Bonus Action later on the same turn. That extra attack must be made with a different Light weapon, and you don't add your ability modifier to the extra attack's damage unless that modifier is negative. For example, you can attack with a [Shortsword](shortsword-xphb.md) in one hand and a [Dagger](dagger-xphb.md) in the other using the [Attack](0.%20DM%20Screen/actions.md#Attack) action and a Bonus Action, but you don't add your Strength or Dexterity modifier to the damage roll of the Bonus Action unless that modifier is negative.
...
A Range weapon has a range in parentheses after the [Ammunition](0.%20DM%20Screen/item-properties.md#Ammunition) or [Thrown](0.%20DM%20Screen/item-properties.md#Thrown) property. The range lists two numbers. The first is the weapon's normal range in feet, and the second is the weapon's long range. When attacking a target beyond normal range, you have [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on the attack roll. You can't attack a target beyond the long range.

#### Reach

A Reach weapon adds 5 feet to your reach when you attack with it, as well as when determining your reach for [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack) with it.
...
When you make the extra attack of the [Light](0.%20DM%20Screen/item-properties.md#Light) property, you can make it as part of the [Attack](0.%20DM%20Screen/actions.md#Attack) action instead of as a Bonus Action. You can make this extra attack only once per turn.
...
If you hit a creature with this weapon, that creature has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on its next attack roll before the start of your next turn.
...
If you hit a creature with this weapon, you can force the creature to make a Constitution saving throw (DC 8 plus the ability modifier used to make the attack roll and your Proficiency Bonus). On a failed save, the creature has the [Prone](0.%20DM%20Screen/conditions.md#Prone) condition.

#### Vex

If you hit a creature with this weapon and deal damage to the creature, you have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on your next attack roll against that creature before the end of your next turn.
...
- **Stealth.** If the table shows "Disadvantage" in the Stealth column for an armor type, the wearer has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on Dexterity ([Stealth](0.%20DM%20Screen/skills.md#Stealth)) checks.  

![Armor](armor-xphb.md)

![Light Armor and Shields](0.%20DM%20Screen/books/players-handbook-2024/img/173-07-062-light-armor-and-shields.webp#center)

![Medium Armor](0.%20DM%20Screen/books/players-handbook-2024/img/174-07-063-medium-armor.webp#center)

![Heavy Armor](0.%20DM%20Screen/books/players-handbook-2024/img/175-07-064-heavy-armor.webp#center)
...
If you wear Light, Medium, or Heavy armor and lack training with it, you have [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on any [D20 Test](0.%20DM%20Screen/variant-rules/d20-test-xphb.md) that involves Strength or Dexterity, and you can't cast spells.
...
- **Utilize.** This entry lists things you can do with the tool when you take the [Utilize](0.%20DM%20Screen/actions.md#Utilize) action. You can do one of those things each time you take the action. This entry also provides the DC for the action.  
...
![](0.%20DM%20Screen/books/players-handbook-2024/img/176-07-002-tools.webp#center)

### Tool Proficiency

If you have proficiency with a tool, add your Proficiency Bonus to any ability check you make that uses the tool. If you have proficiency in a skill that's used with that check, you have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on the check too.
...
- **Ability.** Dexterity  
- **Weight.** 5 lb.  
- **Utilize.** Modify footwear to give [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on the wearer's next Dexterity ([Acrobatics](0.%20DM%20Screen/skills.md#Acrobatics)) check (DC 10)  
...
![A Warlock channels magic through an Arcane Focus](0.%20DM%20Screen/books/players-handbook-2024/img/177-07-003-arcane-focus.webp#center)
...
When you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action, you can replace one of your attacks with throwing a vial of Acid. Target one creature or object you can see within 20 feet of yourself. The target must succeed on a Dexterity saving throw (DC 8 plus your Dexterity modifier and Proficiency Bonus) or take `2d6` Acid damage.

### Alchemist's Fire (50 GP)

When you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action, you can replace one of your attacks with throwing a flask of Alchemist's Fire. Target one creature or object you can see within 20 feet of yourself. The target must succeed on a Dexterity saving throw (DC 8 plus your Dexterity modifier and Proficiency Bonus) or take `1d4` Fire damage and start [burning](burning-xphb.md).

### Ammunition (Varies)

Ammunition is required by a weapon that has the [Ammunition](0.%20DM%20Screen/item-properties.md#Ammunition) property. A weapon's description specifies the type of ammunition used by the weapon. The Ammunition table lists the different types and the amount you get when you buy them. The table also lists the item that is typically used to store each type; storage must be bought separately.

![Ammunition (Varies); Ammunition](ammunition-varies-ammunition-xphb.md)

### Antitoxin (50 GP)

As a Bonus Action, you can drink a vial of Antitoxin to gain [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on saving throws to avoid or end the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned) condition for 1 hour.
...
As a [Utilize](0.%20DM%20Screen/actions.md#Utilize) action, you can spill Ball Bearings from their pouch. They spread to cover a level, 10-foot-square area within 10 feet of yourself. A creature that enters this area for the first time on a turn must succeed on a DC 10 Dexterity saving throw or have the [Prone](0.%20DM%20Screen/conditions.md#Prone) condition. It takes 10 minutes to recover the Ball Bearings.
...
When rung as a [Utilize](0.%20DM%20Screen/actions.md#Utilize) action, a Bell produces a sound that can be heard up to 60 feet away.

### Blanket (5 SP)

While wrapped in a blanket, you have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on saving throws against extreme cold (see the *Dungeon Master's Guide*).
...
A Book contains fiction or nonfiction. If you consult an accurate nonfiction Book about its topic, you gain a +5 bonus to Intelligence ([Arcana](0.%20DM%20Screen/skills.md#Arcana), [History](0.%20DM%20Screen/skills.md#History), [Nature](0.%20DM%20Screen/skills.md#Nature), or [Religion](0.%20DM%20Screen/skills.md#Religion)) checks you make about that topic.
...
As a [Utilize](0.%20DM%20Screen/actions.md#Utilize) action, you can spread Caltrops from their bag to cover a 5-foot-square area within 5 feet of yourself. A creature that enters this area for the first time on a turn must succeed on a DC 15 Dexterity saving throw or take 1 Piercing damage and have its Speed reduced to 0 until the start of its next turn. It takes 10 minutes to recover the Caltrops.

### Candle (1 CP)

For 1 hour, a lit Candle sheds [Bright Light](0.%20DM%20Screen/variant-rules/bright-light-xphb.md) in a 5-foot radius and [Dim Light](0.%20DM%20Screen/variant-rules/dim-light-xphb.md) for an additional 5 feet.
...
As a [Utilize](0.%20DM%20Screen/actions.md#Utilize) action, you can wrap a Chain around an unwilling creature within 5 feet of yourself that has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled), [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated), or [Restrained](0.%20DM%20Screen/conditions.md#Restrained) condition if you succeed on a DC 13 Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check. If the creature's legs are bound, the creature has the Restrained condition until it escapes. Escaping the Chain requires the creature to make a successful DC 18 Dexterity ([Acrobatics](0.%20DM%20Screen/skills.md#Acrobatics)) check as an action. Bursting the Chain requires a successful DC 20 Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check as an action.
...
While wearing a Costume, you have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on any ability check you make to impersonate the person or type of person it represents.

### Crowbar (2 GP)

Using a Crowbar gives you [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on Strength checks where the Crowbar's leverage can be applied.
...
As a [Utilize](0.%20DM%20Screen/actions.md#Utilize) action, you can throw the Grappling Hook at a railing, a ledge, or another catch within 50 feet of yourself, and the hook catches on if you succeed on a DC 13 Dexterity ([Acrobatics](0.%20DM%20Screen/skills.md#Acrobatics)) check. If you tied a [Rope](rope-xphb.md) to the hook, you can then climb it.

### Healer's Kit (5 GP)

A Healer's Kit has ten uses. As a [Utilize](0.%20DM%20Screen/actions.md#Utilize) action, you can expend one of its uses to stabilize an [Unconscious](0.%20DM%20Screen/conditions.md#Unconscious) creature that has 0 Hit Points without needing to make a Wisdom ([Medicine](0.%20DM%20Screen/skills.md#Medicine)) check.
...
When you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action, you can replace one of your attacks with throwing a flask of Holy Water. Target one creature you can see within 20 feet of yourself. The target must succeed on a Dexterity saving throw (DC 8 plus your Dexterity modifier and Proficiency Bonus) or take `2d8` Radiant damage if it is a Fiend or an Undead.

### Hunting Trap (5 GP)

As a [Utilize](0.%20DM%20Screen/actions.md#Utilize) action, you can set a Hunting Trap, which is a sawtooth steel ring that snaps shut when a creature steps on a pressure plate in the center. The trap is affixed by a heavy chain to an immobile object, such as a tree or a spike driven into the ground. A creature that steps on the plate must succeed on a DC 13 Dexterity saving throw or take `1d4` Piercing damage and have its Speed reduced to 0 until the start of its next turn. Thereafter, until the creature breaks free of the trap, its movement is limited by the length of the chain (typically 3 feet). A creature can use its action to make a DC 13 Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check, freeing itself or another creature within its reach on a success. Each failed check deals 1 Piercing damage to the trapped creature.
...
A Lamp burns [Oil](oil-xphb.md) as fuel to cast [Bright Light](0.%20DM%20Screen/variant-rules/bright-light-xphb.md) in a 15-foot radius and [Dim Light](0.%20DM%20Screen/variant-rules/dim-light-xphb.md) for an additional 30 feet.

### Lantern, Bullseye (10 GP)

A Bullseye Lantern burns [Oil](oil-xphb.md) as fuel to cast [Bright Light](0.%20DM%20Screen/variant-rules/bright-light-xphb.md) in a 60-foot [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md) and [Dim Light](0.%20DM%20Screen/variant-rules/dim-light-xphb.md) for an additional 60 feet.

![Lamp and Net](0.%20DM%20Screen/books/players-handbook-2024/img/178-07-004-lamp-net.webp#center)

### Lantern, Hooded (5 GP)

A Hooded Lantern burns [Oil](oil-xphb.md) as fuel to cast [Bright Light](0.%20DM%20Screen/variant-rules/bright-light-xphb.md) in a 30-foot radius and [Dim Light](0.%20DM%20Screen/variant-rules/dim-light-xphb.md) for an additional 30 feet. As a Bonus Action, you can lower the hood, reducing the light to Dim Light in a 5-foot radius, or raise it again.

### Lock (10 GP)

A Lock comes with a key. Without the key, a creature can use [Thieves' Tools](thieves-tools-xphb.md) to pick this Lock with a successful DC 15 Dexterity ([Sleight of Hand](0.%20DM%20Screen/skills.md#Sleight%20of%20Hand)) check.

### Magnifying Glass (100 GP)

A Magnifying Glass grants [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on any ability check made to appraise or inspect a highly detailed item. Lighting a fire with a Magnifying Glass requires light as bright as sunlight to focus, tinder to ignite, and about 5 minutes for the fire to ignite.

### Manacles (2 GP)

As a [Utilize](0.%20DM%20Screen/actions.md#Utilize) action, you can use Manacles to bind an unwilling Small or Medium creature within 5 feet of yourself that has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled), [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated), or [Restrained](0.%20DM%20Screen/conditions.md#Restrained) condition if you succeed on a DC 13 Dexterity ([Sleight of Hand](0.%20DM%20Screen/skills.md#Sleight%20of%20Hand)) check. While bound, a creature has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on attack rolls, and the creature is [Restrained](0.%20DM%20Screen/conditions.md#Restrained) if the Manacles are attached to a chain or hook that is fixed in place. Escaping the Manacles requires a successful DC 20 Dexterity ([Sleight of Hand](0.%20DM%20Screen/skills.md#Sleight%20of%20Hand)) check as an action. Bursting them requires a successful DC 25 Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check as an action.

Each set of Manacles comes with a key. Without the key, a creature can use [Thieves' Tools](thieves-tools-xphb.md) to pick the Manacles' lock with a successful DC 15 Dexterity ([Sleight of Hand](0.%20DM%20Screen/skills.md#Sleight%20of%20Hand)) check.

### Map (1 GP)

If you consult an accurate Map, you gain a +5 bonus to Wisdom ([Survival](0.%20DM%20Screen/skills.md#Survival)) checks you make to find your way in the place represented on it.
...
When you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action, you can replace one of your attacks with throwing a Net. Target a creature you can see within 15 feet of yourself. The target must succeed on a Dexterity saving throw (DC 8 plus your Dexterity modifier and Proficiency Bonus) or have the [Restrained](0.%20DM%20Screen/conditions.md#Restrained) condition until it escapes. The target succeeds automatically if it is Huge or larger.

To escape, the target or a creature within 5 feet of it must take an action to make a DC 10 Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check, freeing the Restrained creature on a success. Destroying the Net (AC 10; 5 HP; Immunity to Bludgeoning, Poison, and Psychic damage) also frees the target, ending the effect.
...
When you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action, you can replace one of your attacks with throwing an Oil flask. Target one creature or object within 20 feet of yourself. The target must succeed on a Dexterity saving throw (DC 8 plus your Dexterity modifier and Proficiency Bonus) or be covered in oil. If the target takes Fire damage before the oil dries (after 1 minute), the target takes an extra 5 Fire damage from burning oil.

#### Dousing a Space

You can take the [Utilize](0.%20DM%20Screen/actions.md#Utilize) action to pour an Oil flask on level ground to cover a 5-foot-square area within 5 feet of yourself. If lit, the oil burns until the end of the turn 2 rounds from when the oil was lit (or 12 seconds) and deals 5 Fire damage to any creature that enters the area or ends its turn there. A creature can take this damage only once per turn.

#### Fuel

Oil serves as fuel for Lamps and Lanterns. Once lit, a flask of Oil burns for 6 hours in a Lamp or Lantern. That duration doesn't need to be consecutive; you can extinguish the burning Oil (as a [Utilize](0.%20DM%20Screen/actions.md#Utilize) action) and rekindle it again until it has burned for a total of 6 hours.
...
Perfume comes in a 4-ounce vial. For 1 hour after applying Perfume to yourself, you have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on Charisma ([Persuasion](0.%20DM%20Screen/skills.md#Persuasion)) checks made to influence an [Indifferent](0.%20DM%20Screen/variant-rules/indifferent-attitude-xphb.md) Humanoid within 5 feet of yourself.
...
A Pole is 10 feet long. You can use it to touch something up to 10 feet away. If you must make a Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check as part of a [High](0.%20DM%20Screen/variant-rules/high-jump-xphb.md) or [Long Jump](0.%20DM%20Screen/variant-rules/long-jump-xphb.md), you can use the Pole to vault, giving yourself [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on the check.
...
You can use a Portable Ram to break down doors. When doing so, you gain a +4 bonus to the Strength check. One other character can help you use the ram, giving you [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on this check.
...
As a [Utilize](0.%20DM%20Screen/actions.md#Utilize) action, you can tie a knot with Rope if you succeed on a DC 10 Dexterity ([Sleight of Hand](0.%20DM%20Screen/skills.md#Sleight%20of%20Hand)) check. The Rope can be burst with a successful DC 20 Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check.

You can bind an unwilling creature with the Rope only if the creature has the [Grappled](0.%20DM%20Screen/conditions.md#Grappled), [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated), or [Restrained](0.%20DM%20Screen/conditions.md#Restrained) condition. If the creature's legs are bound, the creature has the Restrained condition until it escapes. Escaping the Rope requires the creature to make a successful DC 15 Dexterity ([Acrobatics](0.%20DM%20Screen/skills.md#Acrobatics)) check as an action.
...
When blown as a [Utilize](0.%20DM%20Screen/actions.md#Utilize) action, a Signal Whistle produces a sound that can be heard up to 600 feet away.
...
Iron Spikes come in bundles of ten. As a [Utilize](0.%20DM%20Screen/actions.md#Utilize) action, you can use a blunt object, such as a [Light Hammer](light-hammer-xphb.md), to hammer a spike into wood, earth, or a similar material. You can do so to jam a door shut or to then tie a [Rope](rope-xphb.md) or [Chain](chain-xphb.md) to the Spike.
...
String is 10 feet long. You can tie a knot in it as a [Utilize](0.%20DM%20Screen/actions.md#Utilize) action.
...
A Torch burns for 1 hour, casting [Bright Light](0.%20DM%20Screen/variant-rules/bright-light-xphb.md) in a 20-foot radius and [Dim Light](0.%20DM%20Screen/variant-rules/dim-light-xphb.md) for an additional 20 feet. When you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action, you can attack with the Torch, using it as a Simple Melee weapon. On a hit, the target takes 1 Fire damage.

### Vial (1 GP)

A Vial holds up to 4 ounces.

![](0.%20DM%20Screen/books/players-handbook-2024/img/179-07-005-adventurer-with-tools.webp#center)
...
A saddle comes with a bit, a bridle, reins, and any other equipment needed to use the saddle. A Military Saddle gives [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on any ability check you make to remain mounted. An Exotic Saddle is required for riding an aquatic or a flying mount.
...
If a vehicle has a [damage threshold](0.%20DM%20Screen/variant-rules/damage-threshold-xphb.md), it's noted in the table.
...
![A Wizard and her familiar ...](0.%20DM%20Screen/books/players-handbook-2024/img/180-07-006-wizard-familiar-shopping.webp#center "A Wizard and her familiar spend an afternoon shopping")
...
The [Identify](identify-xphb.md) spell is the fastest way to reveal an item's properties. Alternatively, you can focus on one magic item during a [Short Rest](0.%20DM%20Screen/variant-rules/short-rest-xphb.md) while being in physical contact with the item. At the end of the rest, you learn its properties and how to use them (but not any curse the item might bear).
