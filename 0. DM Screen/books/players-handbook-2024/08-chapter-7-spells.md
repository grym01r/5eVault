...
![Archmages of Greyhawk—Jall...](0.%20DM%20Screen/books/players-handbook-2024/img/181-08-001-jallarzi-mordenkainen-bigby.webp#center "Archmages of Greyhawk—Jallarzi, Mordenkainen, and Bigby—prepare their magic as they open a gate to another plane")
...
Finishing a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md) restores any expended spell slots.
...
Most spells require the [Magic](0.%20DM%20Screen/actions.md#Magic) action to cast, but some spells require a Bonus Action, a Reaction, or 1 minute or more. A spell's Casting Time entry specifies which of those is required.

#### One Spell with a Spell Slot per Turn

On a turn, you can expend only one spell slot to cast a spell. This rule means you can't, for example, cast a spell with a spell slot using the [Magic](0.%20DM%20Screen/actions.md#Magic) action and another one using a Bonus Action on the same turn.
...
Certain spells—including a spell cast as a [Ritual](0.%20DM%20Screen/variant-rules/ritual-xphb.md)—require more time to cast: minutes or even hours. While you cast a spell with a casting time of 1 minute or more, you must take the [Magic](0.%20DM%20Screen/actions.md#Magic) action on each of your turns, and you must maintain [Concentration](0.%20DM%20Screen/conditions.md#Concentration) while you do so. If your Concentration is broken, the spell fails, but you don't expend a spell slot. To cast the spell again, you must start over.
...
![An aasimar Wizard uses a c...](0.%20DM%20Screen/books/players-handbook-2024/img/182-08-002-aasimar-wizard.webp#center "An aasimar Wizard uses a crystal material component to focus the magic of Cone of Cold")
...
To target something with a spell, a caster must have a clear path to it, so it can't be behind [Total Cover](0.%20DM%20Screen/variant-rules/cover-xphb.md).

##### Targeting Yourself

If a spell targets a creature of your choice, you can choose yourself unless the creature must be [Hostile](0.%20DM%20Screen/variant-rules/hostile-attitude-xphb.md) or specifically a creature other than you.

##### Areas of Effect

Some spells, such as [Thunderwave](thunderwave-xphb.md), cover an area called an [area of effect](0.%20DM%20Screen/variant-rules/area-of-effect-xphb.md), which is defined in the "rules glossary". The area determines what the spell targets. The description of a spell specifies whether it has an area of effect, which is typically one of these shapes: [Cone](0.%20DM%20Screen/variant-rules/cone-area-of-effect-xphb.md), [Cube](0.%20DM%20Screen/variant-rules/cube-area-of-effect-xphb.md), [Cylinder](0.%20DM%20Screen/variant-rules/cylinder-area-of-effect-xphb.md), [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md), [Line](0.%20DM%20Screen/variant-rules/line-area-of-effect-xphb.md), or [Sphere](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md).

![](0.%20DM%20Screen/books/players-handbook-2024/img/183-08-003-areas-of-effect.webp#center)
...
> 
> You can try to identify a non-instantaneous spell by its observable effects if its duration is ongoing. To identify it, you must take the [Study](0.%20DM%20Screen/actions.md#Study) action and succeed on a DC 15 Intelligence ([Arcana](0.%20DM%20Screen/skills.md#Arcana)) check.
...
- [Darkness](2.%20Compendium/spells/darkness-xphb.md)  
...
- [Giant Insect](2.%20Compendium/spells/giant-insect-xphb.md)  
...
- [Resistance](2.%20Compendium/spells/resistance-xphb.md)  
...
- [Shield](2.%20Compendium/spells/shield-xphb.md)  
...
- [Telepathy](2.%20Compendium/spells/telepathy-xphb.md)  
