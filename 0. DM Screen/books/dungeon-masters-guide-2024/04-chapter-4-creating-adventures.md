...
![A mysterious carriage brin...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/049-03-001-mysterious-carraige.webp#center "A mysterious carriage brings the vampire Strahd von Zarovich out from Castle Ravenloft")
...
![The death of an ancient dr...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/050-03-002-death-of-a-dragon.webp#center "The death of an ancient dragon can shake the foundations of the world")
...
![Common Map Symbols](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/051-03-003-common-map-symbols.webp#center)
...
![When rival factions inhabi...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/052-03-004-rival-factions.webp#center "When rival factions inhabit a ruined dungeon, sometimes the best course is to stay out of the way!")
...
![Goblin raiders prepare an ambush in a gorge](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/053-03-005-goblin-raiders.webp#center)
...
- **The DM's Role.** If the characters can't figure out how to solve an encounter or aren't sure what to do next, you can remind the players of things their characters have already learned or call for Intelligence ([Investigation](0.%20DM%20Screen/skills.md#Investigation)) or similar checks to see if their characters can remember and connect things that the players might be missing.  
...
![Otto's conversation with a...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/054-03-006-magic-mirror.webp#center "Otto's conversation with a magic mirror is an exciting social interaction encounter")
...
- 1 [Wight](wight-xmm.md) (700 XP), 1 [Warhorse Skeleton](warhorse-skeleton-xmm.md) (100 XP), and 6 [Skeletons](skeleton-xmm.md) (50 XP each), for 1,100 XP total  
...
![](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/055-03-007-skeleton.webp#center)
...
![Kobolds build a barricade ...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/056-03-008-kobold-hold.webp#center "Kobolds build a barricade to keep adventurers at bay")

#### Initial Attitudes

A published adventure typically notes or implies whether a creature's initial attitude toward the adventurers is [Friendly](0.%20DM%20Screen/variant-rules/friendly-attitude-xphb.md), [Indifferent](0.%20DM%20Screen/variant-rules/indifferent-attitude-xphb.md), or [Hostile](0.%20DM%20Screen/variant-rules/hostile-attitude-xphb.md). In an encounter you've created, you can decide that starting attitude, or you can randomly determine it using the Initial Attitude table.
...
![Mysterious lights glimmer ...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/057-03-009-glimmering-lake.webp#center "Mysterious lights glimmer in a remote mountain lake, drawing adventurers to explore")
...
![A climactic battle at the ...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/058-03-010-temple-of-elemental-evil.webp#center "A climactic battle at the Temple of Elemental Evil brings an adventure to a dramatic end")
...
Melchis hires a ship to carry the party to the Amedio Jungle. Use the map to determine how long the sea voyage takes, depending on where the adventurers begin the trip and figuring that the ship covers about 1½ hexes per day. Near the end of the trip, as the ship crosses Jeklea Bay, it's attacked by a group of [Hostile](0.%20DM%20Screen/variant-rules/hostile-attitude-xphb.md) sahuagin, including two [Sahuagin Priests](sahuagin-priest-xmm.md), six [Sahuagin Warriors](sahuagin-warrior-xmm.md), and a [Water Elemental](water-elemental-xmm.md). (Assume the ship's crew stays out of the way of these terrifying monsters and lets the characters and Melchis deal with this threat.) Stage 1 ends when Melchis and the characters row a launch ashore.
...
![Minsc, Boo, and Delina nav...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/059-03-011-boreal-ball.webp#center "Minsc, Boo, and Delina navigate the intrigues of the Boreal Ball")
...
- Cannifer is a [Satyr Revelmaster](satyr-revelmaster-xmm.md) who is used to being the center of attention at every ball he attends and is thus [Hostile](0.%20DM%20Screen/variant-rules/hostile-attitude-xphb.md) to the adventurers.  
- Darisis a [Friendly](0.%20DM%20Screen/variant-rules/friendly-attitude-xphb.md), fun-loving [Dryad](dryad-xmm.md) who wants to be seen dancing with all the adventurers.  
- Fidget is a playful [Pixie](pixie-xmm.md) who is [Indifferent](0.%20DM%20Screen/variant-rules/indifferent-attitude-xphb.md) and pesters the adventurers with pranks throughout the evening, without causing any actual harm.  
- Granny Snailtongue is a [Hostile](0.%20DM%20Screen/variant-rules/hostile-attitude-xphb.md) [Green Hag](green-hag-xmm.md) who sees the adventurers as potentially useful tools. She offers to help them at every turn in hopes of putting them in her debt.  
- Raxas Albrethin is an arrogant, Chaotic Neutral drow [Mage](mage-xmm.md) who is initially [Hostile](0.%20DM%20Screen/variant-rules/hostile-attitude-xphb.md) and wants to see the adventurers humiliated. However, once the characters' Renown Score reaches 6, Raxas admits he misjudged them and becomes [Friendly](0.%20DM%20Screen/variant-rules/friendly-attitude-xphb.md).  
