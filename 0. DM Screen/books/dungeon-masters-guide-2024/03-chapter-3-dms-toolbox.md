...
![A Blob of Annihilation att...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/021-02-001-blob-attack.webp#center "A Blob of Annihilation attacks Sharn, the City of Towers, in the world of Eberron")
...
As described in the "Player's Handbook", [alignment](0.%20DM%20Screen/variant-rules/alignment-xphb.md) is a roleplaying tool. It is a quick way to describe a creature's moral and ethical orientation. Like other elements of the game, it's meant to be a tool to serve you and your game, not a constraint or burden. Alignment can help your game in three ways: as a tool for player characters, as a descriptor of a creature's demeanor, and as a summary of an organization's ethos.
...
A creature's alignment can help you determine the creature's attitude in an encounter. A Chaotic Evil monster is likely to be [Hostile](0.%20DM%20Screen/variant-rules/hostile-attitude-xphb.md), while a Lawful Good one is more likely to have a [Friendly](0.%20DM%20Screen/variant-rules/friendly-attitude-xphb.md) attitude, ready to help those in need.
...
![An exciting chase nears its conclusion](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/022-02-002-party-gives-chase.webp#center)
...
A chase requires at least one quarry and at least one pursuer. Any participants not already in [Initiative](0.%20DM%20Screen/variant-rules/initiative-xphb.md) order must roll Initiative as the chase begins. As in combat, each participant in the chase can take one action and move on its turn.
...
Participants in the chase are strongly motivated to take the [Dash](0.%20DM%20Screen/actions.md#Dash) action every round. Pursuers who stop to cast spells and make attacks run the risk of losing their quarry, and a quarry that doesn't take the Dash action is likely to be caught.

#### Dashing

A chase participant can take the [Dash](0.%20DM%20Screen/actions.md#Dash) action a number of times equal to 3 plus its Constitution modifier (minimum of once). Each additional Dash action it takes during the chase requires the creature to succeed on a DC 10 Constitution saving throw at the end of its turn or gain 1 [Exhaustion](0.%20DM%20Screen/conditions.md#Exhaustion) level. A participant drops out of the chase if it has 5 [Exhaustion](0.%20DM%20Screen/conditions.md#Exhaustion) levels. A creature can remove the [Exhaustion](0.%20DM%20Screen/conditions.md#Exhaustion) levels it gained during the chase by finishing a [Short](0.%20DM%20Screen/variant-rules/short-rest-xphb.md) or [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).

#### Spells and Attacks

A chase participant can make attacks and cast spells against other creatures within range.

Chase participants can't normally make [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack) against each other, since they are all assumed to be moving in the same direction at the same time. However, participants can still be the targets of [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack) from creatures not participating in the chase. For example, adventurers who chase a thief past a gang of ruffians might provoke [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack) from the ruffians.
...
If neither side gives up the chase, the quarry makes a Dexterity ([Stealth](0.%20DM%20Screen/skills.md#Stealth)) check on Initiative count 0 each round, after every participant in the chase has taken its turn. If the quarry is never out of the lead pursuer's sight, the check fails automatically. Otherwise, compare the check's total to the [Passive Perception](0.%20DM%20Screen/variant-rules/passive-perception-xphb.md) scores of the pursuers. If the quarry consists of multiple creatures, they all make the check separately, so it's possible for one quarry to escape while others remain in the chase.

The quarry can gain [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) or [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on its check based on the circumstances, as shown in the Escape Factors table.
...
If the total of the quarry's check is greater than the highest [Passive Perception](0.%20DM%20Screen/variant-rules/passive-perception-xphb.md) score of the pursuers, the quarry escapes. If not, the chase continues for another round. Escape doesn't necessarily mean the quarry has outpaced its pursuers. For example, in a city, escape might mean the quarry ducked into a crowd or slipped around a corner, leaving no clue as to where it went.
...
![An ill-advised attempt to ...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/023-02-003-sylgar-theft.webp#center "An ill-advised attempt to steal Xanathar's pet goldfish, Sylgar, leads to a heated chase")
...
![You might alter the Sailor...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/024-02-004-seas-of-greyhawk.webp#center "You might alter the Sailor background to reflect a character's youth on the seas of Greyhawk")
...
![Baba Yaga invents a new cr...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/025-02-005-baba-yaga.webp#center "Baba Yaga invents a new creature—a fire-breathing Giant Toad!")
...
You can usually change a creature's Intelligence, Wisdom, and Charisma scores freely unless the ability is used for spellcasting. For example, a [Black Pudding](black-pudding-xmm.md) stat block could represent a sapient alien if you raise its Intelligence and Charisma to 10 or so. It's usually best to leave its Strength, Dexterity, and Constitution scores alone, as changes to these scores can alter a monster's attack bonus, damage, [Armor Class](0.%20DM%20Screen/variant-rules/armor-class-xphb.md), or [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md), which in turn can alter its [Challenge Rating](0.%20DM%20Screen/variant-rules/challenge-rating-xphb.md).

#### Languages

You can change any or all of the languages the creature knows. You might want to add languages if you've made a creature sapient that wasn't before. You can also add or remove [telepathy](0.%20DM%20Screen/variant-rules/telepathy-xphb.md) or other forms of communication.

#### Proficiencies

You can give a creature any skill proficiencies you want and give it [Expertise](0.%20DM%20Screen/variant-rules/expertise-xphb.md) if you want it to be very skilled. If you want a creature to be good at hiding, give it Expertise in the [Stealth](0.%20DM%20Screen/skills.md#Stealth) skill. If its keen senses make it an excellent tracker or otherwise adept at finding hidden foes, give it Expertise in the [Perception](0.%20DM%20Screen/skills.md#Perception) skill. (You can also increase its Wisdom, as noted above.)

You can also swap a monster's saving throw proficiencies. If it has none, you can add one or two.

#### Senses

[Blindsight](0.%20DM%20Screen/senses.md#Blindsight), [Darkvision](0.%20DM%20Screen/senses.md#Darkvision), [Tremorsense](0.%20DM%20Screen/senses.md#Tremorsense), and [Truesight](0.%20DM%20Screen/senses.md#Truesight) have no bearing on a creature's Challenge Rating. You can add or remove them freely.
...
If a creature doesn't have [Resistance](0.%20DM%20Screen/variant-rules/resistance-xphb.md) or [Immunity](0.%20DM%20Screen/variant-rules/immunity-xphb.md) to one or more damage types, you can give it Resistance or Immunity to one or two damage types. You can also change the damage type of its existing Resistances and Immunities.
...
You can also use traits from other stat blocks in the "Monster Manual", provided you don't add traits that alter a creature's Hit Points, confer [Temporary Hit Points](0.%20DM%20Screen/variant-rules/temporary-hit-points-xphb.md), or change the amount of damage the creature deals to other creatures.

#### Creature Traits

- **Aversion to Fire.** If the creature takes Fire damage, it has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on attack rolls and ability checks until the end of its next turn.  
- **Battle Ready.** The creature has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on [Initiative](0.%20DM%20Screen/variant-rules/initiative-xphb.md) rolls.  
...
- **Dimensional Disruption.** Disruptive energy extends from the creature in a 30-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md). Other creatures can't teleport to or from a space in that area. Any attempt to do so is wasted.  
- **Disciple of the Nine Hells.** When the creature dies, its body disgorges a [Hostile](0.%20DM%20Screen/variant-rules/hostile-attitude-xphb.md) [Imp](imp-xmm.md) in the same space.  
...
- **Emissary of Juiblex.** When the creature dies, its body disgorges a [Hostile](0.%20DM%20Screen/variant-rules/hostile-attitude-xphb.md) [Ochre Jelly](ochre-jelly-xmm.md) in the same space.  
- **Fey Ancestry.** The creature has Advantage on saving throws it makes to avoid or end the [Charmed](0.%20DM%20Screen/conditions.md#Charmed) condition, and magic can't put it to sleep.  
- **Forbiddance.** The creature can't enter a residence without an invitation from one of its occupants.  
- **Gloom Shroud.** Imperceptible energy channeled from the "Shadowfell" extends from the creature in a 20-foot [Emanation](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md). Other creatures in that area have [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on Charisma checks and Charisma saving throws.  
- **Light.** The creature sheds [Bright Light](0.%20DM%20Screen/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](0.%20DM%20Screen/variant-rules/dim-light-xphb.md) for an additional 10 feet. As a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md), the creature can suppress this light or cause it to return. The light winks out if the creature dies.  
- **Mimicry.** The creature can mimic Beast sounds and Humanoid voices. A creature that hears the sounds can tell they are imitations with a successful DC 14 Wisdom ([Insight](0.%20DM%20Screen/skills.md#Insight)) check.  
- **Poison Tolerant.** The creature has Advantage on saving throws it makes to avoid or end the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned) condition.  
...
- **Slaad Host.** When the creature dies, a [Hostile](0.%20DM%20Screen/variant-rules/hostile-attitude-xphb.md) [Slaad Tadpole](slaad-tadpole-xmm.md) bursts from its innards in the same space.  
- **Steadfast.** The creature has [Immunity](0.%20DM%20Screen/variant-rules/immunity-xphb.md) to the [Frightened](0.%20DM%20Screen/conditions.md#Frightened) condition while it can see an ally within 30 feet of itself.  
...
- **Warrior's Wrath.** The creature has Advantage on melee attack rolls against any [Bloodied](0.%20DM%20Screen/conditions.md#Bloodied) creature.  
...
If the item grants a bonus that other items also grant, it's a good idea to require [Attunement](0.%20DM%20Screen/variant-rules/attunement-xphb.md) so characters don't try to collect too many of those items.

## Creating a Spell

![Ringlerun's spell research...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/026-02-006-ringlerun-researching.webp#center "Ringlerun's spell research leads in unexpected directions as he unintentionally creates a flying gelatinous cubelet")
...
![The curse of demonic posse...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/027-02-007-demonic-possession.webp#center "The curse of demonic possession has devastating effects")
...
- [Cackle Fever](0.%20DM%20Screen/diseases.md#Cackle%20Fever)  
- [Sewer Plague](0.%20DM%20Screen/diseases.md#Sewer%20Plague)  
- [Sight Rot](0.%20DM%20Screen/diseases.md#Sight%20Rot)  
...
![Sometimes death—even the d...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/028-02-008-death-passage.webp#center "Sometimes death—even the death of an entire party—is just a passage to new adventures")
...
The character has 1 Hit Point and the [Unconscious](0.%20DM%20Screen/conditions.md#Unconscious) condition. The character can regain Hit Points as normal, but the character remains Unconscious until they are targeted by a [Greater Restoration](greater-restoration-xphb.md) spell or experience a sudden awakening (see below).
...
You can also reward a player who describes a memory or something else occupying the dying character's thoughts with [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on the Death Save.
...
With the [Utilize](0.%20DM%20Screen/actions.md#Utilize) action, a creature can try to force open a door that is barred or locked, doing so with a successful Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check. The table provides the DC of the check. For bigger doors, double or triple the Hit Points and increase the DC of the check by 5.

![Doors](doors-xdmg.md)

#### Barred Door

A barred door has no lock. A creature on the barred side of the door can take the [Utilize](0.%20DM%20Screen/actions.md#Utilize) action to lift the bar from its braces, allowing the door to be opened.

#### Locked Door

Characters who don't have the key to a locked door can try to pick the lock using [Thieves' Tools](thieves-tools-xphb.md). The Lock Complexity table tells you how long it takes to try to pick a lock based on its complexity. At the end of that time, the character picks the lock by making a successful Dexterity ([Sleight of Hand](0.%20DM%20Screen/skills.md#Sleight%20of%20Hand)) check using Thieves' Tools. The DC is determined by the lock's quality, as shown in the Lock Quality table.
...
With the [Search](0.%20DM%20Screen/actions.md#Search) action, a character can search for a secret door along a 10-foot-square section of wall and make a Wisdom ([Perception](0.%20DM%20Screen/skills.md#Perception)) check. On a successful check, the character finds any secret door hidden in that section of wall as well as the mechanism to open the door. The DC of the check depends on how well the secret door is hidden, as shown in the Secret Doors table.

You can instead call for an Intelligence ([Investigation](0.%20DM%20Screen/skills.md#Investigation)) check if the challenge involves deducing that a door is present from noticeable clues, rather than spotting those clues in the first place. See ""Perception"" in "chapter 2" for more advice.
...
Typically made of iron or wood, a portcullis blocks a passage or an archway until it is raised into the ceiling by a winch and chain. Creatures within 5 feet of a lowered portcullis can make ranged attacks or cast spells through it, and they have [Three-Quarters Cover](0.%20DM%20Screen/tables/cover-xphb.md) against attacks, spells, and other effects originating from the opposite side. A portcullis can also be attacked and destroyed, using the AC and Hit Points of a metal door (if iron) or a wooden door (if wood).

Winching a portcullis up or down requires the Utilize action. If a creature can't reach the winch (usually because it's on the other side of the portcullis), lifting the portcullis requires the [Utilize](0.%20DM%20Screen/actions.md#Utilize) action and a successful Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check. The DC of the check depends on the type of portcullis, as shown in the Portcullises table.
...
![A dungeon built by giants ...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/029-02-009-giants-dungeon.webp#center "A dungeon built by giants offers enormous adventures")
...
When you design a guard post, decide how many guards are on duty, note their [Passive Perception](0.%20DM%20Screen/variant-rules/passive-perception-xphb.md) scores, and decide what they do when they notice intruders (see ""Monster Behavior"" in "chapter 4"). Some will rush headlong into a fight, while others will negotiate, sound an alarm, or flee to get help.
...
![A friendly bronze dragon k...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/030-02-010-bronze-dragon-v-ship.webp#center "A friendly bronze dragon keeps a watchful eye on a storm-tossed ship")
...
- The Frightened creature must take the [Dash](0.%20DM%20Screen/actions.md#Dash) action on each of its turns and uses its movement to get farther away from the source of its fear.  
- Attack rolls against the Frightened creature have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md).  
...
The character has the [Frightened](0.%20DM%20Screen/conditions.md#Frightened), [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated), or [Stunned](0.%20DM%20Screen/conditions.md#Stunned) condition for `1d10` minutes. This condition might be accompanied by alarming behavior or hallucinations. These effects can be suppressed with the [Calm Emotions](calm-emotions-xphb.md) spell or removed by the [Lesser Restoration](lesser-restoration-xphb.md) spell.

##### Long-Term Effects

The character has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on some or all ability checks for `1d10 × 10` hours, stemming from an unwillingness or inability to exert a particular set of abilities. The character might feel enervated and unable to exert much Strength, for example, or become so suspicious of others that Charisma checks are more difficult. These effects can be suppressed with the Calm Emotions spell or removed by the Lesser Restoration spell.
...
![Fight, flight, or freeze?](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/031-02-011-fight-flight-or-freeze.webp#center)
...
![When faced with a troll, t...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/032-02-012-troll-v-firearms.webp#center "When faced with a troll, there's no time to figure out the right way to hold a shotgun")
...
![Firearms](0.%20DM%20Screen/tables/firearms-xdmg.md)
...
As an action, you can either throw a grenade at a point up to 60 feet away or use a Grenade Launcher to propel the grenade to a point up to 1,000 feet away. The grenade explodes at that point, creating a particular effect in a 20-foot-radius [Sphere](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md).

#### Fragmentation Grenade

Each creature in the [Sphere](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md) makes a DC 15 Dexterity saving throw, taking 17 (`5d6`) Piercing damage on a failed save or half as much damage on a successful one.

#### Smoke Grenade

The area of the [Sphere](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md) is [Heavily Obscured](0.%20DM%20Screen/variant-rules/heavily-obscured-xphb.md) by smoke for 1 minute. A strong wind (such as the [Gust of Wind](gust-of-wind-xphb.md) spell) disperses the smoke.

#### Gunpowder

Setting fire to a container full of Gunpowder causes it to explode. When a container explodes, each creature in a 10-foot-radius [Sphere](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md) centered on the container makes a DC 12 Dexterity saving throw, taking 10 (`3d6`) Fire damage (for a powder horn) or 24 (`7d6`) Fire damage (for a keg) on a failed save or half as much damage on a successful one.

### Alien Technology

When adventurers find a piece of technology that isn't from their world or time period, they can deduce what it is with a successful Intelligence ([Investigation](0.%20DM%20Screen/skills.md#Investigation)) check, with the DC depending on the complexity of the item: DC 10 for a relatively simple item like a calculator or a lighter, or DC 20 for a complex item such as a computer, a chainsaw, or a hovercraft. You may require a separate Intelligence ([Investigation](0.%20DM%20Screen/skills.md#Investigation)) check to determine whether a character can activate or operate the technology; a character who has observed the item in use or has operated a similar item either has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on the check or succeeds on the check automatically (your choice).
...
![](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/035-02-015-spiders.webp#center)
...
![Queen Yolande of Celene is...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/036-02-016-queen-yolande.webp#center "Queen Yolande of Celene is grateful for adventurers' aid")
...
Whenever you would otherwise make a number of [D20 Tests](0.%20DM%20Screen/variant-rules/d20-test-xphb.md) for identical monsters, the Mob Results table can help you determine the number of successful [D20 Tests](0.%20DM%20Screen/variant-rules/d20-test-xphb.md) the monsters get without having to roll dice. Follow these steps:

- **Step 1.** Determine the minimum `d20` roll the monsters need to succeed on the [D20 Test](0.%20DM%20Screen/variant-rules/d20-test-xphb.md) using the following formula:  

**Roll needed** = target number−monster's bonus

- **Step 2.** Find the roll needed on the Mob Results table. If all the monsters have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on the roll (for example, if they're attacking and have the Pack Tactics trait, or if they're making a saving throw against a spell and have the Magic Resistance trait), find the roll needed in the With Advantage column. If all the monsters have [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) (for example, if they're attacking a creature protected by the [Blur](blur-xphb.md) spell), use the With Disadvantage column. Otherwise, use the Normal column.  
- **Step 3.** Read across the table to find a fractional number of successes you can easily apply to the group of monsters. That's the fraction of monsters that succeed on the [D20 Test](0.%20DM%20Screen/variant-rules/d20-test-xphb.md).  
...
Your judgment always outweighs these guidelines, and it's fine to err on the side of affecting more creatures. For example, if eight zombies are crowded around a Fighter when the Bard centers a [Shatter](shatter-xphb.md) spell on the Fighter's space, the spell's area should definitely engulf all eight zombies, even though according to the table, a 10-foot-radius [Sphere](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md) includes only three creatures.
...
![Nonplayer Characters come in all shapes and sizes](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/037-02-017-nonplayer-characters.webp#center)
...
![](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/038-02-018-lone-npc.webp#center)
...
Choose the NPC's [alignment](0.%20DM%20Screen/variant-rules/alignment-xphb.md), which can help you sketch the outlines of an NPC's behavior and personality. See the "Player's Handbook" and ""Alignment"" in this chapter for more information.
...
![Download PDF](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/039-02-019-npc-tracker-sheet.webp#center)
...
![As a member of another gro...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/040-02-020-npc-healer.webp#center "As a member of another group of heroes, Niko first joined Sheila, Diana, Eric, and Presto as an NPC healer")
...
A character can attempt to harvest poison from a venomous creature that is dead or has the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated) condition. The effort takes `1d6` minutes, after which the character makes a DC 20 Intelligence ([Nature](0.%20DM%20Screen/skills.md#Nature)) check using a [Poisoner's Kit](poisoners-kit-xphb.md). On a successful check, the character harvests enough poison for a single dose, and no additional poison can be harvested from that creature. On a failed check, the character is unable to extract any poison. If the character fails the check by 5 or more, the character is subjected to the creature's poison.
...
![Life in a city is full of fantastical surprises!](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/042-02-022-city-life.webp#center)
...
![](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/043-02-023-flagon-with-coins.webp#center)

![Download PDF](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/044-02-024-settlement-tracker-sheet.webp#center)
...
![A magical creature like a ...](0.%20DM%20Screen/books/dungeon-masters-guide-2024/img/047-02-027-unicorn.webp#center "A magical creature like a unicorn might bestow a supernatural gift")
...
- [Blessing of Health](0.%20DM%20Screen/rewards/blessing-of-health-xdmg.md)  
- [Blessing of Magic Resistance](0.%20DM%20Screen/rewards/blessing-of-magic-resistance-xdmg.md)  
- [Blessing of Protection](0.%20DM%20Screen/rewards/blessing-of-protection-xdmg.md)  
- [Blessing of Understanding](0.%20DM%20Screen/rewards/blessing-of-understanding-xdmg.md)  
- [Blessing of Valhalla](0.%20DM%20Screen/rewards/blessing-of-valhalla-xdmg.md)  
- [Blessing of Weapon Enhancement](0.%20DM%20Screen/rewards/blessing-of-weapon-enhancement-xdmg.md)  
- [Blessing of Wound Closure](0.%20DM%20Screen/rewards/blessing-of-wound-closure-xdmg.md)  
...
- [Charm of Animal Conjuring](0.%20DM%20Screen/rewards/charm-of-animal-conjuring-xdmg.md)  
- [Charm of Darkvision](0.%20DM%20Screen/rewards/charm-of-darkvision-xdmg.md)  
- [Charm of Feather Falling](0.%20DM%20Screen/rewards/charm-of-feather-falling-xdmg.md)  
- [Charm of Heroism](0.%20DM%20Screen/rewards/charm-of-heroism-xdmg.md)  
- [Charm of Restoration](0.%20DM%20Screen/rewards/charm-of-restoration-xdmg.md)  
- [Charm of the Slayer](0.%20DM%20Screen/rewards/charm-of-the-slayer-xdmg.md)  
- [Charm of Vitality](0.%20DM%20Screen/rewards/charm-of-vitality-xdmg.md)  
