...
aliases:
- Halfling
image: 0. DM Screen/races/img/halfling.webp
tags: race
---
# Halfling
*Source: Player's Handbook (2024) p. 193. Available in the Free Rules (2024)*  
![](0.%20DM%20Screen/races/img/halfling.webp)
...
You have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on saving throws you make to avoid or end the [Frightened](0.%20DM%20Screen/conditions.md#Frightened) condition.
...
When you roll a 1 on the `d20` of a [D20 Test](0.%20DM%20Screen/variant-rules/d20-test-xphb.md), you can reroll the die, and you must use the new roll.

### Naturally Stealthy

You can take the [Hide](0.%20DM%20Screen/actions.md#Hide) action even when you are obscured only by a creature that is at least one size larger than you.
