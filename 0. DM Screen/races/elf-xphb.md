...
aliases:
- Elf
image: 0. DM Screen/races/img/elf.webp
tags: race
---
# Elf
...
![](0.%20DM%20Screen/races/img/elf.webp)
...
When you reach character levels 3 and 5, you learn a higher-level spell, as shown on the table. You always have that spell prepared. You can cast it once without a spell slot, and you regain the ability to cast it in that way when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md). You can also cast the spell using any spell slots you have of the appropriate level.
...
|---------|---------|---------|---------|
| Drow | The range of your Darkvision increases to 120 feet. You also know the [Dancing Lights](dancing-lights-xphb.md) cantrip. | [Faerie Fire](faerie-fire-xphb.md) | [Darkness](2.%20Compendium/spells/darkness-xphb.md) |
...
You have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on saving throws you make to avoid or end the [Charmed](0.%20DM%20Screen/conditions.md#Charmed) condition.

### Keen Senses

You have proficiency in the [Insight](0.%20DM%20Screen/skills.md#Insight), [Perception](0.%20DM%20Screen/skills.md#Perception), or [Survival](0.%20DM%20Screen/skills.md#Survival) skill.

### Trance

You don't need to sleep, and magic can't put you to sleep. You can finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md) in 4 hours if you spend those hours in a trancelike meditation, during which you retain consciousness.
...
![A ship departs from a city built by high elves](0.%20DM%20Screen/races/img/148-05-022-elf-city.webp#center)