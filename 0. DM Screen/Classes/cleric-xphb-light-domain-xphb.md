...
As a [Magic](0.%20DM%20Screen/actions.md#Magic) action, you cause yourself to emit an aura of sunlight that lasts for 1 minute or until you dismiss it (no action required). You emit [Bright Light](bright-light-xphb.md) in a 60-foot radius and [Dim Light](dim-light-xphb.md) for an additional 30 feet. Your enemies in the [Bright Light](bright-light-xphb.md) have [Disadvantage](disadvantage-xphb.md) on saving throws against your Radiance of the Dawn and any spell that deals Fire or Radiant damage.
