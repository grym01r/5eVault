...
[Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack) have [Disadvantage](disadvantage-xphb.md) against you.
...
When you take damage, you can take a [Reaction](reaction-xphb.md) to give yourself [Resistance](0.%20DM%20Screen/Variant-rules/resistance-xphb.md) to that damage and any other damage of the same type until the end of the current turn.