...
You gain [Expertise](expertise-xphb.md) in two of your skill proficiencies of your choice. [Performance](0.%20DM%20Screen/skills.md#Performance) and [Persuasion](0.%20DM%20Screen/skills.md#Persuasion) are recommended if you have proficiency in them.
...
For example, if you make a Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check and lack [Athletics](0.%20DM%20Screen/skills.md#Athletics) proficiency, you can add half your [Proficiency Bonus](proficiency-xphb.md) to the check.
...
You can use musical notes or words of power to disrupt mind-influencing effects. If you or a creature within 30 feet of you fails a saving throw against an effect that applies the [Charmed](0.%20DM%20Screen/conditions.md#Charmed) or [Frightened](0.%20DM%20Screen/conditions.md#Frightened) condition, you can take a [Reaction](reaction-xphb.md) to cause the save to be rerolled, and the new roll has [Advantage](advantage-xphb.md).
