...
![A Cleric prays for the day's spells](051-03-027-cleric-praying.webp#center)
...
You can call on your deity or pantheon to intervene on your behalf. As a [Magic](0.%20DM%20Screen/actions.md#Magic) action, choose any Cleric spell of level 5 or lower that doesn't require a [Reaction](reaction-xphb.md) to cast. As part of the same action, you cast that spell without expending a spell slot or needing Material components. You can't use this feature again until you finish a [Long Rest](long-rest-xphb.md).
