...
![](beast-master-ranger.webp#right)
...
In combat, the beast acts during your turn. It can move and use its [Reaction](reaction-xphb.md) on its own, but the only action it takes is the [Dodge](0.%20DM%20Screen/actions.md#Dodge) action unless you take a [Bonus Action](bonus-action-xphb.md) to command it to take an action in its stat block or some other action. You can also sacrifice one of your attacks when you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action to command the beast to take the Beast's Strike action. If you have the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated) condition, the beast acts on its own and isn't limited to the [Dodge](0.%20DM%20Screen/actions.md#Dodge) action.

#### Restoring or Replacing the Beast

If the beast has died within the last hour, you can take a [Magic](0.%20DM%20Screen/actions.md#Magic) action to touch it and expend a spell slot. The beast returns to life after 1 minute with all its [Hit Points](hit-points-xphb.md) restored.
...
When you take a [Bonus Action](bonus-action-xphb.md) to command your Primal Companion beast to take an action, you can also command it to take the [Dash](0.%20DM%20Screen/actions.md#Dash), [Disengage](0.%20DM%20Screen/actions.md#Disengage), [Dodge](0.%20DM%20Screen/actions.md#Dodge), or [Help](0.%20DM%20Screen/actions.md#Help) action using its [Bonus Action](bonus-action-xphb.md).
