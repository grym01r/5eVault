...
When you reduce an enemy to 0 [Hit Points](hit-points-xphb.md), you gain [Temporary Hit Points](temporary-hit-points-xphb.md) equal to your Charisma modifier plus your Warlock level (minimum of 1 [Temporary Hit Point](temporary-hit-points-xphb.md)). You also gain this benefit if someone else reduces an enemy within 10 feet of you to 0 [Hit Points](hit-points-xphb.md).
...
Choose one damage type, other than Force, whenever you finish a [Short](short-rest-xphb.md) or [Long Rest](long-rest-xphb.md). You have [Resistance](0.%20DM%20Screen/Variant-rules/resistance-xphb.md) to that damage type until you choose a different one with this feature.
