...
![](arcane-trickster-rogue.webp#right)
...
When you cast [Mage Hand](mage-hand-xphb.md), you can cast it as a [Bonus Action](bonus-action-xphb.md), and you can make the spectral hand [Invisible](0.%20DM%20Screen/conditions.md#Invisible). You can control the hand as a [Bonus Action](bonus-action-xphb.md), and through it, you can make Dexterity ([Sleight of Hand](0.%20DM%20Screen/skills.md#Sleight%20of%20Hand)) checks.

### Magical Ambush (Level 9)

If you have the [Invisible](0.%20DM%20Screen/conditions.md#Invisible) condition when you cast a spell on a creature, it has [Disadvantage](disadvantage-xphb.md) on any saving throw it makes against the spell on the same turn.
