...
![](039-03-015-barbarian-weapons.webp#right)
...
While you aren't wearing any armor, your base [Armor Class](armor-class-xphb.md) equals 10 plus your Dexterity and Constitution modifiers. You can use a [Shield](2.%20Compendium/Items/shield-xphb.md) and still gain this benefit.
...
You gain an uncanny sense of when things aren't as they should be, giving you an edge when you dodge perils. You have [Advantage](advantage-xphb.md) on Dexterity saving throws unless you have the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated) condition.
...
The target is pushed 15 feet straight away from you. You can then move up to half your [Speed](speed-xphb.md) straight toward the target without provoking [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack).
...
The target has [Disadvantage](disadvantage-xphb.md) on the next saving throw it makes, and it can't make [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack) until the start of your next turn.
