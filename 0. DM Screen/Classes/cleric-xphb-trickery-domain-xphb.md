...
As a [Magic](0.%20DM%20Screen/actions.md#Magic) action, you can choose yourself or a willing creature within 30 feet of yourself to have [Advantage](advantage-xphb.md) on Dexterity ([Stealth](0.%20DM%20Screen/skills.md#Stealth)) checks. This blessing lasts until you finish a [Long Rest](long-rest-xphb.md) or you use this feature again.

### Invoke Duplicity (Level 3)

As a [Bonus Action](bonus-action-xphb.md), you can expend one use of your Channel Divinity to create a perfect visual illusion of yourself in an unoccupied space you can see within 30 feet of yourself. The illusion is intangible and doesn't occupy its space. It lasts for 1 minute, but it ends early if you dismiss it (no action required) or have the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated) condition. The illusion is animated and mimics your expressions and gestures. While it persists, you gain the following benefits.
