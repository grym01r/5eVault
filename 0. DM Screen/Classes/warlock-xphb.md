...
![](114-04-029-skull-spiders.webp#center)
...
The Warlock Features table shows how many spell slots you have to cast your Warlock spells of levels 1–5. The table also shows the level of those slots, all of which are the same level. You regain all expended Pact Magic spell slots when you finish a [Short](short-rest-xphb.md) or [Long Rest](long-rest-xphb.md).
...
You can use an [Arcane Focus](arcane-focus-xphb.md) as a [Spellcasting Focus](spellcasting-focus-xphb.md) for your Warlock spells.
