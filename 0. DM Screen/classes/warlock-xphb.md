...
proficiencies: [Arcana, Deception, History, Intimidation, Investigation, Nature, Religion, Simple, Light]
spellcasting: True
subclasses:
source: [XPHB]
aliases:
- Warlock
image: 0. DM Screen/classes/img/warlock.webp
tags: class
---
# Warlock
...
> <tr class="class-progression"><th class"level">Level</th><th class"pb">PB</th><th class"feature">Features</th><th class="value"><a href="0.%20DM%20Screen/lists/list-optfeaturetype-ei.md">Invocations</a></th><th class="value">Cantrips</th><th class="value">Prepared Spells</th><th class="value">Spell Slots</th><th class="value">Slot Level</th></tr>
> </thead><tbody>
...
![](0.%20DM%20Screen/classes/img/warlock.webp)
...
- **Skill Proficiencies**: *Choose 2:* [Arcana](0.%20DM%20Screen/skills.md#Arcana), [Deception](0.%20DM%20Screen/skills.md#Deception), [History](0.%20DM%20Screen/skills.md#History), [Intimidation](0.%20DM%20Screen/skills.md#Intimidation), [Investigation](0.%20DM%20Screen/skills.md#Investigation), [Nature](0.%20DM%20Screen/skills.md#Nature), or [Religion](0.%20DM%20Screen/skills.md#Religion)
- **Weapon Proficiencies**: Simple weapons
- **Armor Training**: [Light armor](0.%20DM%20Screen/item-types.md#Light%20Armor)

**Starting Equipment:** *Choose A or B:* (A) [Leather Armor](leather-armor-xphb.md), [Sickle](sickle-xphb.md), 2 [Daggers](dagger-xphb.md), [Arcane Focus](arcane-focus-xphb.md) ([orb](orb-xphb.md)), [Book](book-xphb.md) (occult lore), [Scholar's Pack](scholars-pack-xphb.md), and 15 GP; or (B) 100 GP

## Multiclassing Warlock

- **Armor Training**: [Light armor](0.%20DM%20Screen/item-types.md#Light%20Armor)

![](0.%20DM%20Screen/classes/img/114-04-029-skull-spiders.webp#center)
...
You have unearthed Eldritch Invocations, pieces of forbidden knowledge that imbue you with an abiding magical ability or other lessons. You gain one invocation of your choice, such as Pact of the Tome. Invocations are described in the "Eldritch Invocation Options^[Optional features from [Eldritch Invocation](0.%20DM%20Screen/lists/list-optfeaturetype-ei.md); defined in Player's Handbook (2024)]" section later in this class's description.
...
You know two Warlock cantrips of your choice. [Eldritch Blast](eldritch-blast-xphb.md) and [Prestidigitation](prestidigitation-xphb.md) are recommended. Whenever you gain a Warlock level, you can replace one of your cantrips from this feature with another Warlock cantrip of your choice.

When you reach Warlock levels 4 and 10, you learn another Warlock cantrip of your choice, as shown in the Cantrips column of the Warlock Features table.

#### Spell Slots

The Warlock Features table shows how many spell slots you have to cast your Warlock spells of levels 1–5. The table also shows the level of those slots, all of which are the same level. You regain all expended Pact Magic spell slots when you finish a [Short](0.%20DM%20Screen/variant-rules/short-rest-xphb.md) or [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).
...
You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Warlock spells. [Charm Person](charm-person-xphb.md) and [Hex](hex-xphb.md) are recommended.
...
You can use an [Arcane Focus](arcane-focus-xphb.md) as a [Spellcasting Focus](0.%20DM%20Screen/variant-rules/spellcasting-focus-xphb.md) for your Warlock spells.
...
You can perform an esoteric rite for 1 minute. At the end of it, you regain expended Pact Magic spell slots but no more than a number equal to half your maximum (round up). Once you use this feature, you can't do so again until you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).
...
You gain the [Ability Score Improvement](0.%20DM%20Screen/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Warlock levels 8, 12, and 16.
...
Once you cast the spell with this feature, you can't do so in this way again until you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).
...
You can cast your arcanum spell once without expending a spell slot, and you must finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md) before you can cast it in this way again.

As shown in the Warlock Features table, you gain another Warlock spell of your choice that can be cast in this way when you reach Warlock levels 13 (level 7 spell), 15 (level 8 spell), and 17 (level 9 spell). You regain all uses of your Mystic Arcanum when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).
...
> ![Eldritch Invocation](0.%20DM%20Screen/lists/list-optfeaturetype-ei.md#Eldritch%20Invocation)
^list-optfeature-ei