...
- College of Valor
tags: subclass
image: 0. DM Screen/classes/img/valor-bard.webp
---
# College of Valor
...
![](0.%20DM%20Screen/classes/img/valor-bard.webp#right)
...
When the creature is hit by an attack roll, that creature can use its [Reaction](0.%20DM%20Screen/variant-rules/reaction-xphb.md) to roll the Bardic Inspiration die and add the number rolled to its AC against that attack, potentially causing the attack to miss.
...
You gain proficiency with Martial weapons and training with Medium armor and [Shields](2.%20Compendium/items/shield-xphb.md).

In addition, you can use a Simple or Martial weapon as a [Spellcasting Focus](0.%20DM%20Screen/variant-rules/spellcasting-focus-xphb.md) to cast spells from your Bard spell list.
...
After you cast a spell that has a casting time of an action, you can make one attack with a weapon as a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md).