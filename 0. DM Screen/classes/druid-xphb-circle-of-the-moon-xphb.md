...
- Circle of the Moon
tags: subclass
image: 0. DM Screen/classes/img/moon-druid.webp
---
# Circle of the Moon
...
![](0.%20DM%20Screen/classes/img/moon-druid.webp#right)
...
The maximum [Challenge Rating](0.%20DM%20Screen/variant-rules/challenge-rating-xphb.md) for the form equals your Druid level divided by 3 (round down).
...
You gain a number of [Temporary Hit Points](0.%20DM%20Screen/variant-rules/temporary-hit-points-xphb.md) equal to three times your Druid level.
...
You magically transport yourself, reappearing amid a burst of moonlight. As a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md), you teleport up to 30 feet to an unoccupied space you can see, and you have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on the next attack roll you make before the end of this turn.

You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md). You can also regain uses by expending a level 2+ spell slot for each use you want to restore (no action required).
