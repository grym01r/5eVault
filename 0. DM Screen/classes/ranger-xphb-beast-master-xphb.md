...
- Beast Master
tags: subclass
image: 0. DM Screen/classes/img/beast-master-ranger.webp
---
# Beast Master
...
![](0.%20DM%20Screen/classes/img/beast-master-ranger.webp#right)
...
In combat, the beast acts during your turn. It can move and use its [Reaction](0.%20DM%20Screen/variant-rules/reaction-xphb.md) on its own, but the only action it takes is the [Dodge](0.%20DM%20Screen/actions.md#Dodge) action unless you take a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md) to command it to take an action in its stat block or some other action. You can also sacrifice one of your attacks when you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action to command the beast to take the Beast's Strike action. If you have the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated) condition, the beast acts on its own and isn't limited to the [Dodge](0.%20DM%20Screen/actions.md#Dodge) action.

#### Restoring or Replacing the Beast

If the beast has died within the last hour, you can take a [Magic](0.%20DM%20Screen/actions.md#Magic) action to touch it and expend a spell slot. The beast returns to life after 1 minute with all its [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) restored.

Whenever you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md), you can summon a different primal beast, which appears in an unoccupied space within 5 feet of you. You choose its stat block and appearance. If you already have a beast from this feature, the old one vanishes when the new one appears.

### Exceptional Training (Level 7)

When you take a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md) to command your Primal Companion beast to take an action, you can also command it to take the [Dash](0.%20DM%20Screen/actions.md#Dash), [Disengage](0.%20DM%20Screen/actions.md#Disengage), [Dodge](0.%20DM%20Screen/actions.md#Dodge), or [Help](0.%20DM%20Screen/actions.md#Help) action using its [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md).
