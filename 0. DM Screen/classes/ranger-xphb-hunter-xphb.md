...
- Hunter
tags: subclass
image: 0. DM Screen/classes/img/hunter-ranger.webp
---
# Hunter
...
![](0.%20DM%20Screen/classes/img/hunter-ranger.webp#right)
...
You gain one of the following feature options of your choice. Whenever you finish a [Short](0.%20DM%20Screen/variant-rules/short-rest-xphb.md) or [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md), you can replace the chosen option with the other one.

#### Colossus Slayer

Your tenacity can wear down even the most resilient foes. When you hit a creature with a weapon, the weapon deals an extra `1d8` damage to the target if it's missing any of its [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md). You can deal this extra damage only once per turn.
...
[Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack) have [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) against you.

#### Multiattack Defense

When a creature hits you with an attack roll, that creature has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on all other attack rolls against you this turn.
...
When you take damage, you can take a [Reaction](0.%20DM%20Screen/variant-rules/reaction-xphb.md) to give yourself [Resistance](0.%20DM%20Screen/variant-rules/resistance-xphb.md) to that damage and any other damage of the same type until the end of the current turn.