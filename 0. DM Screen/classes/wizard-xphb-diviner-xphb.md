...
aliases:
  - Diviner
tags: subclass
image: 0. DM Screen/classes/img/diviner-wizard.webp
---
# Diviner
...
![](0.%20DM%20Screen/classes/img/diviner-wizard.webp#right)
...
Glimpses of the future begin to press on your awareness. Whenever you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md), roll two d20s and record the numbers rolled. You can replace any [D20 Test](0.%20DM%20Screen/variant-rules/d20-test-xphb.md) made by you or a creature that you can see with one of these foretelling rolls. You must choose to do so before the roll, and you can replace a roll in this way only once per turn.

Each foretelling roll can be used only once. When you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md), you lose any unused foretelling rolls.
...
You can increase your powers of perception. As a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md), choose one of the following benefits, which lasts until you start a [Short](0.%20DM%20Screen/variant-rules/short-rest-xphb.md) or [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md). You can't use this feature again until you finish a [Short](0.%20DM%20Screen/variant-rules/short-rest-xphb.md) or [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).

#### Darkvision

You gain [Darkvision](0.%20DM%20Screen/senses.md#Darkvision) with a range of 120 feet.
...
You can cast [See Invisibility](see-invisibility-xphb.md) without expending a spell slot.
