...
aliases:
  - Bard
image: 0. DM Screen/classes/img/bard.webp
tags: class
---
# Bard
...
![](0.%20DM%20Screen/classes/img/bard.webp)
...
- **Skill Proficiencies**: Choose 3 [skills](0.%20DM%20Screen/skills.md)
...
- **Skill Proficiencies**: Choose 1 [skill](0.%20DM%20Screen/skills.md)
...
As a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md), you can inspire another creature within 60 feet of yourself who can see or hear you. That creature gains one of your Bardic Inspiration dice. A creature can have only one Bardic Inspiration die at a time.

Once within the next hour when the creature fails a [D20 Test](0.%20DM%20Screen/variant-rules/d20-test-xphb.md), the creature can roll the Bardic Inspiration die and add the number rolled to the `d20`, potentially turning the failure into a success. A Bardic Inspiration die is expended when it's rolled.

#### Number of Uses

You can confer a Bardic Inspiration die a number of times equal to your Charisma modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).
...
The Bard Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).
...
You can use a [Musical Instrument](musical-instrument-xphb.md) as a [Spellcasting Focus](0.%20DM%20Screen/variant-rules/spellcasting-focus-xphb.md) for your Bard spells.

### Expertise (Level 2)

You gain [Expertise](0.%20DM%20Screen/variant-rules/expertise-xphb.md) in two of your skill proficiencies of your choice. [Performance](0.%20DM%20Screen/skills.md#Performance) and [Persuasion](0.%20DM%20Screen/skills.md#Persuasion) are recommended if you have proficiency in them.

At Bard level 9, you gain [Expertise](0.%20DM%20Screen/variant-rules/expertise-xphb.md) in two more of your skill proficiencies of your choice.

### Jack of All Trades (Level 2)

You can add half your [Proficiency Bonus](0.%20DM%20Screen/variant-rules/proficiency-xphb.md) (round down) to any ability check you make that uses a skill proficiency you lack and that doesn't otherwise use your [Proficiency Bonus](0.%20DM%20Screen/variant-rules/proficiency-xphb.md).

For example, if you make a Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check and lack [Athletics](0.%20DM%20Screen/skills.md#Athletics) proficiency, you can add half your [Proficiency Bonus](0.%20DM%20Screen/variant-rules/proficiency-xphb.md) to the check.
...
You gain the [Ability Score Improvement](0.%20DM%20Screen/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Bard levels 8, 12, and 16.

### Font of Inspiration (Level 5)

You now regain all your expended uses of Bardic Inspiration when you finish a [Short](0.%20DM%20Screen/variant-rules/short-rest-xphb.md) or [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).
...
You can use musical notes or words of power to disrupt mind-influencing effects. If you or a creature within 30 feet of you fails a saving throw against an effect that applies the [Charmed](0.%20DM%20Screen/conditions.md#Charmed) or [Frightened](0.%20DM%20Screen/conditions.md#Frightened) condition, you can take a [Reaction](0.%20DM%20Screen/variant-rules/reaction-xphb.md) to cause the save to be rerolled, and the new roll has [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md).
...
When you roll [Initiative](0.%20DM%20Screen/variant-rules/initiative-xphb.md), you regain expended uses of Bardic Inspiration until you have two if you have fewer than that.
