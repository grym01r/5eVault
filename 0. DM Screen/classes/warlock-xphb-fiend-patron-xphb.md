...
- Fiend Patron
tags: subclass
image: 0. DM Screen/classes/img/fiend-warlock.webp
---
# Fiend Patron
...
![](0.%20DM%20Screen/classes/img/fiend-warlock.webp#right)
...
|---------------|--------|
| 3 | [Burning Hands](burning-hands-xphb.md), [Command](command-xphb.md), [Scorching Ray](scorching-ray-xphb.md), [Suggestion](suggestion-xphb.md) |
...
| 9 | [Geas](geas-xphb.md), [Insect Plague](insect-plague-xphb.md) |
^fiend-spells

### Dark One's Blessing (Level 3)

When you reduce an enemy to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md), you gain [Temporary Hit Points](0.%20DM%20Screen/variant-rules/temporary-hit-points-xphb.md) equal to your Charisma modifier plus your Warlock level (minimum of 1 [Temporary Hit Point](0.%20DM%20Screen/variant-rules/temporary-hit-points-xphb.md)). You also gain this benefit if someone else reduces an enemy within 10 feet of you to 0 [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md).
...
You can use this feature a number of times equal to your Charisma modifier (minimum of once), but you can use it no more than once per roll. You regain all expended uses when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).

### Fiendish Resilience (Level 10)

Choose one damage type, other than Force, whenever you finish a [Short](0.%20DM%20Screen/variant-rules/short-rest-xphb.md) or [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md). You have [Resistance](0.%20DM%20Screen/variant-rules/resistance-xphb.md) to that damage type until you choose a different one with this feature.

### Hurl Through Hell (Level 14)

Once per turn when you hit a creature with an attack roll, you can try to instantly transport the target through the Lower Planes. The target must succeed on a Charisma saving throw against your spell save DC, or the target disappears and hurtles through a nightmare landscape. The target takes `8d10` Psychic damage if it isn't a Fiend, and it has the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated) condition until the end of your next turn, when it returns to the space it previously occupied or the nearest unoccupied space.

Once you use this feature, you can't use it again until you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md) unless you expend a Pact Magic spell slot (no action required) to restore your use of it.