...
- Arcane Trickster
tags: subclass
image: 0. DM Screen/classes/img/arcane-trickster-rogue.webp
---
# Arcane Trickster
...
![](0.%20DM%20Screen/classes/img/arcane-trickster-rogue.webp#right)
...
You know three cantrips: [Mage Hand](mage-hand-xphb.md) and two other cantrips of your choice from the Wizard spell list (see that class's section for its list). [Mind Sliver](mind-sliver-xphb.md) and [Minor Illusion](minor-illusion-xphb.md) are recommended.
...
The Arcane Trickster Spellcasting table shows how many spell slots you have to cast your level 1+ spells. You regain all expended spell slots when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).

#### Prepared Spells of 1st+ Level

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose three level 1 Wizard spells. [Charm Person](charm-person-xphb.md), [Disguise Self](disguise-self-xphb.md), and [Fog Cloud](fog-cloud-xphb.md) are recommended.
...
When you cast [Mage Hand](mage-hand-xphb.md), you can cast it as a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md), and you can make the spectral hand [Invisible](0.%20DM%20Screen/conditions.md#Invisible). You can control the hand as a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md), and through it, you can make Dexterity ([Sleight of Hand](0.%20DM%20Screen/skills.md#Sleight%20of%20Hand)) checks.

### Magical Ambush (Level 9)

If you have the [Invisible](0.%20DM%20Screen/conditions.md#Invisible) condition when you cast a spell on a creature, it has [Disadvantage](0.%20DM%20Screen/variant-rules/disadvantage-xphb.md) on any saving throw it makes against the spell on the same turn.
...
Immediately after a creature casts a spell that targets you or includes you in its area of effect, you can take a [Reaction](0.%20DM%20Screen/variant-rules/reaction-xphb.md) to force the creature to make an Intelligence saving throw. The DC equals your spell save DC. On a failed save, you negate the spell's effect against you, and you steal the knowledge of the spell if it is at least level 1 and of a level you can cast (it doesn't need to be a Wizard spell). For the next 8 hours, you have the spell prepared. The creature can't cast it until the 8 hours have passed.

Once you steal a spell with this feature, you can't use this feature again until you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).