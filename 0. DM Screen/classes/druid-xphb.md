...
proficiencies: [Arcana, Animal Handling, Insight, Medicine, Nature, Perception, Religion, Survival, Simple, Herbalism Kit, Light, Shields]
spellcasting: True
subclasses:
source: [XPHB]
aliases:
- Druid
image: 0. DM Screen/classes/img/druid.webp
tags: class
---
# Druid
...
![](0.%20DM%20Screen/classes/img/druid.webp)
...
- **Skill Proficiencies**: *Choose 2:* [Animal Handling](0.%20DM%20Screen/skills.md#Animal%20Handling), [Arcana](0.%20DM%20Screen/skills.md#Arcana), [Insight](0.%20DM%20Screen/skills.md#Insight), [Medicine](0.%20DM%20Screen/skills.md#Medicine), [Nature](0.%20DM%20Screen/skills.md#Nature), [Perception](0.%20DM%20Screen/skills.md#Perception), [Religion](0.%20DM%20Screen/skills.md#Religion), or [Survival](0.%20DM%20Screen/skills.md#Survival)
- **Weapon Proficiencies**: Simple weapons
- **Tool Proficiencies**: [Herbalism Kit](herbalism-kit-xphb.md)
- **Armor Training**: [Light armor](0.%20DM%20Screen/item-types.md#Light%20Armor) and [Shields](2.%20Compendium/items/shield-xphb.md)

**Starting Equipment:** *Choose A or B:* (A) [Leather Armor](leather-armor-xphb.md), [Shield](2.%20Compendium/items/shield-xphb.md), [Sickle](sickle-xphb.md), [Druidic Focus (Quarterstaff)](druidic-focus-xphb.md), [Explorer's Pack](explorers-pack-xphb.md), [Herbalism kit](herbalism-kit-xphb.md), 9 GP; or (B) 50 GP

## Multiclassing Druid

- **Armor Training**: [Light armor](0.%20DM%20Screen/item-types.md#Light%20Armor), [Shields](2.%20Compendium/items/shield-xphb.md)

> [!gallery]
![A Druid channels the power...](0.%20DM%20Screen/classes/img/057-03-033-druid-in-nature.webp "A Druid channels the power of nature through their magic")
![A Druid in wolf form howls at the moon](0.%20DM%20Screen/classes/img/060-03-036-wolf-form-druid.webp)
...
You can use Druidic to leave hidden messages. You and others who know Druidic automatically spot such a message. Others spot the message's presence with a successful DC 15 Intelligence ([Investigation](0.%20DM%20Screen/skills.md#Investigation)) check but can't decipher it without magic.
...
- **Magician**  
    ...
    You know one extra cantrip from the Druid spell list. In addition, your mystical connection to nature gives you a bonus to your Intelligence ([Arcana](0.%20DM%20Screen/skills.md#Arcana) or [Nature](0.%20DM%20Screen/skills.md#Nature)) checks. The bonus equals your Wisdom modifier (minimum bonus of +1).  
...
The Druid Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).

#### Prepared Spells of Level 1+

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose four level 1 spells from the Druid spell list. [Animal Friendship](animal-friendship-xphb.md), [Cure Wounds](cure-wounds-xphb.md), [Faerie Fire](faerie-fire-xphb.md), and [Thunderwave](thunderwave-xphb.md) are recommended.
...
Whenever you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md), you can change your list of prepared spells, replacing any of the spells with other Druid spells for which you have spell slots.
...
You can use a [Druidic Focus](druidic-focus-xphb.md) as a [Spellcasting Focus](0.%20DM%20Screen/variant-rules/spellcasting-focus-xphb.md) for your Druid spells.

### Wild Companion (Level 2)

You can summon a nature spirit that assumes an animal form to aid you. As a [Magic](0.%20DM%20Screen/actions.md#Magic) action, you can expend a spell slot or a use of Wild Shape to cast the [Find Familiar](find-familiar-xphb.md) spell without Material components.

When you cast the spell in this way, the familiar is Fey and disappears when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).

### Wild Shape (Level 2)

The power of nature allows you to assume the form of an animal. As a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md), you shape-shift into a Beast form that you have learned for this feature (see "Known Forms" below). You stay in that form for a number of hours equal to half your Druid level or until you use Wild Shape again, have the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated) condition, or die. You can also leave the form early as a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md).

#### Number of Uses

You can use Wild Shape twice. You regain one expended use when you finish a [Short Rest](0.%20DM%20Screen/variant-rules/short-rest-xphb.md), and you regain all expended uses when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).

You gain additional uses when you reach certain Druid levels, as shown in the Wild Shape column of the Druid Features table.

#### Known Forms

You know four Beast forms for this feature, chosen from among Beast stat blocks that have a maximum [Challenge Rating](0.%20DM%20Screen/variant-rules/challenge-rating-xphb.md) of 1/4 and that lack a [Fly Speed](0.%20DM%20Screen/variant-rules/fly-speed-xphb.md) (see appendix B for stat block options). The [Rat](rat-xmm.md), [Riding Horse](riding-horse-xmm.md), [Spider](spider-xmm.md), and [Wolf](wolf-xmm.md) are recommended. Whenever you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md), you can replace one of your known forms with another eligible form.

When you reach certain Druid levels, your number of known forms and the maximum [Challenge Rating](0.%20DM%20Screen/variant-rules/challenge-rating-xphb.md) for those forms increases, as shown in the Beast Shapes table. In addition, starting at level 8, you can adopt a form that has a [Fly Speed](0.%20DM%20Screen/variant-rules/fly-speed-xphb.md).
...
- **Temporary Hit Points.** When you assume a Wild Shape form, you gain a number of [Temporary Hit Points](0.%20DM%20Screen/variant-rules/temporary-hit-points-xphb.md) equal to your Druid level.  
- **Game Statistics.** Your game statistics are replaced by the Beast's stat block, but you retain your creature type; [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md); [Hit Point Dice](0.%20DM%20Screen/variant-rules/hit-point-dice-xphb.md); Intelligence, Wisdom, and Charisma scores; class features; languages; and feats. You also retain your skill and saving throw proficiencies and use your [Proficiency Bonus](0.%20DM%20Screen/variant-rules/proficiency-xphb.md) for them, in addition to gaining the proficiencies of the creature. If a skill or saving throw modifier in the Beast's stat block is higher than yours, use the one in the stat block.  
- **No Spellcasting.** You can't cast spells, but shape-shifting doesn't break your [Concentration](0.%20DM%20Screen/conditions.md#Concentration) or otherwise interfere with a spell you've already cast.  
...
You gain the [Ability Score Improvement](0.%20DM%20Screen/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Druid levels 8, 12, and 16.

### Wild Resurgence (Level 5)

Once on each of your turns, if you have no uses of Wild Shape left, you can give yourself one use by expending a spell slot (no action required).

In addition, you can expend one use of Wild Shape (no action required) to give yourself a level 1 spell slot, but you can't do so again until you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Dimensional Travel](0.%20DM%20Screen/feats/boon-of-dimensional-travel-xphb.md) is recommended.
...
Whenever you roll [Initiative](0.%20DM%20Screen/variant-rules/initiative-xphb.md) and have no uses of Wild Shape left, you regain one expended use of it.

#### Nature Magician

You can convert uses of Wild Shape into a spell slot (no action required). Choose a number of your unexpended uses of Wild Shape and convert them into a single spell slot, with each use contributing 2 spell levels. For example, if you convert two uses of Wild Shape, you produce a level 4 spell slot. Once you use this benefit, you can't do so again until you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).
