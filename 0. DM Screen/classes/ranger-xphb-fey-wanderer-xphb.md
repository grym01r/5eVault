...
- Fey Wanderer
tags: subclass
image: 0. DM Screen/classes/img/fey-wanderer-ranger.webp
---
# Fey Wanderer
...
![](0.%20DM%20Screen/classes/img/fey-wanderer-ranger.webp#right)
...
| dice: 1d6 | Gift |
|-----------|------|
| 1 | Illusory butterflies flutter around you while you take a [Short](0.%20DM%20Screen/variant-rules/short-rest-xphb.md) or [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md). |
...
You also gain proficiency in one of these skills of your choice: [Deception](0.%20DM%20Screen/skills.md#Deception), [Performance](0.%20DM%20Screen/skills.md#Performance), or [Persuasion](0.%20DM%20Screen/skills.md#Persuasion).

### Beguiling Twist (Level 7)

The magic of the Feywild guards your mind. You have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on saving throws to avoid or end the [Charmed](0.%20DM%20Screen/conditions.md#Charmed) or [Frightened](0.%20DM%20Screen/conditions.md#Frightened) condition.

In addition, whenever you or a creature you can see within 120 feet of you succeeds on a saving throw to avoid or end the [Charmed](0.%20DM%20Screen/conditions.md#Charmed) or [Frightened](0.%20DM%20Screen/conditions.md#Frightened) condition, you can take a [Reaction](0.%20DM%20Screen/variant-rules/reaction-xphb.md) to force a different creature you can see within 120 feet of yourself to make a Wisdom save against your spell save DC. On a failed save, the target is [Charmed](0.%20DM%20Screen/conditions.md#Charmed) or [Frightened](0.%20DM%20Screen/conditions.md#Frightened) (your choice) for 1 minute. The target repeats the save at the end of each of its turns, ending the effect on itself on a success.

### Fey Reinforcements (Level 11)

You can cast [Summon Fey](summon-fey-xphb.md) without a Material component. You can also cast it once without a spell slot, and you regain the ability to cast it in this way when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).

Whenever you start casting the spell, you can modify it so that it doesn't require [Concentration](0.%20DM%20Screen/conditions.md#Concentration). If you do so, the spell's duration becomes 1 minute for that casting.

### Misty Wanderer (Level 15)

You can cast [Misty Step](misty-step-xphb.md) without expending a spell slot. You can do so a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).
