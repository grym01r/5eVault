...
proficiencies: [History, Insight, Medicine, Persuasion, Religion, Simple, Light, Medium, Shields]
spellcasting: True
subclasses:
source: [XPHB]
aliases:
- Cleric
image: 0. DM Screen/classes/img/cleric.webp
tags: class
---
# Cleric
...
![](0.%20DM%20Screen/classes/img/cleric.webp)
...
- **Skill Proficiencies**: *Choose 2:* [History](0.%20DM%20Screen/skills.md#History), [Insight](0.%20DM%20Screen/skills.md#Insight), [Medicine](0.%20DM%20Screen/skills.md#Medicine), [Persuasion](0.%20DM%20Screen/skills.md#Persuasion), or [Religion](0.%20DM%20Screen/skills.md#Religion)
...
**Starting Equipment:** *Choose A or B:* (A) [Chain Shirt](chain-shirt-xphb.md), [Shield](2.%20Compendium/items/shield-xphb.md), [Mace](mace-xphb.md), [Holy Symbol](holy-symbol-xphb.md), [Priest's Pack](priests-pack-xphb.md), 7 GP; or (B) 110 GP
...
![A Cleric prays for the day's spells](0.%20DM%20Screen/classes/img/051-03-027-cleric-praying.webp#center)
...
The Cleric Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).
...
Whenever you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md), you can change your list of prepared spells, replacing any of the spells there with other Cleric spells for which you have spell slots.
...
You can use a [Holy Symbol](holy-symbol-xphb.md) as a [Spellcasting Focus](0.%20DM%20Screen/variant-rules/spellcasting-focus-xphb.md) for your Cleric spells.
...
- **Thaumaturge**  
    ...
    You know one extra cantrip from the Cleric spell list. In addition, your mystical connection to the divine gives you a bonus to your Intelligence ([Arcana](0.%20DM%20Screen/skills.md#Arcana) or [Religion](0.%20DM%20Screen/skills.md#Religion)) checks. The bonus equals your Wisdom modifier (minimum of +1).  

### Channel Divinity (Level 2)

You can channel divine energy directly from the Outer Planes to fuel magical effects. You start with two such effects: Divine Spark and Turn Undead, each of which is described below. Each time you use this class's Channel Divinity, choose which Channel Divinity effect from this class to create. You gain additional effect options at higher Cleric levels.

You can use this class's Channel Divinity twice. You regain one of its expended uses when you finish a [Short Rest](0.%20DM%20Screen/variant-rules/short-rest-xphb.md), and you regain all expended uses when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md). You gain additional uses when you reach certain Cleric levels, as shown in the Channel Divinity column of the Cleric Features table.

If a Channel Divinity effect requires a saving throw, the DC equals the spell save DC from this class's Spellcasting feature.

### Divine Spark (Level 2)

As a [Magic](0.%20DM%20Screen/actions.md#Magic) action, you point your [Holy Symbol](holy-symbol-xphb.md) at another creature you can see within 30 feet of yourself and focus divine energy at it. Roll `1d8` and add your Wisdom modifier. You either restore [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) to the creature equal to that total or force the creature to make a Constitution saving throw. On a failed save, the creature takes Necrotic or Radiant damage (your choice) equal to that total. On a successful save, the creature takes half as much damage (round down).

You roll an additional `d8` when you reach Cleric levels 7 (`2d8`), 13 (`3d8`), and 18 (`4d8`).

### Turn Undead (Level 2)

As a [Magic](0.%20DM%20Screen/actions.md#Magic) action, you present your [Holy Symbol](holy-symbol-xphb.md) and censure Undead creatures. Each Undead of your choice within 30 feet of you must make a Wisdom saving throw. If the creature fails its save, it has the [Frightened](0.%20DM%20Screen/conditions.md#Frightened) and [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated) conditions for 1 minute. For that duration, it tries to move as far from you as it can on its turns. This effect ends early on the creature if it takes any damage, if you have the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated) condition, or if you die.
...
You gain the [Ability Score Improvement](0.%20DM%20Screen/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Cleric levels 8, 12, and 16.
...
You can call on your deity or pantheon to intervene on your behalf. As a [Magic](0.%20DM%20Screen/actions.md#Magic) action, choose any Cleric spell of level 5 or lower that doesn't require a [Reaction](0.%20DM%20Screen/variant-rules/reaction-xphb.md) to cast. As part of the same action, you cast that spell without expending a spell slot or needing Material components. You can't use this feature again until you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).
...
When you cast a Cleric cantrip and deal damage to a creature with it, you can give vitality to yourself or another creature within 60 feet of yourself, granting a number of [Temporary Hit Points](0.%20DM%20Screen/variant-rules/temporary-hit-points-xphb.md) equal to twice your Wisdom modifier.
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Fate](0.%20DM%20Screen/feats/boon-of-fate-xphb.md) is recommended.
