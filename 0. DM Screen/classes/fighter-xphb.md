...
saving throws:
  - Strength
  - Constitution
proficiencies: [Acrobatics, Animal Handling, Athletics, History, Insight, Intimidation, Persuasion, Perception, Survival, Simple, Martial, Light, Medium, Heavy, Shields]
spellcasting: False
subclasses:
source:
  - XPHB
aliases:
  - Fighter
image: 0. DM Screen/classes/img/fighter.webp
tags: class
---
# Fighter
...
![](0.%20DM%20Screen/classes/img/fighter.webp)
...
- **Skill Proficiencies**: *Choose 2:* [Acrobatics](0.%20DM%20Screen/skills.md#Acrobatics), [Animal Handling](0.%20DM%20Screen/skills.md#Animal%20Handling), [Athletics](0.%20DM%20Screen/skills.md#Athletics), [History](0.%20DM%20Screen/skills.md#History), [Insight](0.%20DM%20Screen/skills.md#Insight), [Intimidation](0.%20DM%20Screen/skills.md#Intimidation), [Perception](0.%20DM%20Screen/skills.md#Perception), [Persuasion](0.%20DM%20Screen/skills.md#Persuasion), or [Survival](0.%20DM%20Screen/skills.md#Survival)
...
**Starting Equipment:** *Choose A, B, or C:* (A) [Chain Mail](chain-mail-xphb.md), [Greatsword](greatsword-xphb.md), [Flail](flail-xphb.md), 8 [Javelins](javelin-xphb.md), [Dungeoneer's Pack](dungeoneers-pack-xphb.md), and 4 GP; (B) [Studded Leather Armor](studded-leather-armor-xphb.md), [Scimitar](scimitar-xphb.md), [Shortsword](shortsword-xphb.md), [Longbow](longbow-xphb.md), [20 Arrows](arrows-20-xphb.md), [Quiver](quiver-xphb.md), [Dungeoneer's Pack](dungeoneers-pack-xphb.md), and 11 GP; or (C) 155 GP
...
![A Fighter stands between a...](0.%20DM%20Screen/classes/img/064-03-040-fighter-v-black-dragon.webp#center "A Fighter stands between an ally and the onslaught of a black dragon")
...
You have honed your martial prowess and gain a Fighting Style feat of your choice. [Defense](0.%20DM%20Screen/feats/defense-xphb.md) is recommended.

Whenever you gain a Fighter level, you can replace the feat you chose with a different Fighting Style feat.

### Second Wind (Level 1)

You have a limited well of physical and mental stamina that you can draw on. As a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md), you can use it to regain [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md) equal to `1d10` plus your Fighter level.

You can use this feature twice. You regain one expended use when you finish a [Short Rest](0.%20DM%20Screen/variant-rules/short-rest-xphb.md), and you regain all expended uses when you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).

When you reach certain Fighter levels, you gain more uses of this feature, as shown in the Second Wind column of the Fighter Features table.

### Weapon Mastery (Level 1)

Your training with weapons allows you to use the [mastery properties](0.%20DM%20Screen/variant-rules/weapon-mastery-properties-xphb.md) of three kinds of Simple or Martial weapons of your choice. Whenever you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md), you can practice weapon drills and change one of those weapon choices.

When you reach certain Fighter levels, you gain the ability to use the [mastery properties](0.%20DM%20Screen/variant-rules/weapon-mastery-properties-xphb.md) of more kinds of weapons, as shown in the [Weapon](0.%20DM%20Screen/variant-rules/weapon-xphb.md) Mastery column of the Fighter Features table.

### Action Surge (Level 2)

You can push yourself beyond your normal limits for a moment. On your turn, you can take one additional action, except the [Magic](0.%20DM%20Screen/actions.md#Magic) action.

Once you use this feature, you can't do so again until you finish a [Short](0.%20DM%20Screen/variant-rules/short-rest-xphb.md) or [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md). Starting at level 17, you can use it twice before a rest but only once on a turn.

### Tactical Mind (Level 2)

You have a mind for tactics on and off the battlefield. When you fail an ability check, you can expend a use of your Second Wind to push yourself toward success. Rather than regaining [Hit Points](0.%20DM%20Screen/variant-rules/hit-points-xphb.md), you roll `1d10` and add the number rolled to the ability check, potentially turning it into a success. If the check still fails, this use of Second Wind isn't expended.
...
You gain the [Ability Score Improvement](0.%20DM%20Screen/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Fighter levels 6, 8, 12, 14, and 16.
...
Whenever you activate your Second Wind with a [Bonus Action](0.%20DM%20Screen/variant-rules/bonus-action-xphb.md), you can move up to half your [Speed](0.%20DM%20Screen/variant-rules/speed-xphb.md) without provoking [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack).
...
If you fail a saving throw, you can reroll it with a bonus equal to your Fighter level. You must use the new roll, and you can't use this feature again until you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md).

You can use this feature twice before a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md) starting at level 13 and three times before a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md) starting at level 17.

### Tactical Master (Level 9)

When you attack with a weapon whose mastery property you can use, you can replace that property with the [Push](0.%20DM%20Screen/item-mastery.md#Push), [Sap](0.%20DM%20Screen/item-mastery.md#Sap), or [Slow](0.%20DM%20Screen/item-mastery.md#Slow) property for that attack.
...
You can attack three times instead of once whenever you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action on your turn.
...
You study your opponents and learn from each attack you make. If you make an attack roll against a creature and miss, you have [Advantage](0.%20DM%20Screen/variant-rules/advantage-xphb.md) on your next attack roll against that creature before the end of your next turn.
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Combat Prowess](0.%20DM%20Screen/feats/boon-of-combat-prowess-xphb.md) is recommended.

### Three Extra Attacks (Level 20)

You can attack four times instead of once whenever you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action on your turn.