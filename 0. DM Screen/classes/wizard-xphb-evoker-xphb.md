...
aliases:
  - Evoker
tags: subclass
image: 0. DM Screen/classes/img/evoker-wizard.webp
---
# Evoker
...
![](0.%20DM%20Screen/classes/img/evoker-wizard.webp#right)
...
The first time you do so, you suffer no adverse effect. If you use this feature again before you finish a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md), you take `2d12` Necrotic damage for each level of the spell slot immediately after you cast it. This damage ignores [Resistance](0.%20DM%20Screen/variant-rules/resistance-xphb.md) and [Immunity](0.%20DM%20Screen/variant-rules/immunity-xphb.md).

Each time you use this feature again before finishing a [Long Rest](0.%20DM%20Screen/variant-rules/long-rest-xphb.md), the Necrotic damage per spell level increases by `1d12`.