...
If you land in [difficult terrain](difficult-terrain-xphb.md), you must succeed on a DC 10 Dexterity ([Acrobatics](0.%20DM%20Screen/skills.md#Acrobatics)) check or have the [Prone](0.%20DM%20Screen/conditions.md#Prone) condition.

This Long Jump rule assumes that the height of the jump doesn't matter, such as a jump across a stream or chasm. At your DM's option, you must succeed on a DC 10 Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check to clear a low obstacle (no taller than a quarter of the jump's distance), such as a hedge or low wall. Otherwise, you hit the obstacle.