...
*Use this column for [Cylinders](0.%20DM%20Screen/variant-rules/cylinder-area-of-effect-xphb.md), [Emanations](0.%20DM%20Screen/variant-rules/emanation-area-of-effect-xphb.md) (using the size of the Emanation rather than its radius), and [Spheres](0.%20DM%20Screen/variant-rules/sphere-area-of-effect-xphb.md).
