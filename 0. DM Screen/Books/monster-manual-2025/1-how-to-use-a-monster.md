...
![](stat-block-overview.webp#center)
...
These entries list a monster's [Resistances](0.%20DM%20Screen/Variant-rules/resistance-xphb.md) and [Vulnerabilities](vulnerability-xphb.md), if any. See the "Player's Handbook" for more information.
