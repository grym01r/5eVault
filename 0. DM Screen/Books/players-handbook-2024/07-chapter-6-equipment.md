...
![In the skies of Eberron, t...](168-07-001-inventor-vi.webp#center "In the skies of Eberron, the inventor Vi and her Fixers escape the Lord of Blades and a plummeting airship that burns with green flame!")
...
![Simple Melee Weapons](169-07-058-simple-melee.webp#center)

![Simple Ranged Weapons](170-07-059-simple-range.webp#center)

![Martial Melee Weapons](171-07-061-martial-melee.webp#center)

![Martial Ranged Weapons](172-07-060-martial-range.webp#center)
...
- **Stealth.** If the table shows "Disadvantage" in the Stealth column for an armor type, the wearer has [Disadvantage](disadvantage-xphb.md) on Dexterity ([Stealth](0.%20DM%20Screen/skills.md#Stealth)) checks.  

![Armor](armor-xphb.md)

![Light Armor and Shields](173-07-062-light-armor-and-shields.webp#center)

![Medium Armor](174-07-063-medium-armor.webp#center)

![Heavy Armor](175-07-064-heavy-armor.webp#center)
...
- **Ability.** Dexterity  
- **Weight.** 5 lb.  
- **Utilize.** Modify footwear to give [Advantage](advantage-xphb.md) on the wearer's next Dexterity ([Acrobatics](0.%20DM%20Screen/skills.md#Acrobatics)) check (DC 10)  
...
![A Warlock channels magic through an Arcane Focus](177-07-003-arcane-focus.webp#center)
...
As a Bonus Action, you can drink a vial of Antitoxin to gain [Advantage](advantage-xphb.md) on saving throws to avoid or end the [Poisoned](0.%20DM%20Screen/conditions.md#Poisoned) condition for 1 hour.
...
![Lamp and Net](178-07-004-lamp-net.webp#center)
...
Perfume comes in a 4-ounce vial. For 1 hour after applying Perfume to yourself, you have [Advantage](advantage-xphb.md) on Charisma ([Persuasion](0.%20DM%20Screen/skills.md#Persuasion)) checks made to influence an [Indifferent](indifferent-attitude-xphb.md) Humanoid within 5 feet of yourself.
...
A Pole is 10 feet long. You can use it to touch something up to 10 feet away. If you must make a Strength ([Athletics](0.%20DM%20Screen/skills.md#Athletics)) check as part of a [High](high-jump-xphb.md) or [Long Jump](long-jump-xphb.md), you can use the Pole to vault, giving yourself [Advantage](advantage-xphb.md) on the check.
...
A Torch burns for 1 hour, casting [Bright Light](bright-light-xphb.md) in a 20-foot radius and [Dim Light](dim-light-xphb.md) for an additional 20 feet. When you take the [Attack](0.%20DM%20Screen/actions.md#Attack) action, you can attack with the Torch, using it as a Simple Melee weapon. On a hit, the target takes 1 Fire damage.

### Vial (1 GP)

A Vial holds up to 4 ounces.

![](179-07-005-adventurer-with-tools.webp#center)
...
![A Wizard and her familiar ...](180-07-006-wizard-familiar-shopping.webp#center "A Wizard and her familiar spend an afternoon shopping")
