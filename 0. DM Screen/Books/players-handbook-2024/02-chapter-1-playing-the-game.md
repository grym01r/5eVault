...
![While adventuring in the D...](000-01-013-opening-art.webp#center "While adventuring in the Dragonlance setting, the siblings Caramon Majere, Raistlin Majere, and Kitiara uth Matar provoke the rage of a wyvern")
...
![From left to right: `D4`, ...](001-01-002-dice.webp#center "From left to right: `D4`, `D6`, `D8`, `D10` (ones digit), `D10` (tens digit), `D12`, `D20`")
...
![A D20 Test can result in a...](002-01-003-d20-test.webp#center "A D20 Test can result in a dramatic success, a simple accomplishment, or a catastrophe")
...
![If you have Advantage, use...](003-01-004-advantage-disadvantage.webp#center "If you have Advantage, use the 18 If you have Disadvantage, use the 3")
...
![Characters lay on the char...](004-01-005-adventurers-bartering.webp#center "Characters lay on the charm while bartering for magic items with a green hag")
...
![](005-01-006-social-interaction-example.webp#center)
...
> 
> Gareth takes the [Influence](0.%20DM%20Screen/actions.md#Influence) action, which characters can take to influence an NPC. It's easier to influence an NPC who's already disposed to help you, as Ismark is here. Ismark's [Friendly](friendly-attitude-xphb.md) attitude gives Phillip Advantage on the roll. In this case, [Advantage](advantage-xphb.md) made the difference between success and failure.
^2-influencing-npcs
...
![](006-01-007-obscured-exploration.webp#center)
...
An area might be Lightly or Heavily Obscured. In a Lightly Obscured area—such as an area with Dim Light, patchy fog, or moderate foliage—you have [Disadvantage](disadvantage-xphb.md) on Wisdom ([Perception](0.%20DM%20Screen/skills.md#Perception)) checks that rely on sight.
...
Traveling at a Fast pace imposes [Disadvantage](disadvantage-xphb.md) on a traveler's Wisdom ([Perception](0.%20DM%20Screen/skills.md#Perception) or [Survival](0.%20DM%20Screen/skills.md#Survival)) and Dexterity ([Stealth](0.%20DM%20Screen/skills.md#Stealth)) checks.

##### Normal

Traveling at a Normal pace imposes [Disadvantage](disadvantage-xphb.md) on Dexterity ([Stealth](0.%20DM%20Screen/skills.md#Stealth)) checks.

##### Slow

Traveling at a Slow pace grants [Advantage](advantage-xphb.md) on Wisdom ([Perception](0.%20DM%20Screen/skills.md#Perception) or [Survival](0.%20DM%20Screen/skills.md#Survival)) checks.
...
![](007-01-008-exploration-example.webp#center)
...
![](008-01-009-adventurers-in-combat.webp#center)
...
![Creatures occupy spaces of...](009-01-010-displacer-beast-combat.webp#center "Creatures occupy spaces of varying sizes. This Displacer Beast occupies a 10-by-10-foot space, while the adventurers occupy 5-by-5-foot spaces")
...
- **Determine Modifiers.** The DM determines whether the target has [Cover](0.%20DM%20Screen/Variant-rules/cover-xphb.md) (see the next section) and whether you have [Advantage](advantage-xphb.md) or [Disadvantage](disadvantage-xphb.md) against the target. In addition, spells, special abilities, and other effects can apply penalties or bonuses to your attack roll.  
...
Aiming a ranged attack is more difficult when a foe is next to you. When you make a ranged attack roll with a weapon, a spell, or some other means, you have [Disadvantage](disadvantage-xphb.md) on the roll if you are within 5 feet of an enemy who can see you and doesn't have the [Incapacitated](0.%20DM%20Screen/conditions.md#Incapacitated) condition.
...
![Astride a giant seahorse, ...](010-01-011-giant-seahorse-mount.webp#center "Astride a giant seahorse, a paladin adventures underwater")
...
If you reach 0 Hit Points and don't die instantly, you have the [Unconscious](0.%20DM%20Screen/conditions.md#Unconscious) condition until you regain any Hit Points, and you now face making [Death Saving Throws](death-saving-throw-xphb.md) (see below).

> [!note] Knocking Out a Creature
> 
> When you would reduce a creature to 0 Hit Points with a melee attack, you can instead reduce the creature to 1 Hit Point and give it the [Unconscious](0.%20DM%20Screen/conditions.md#Unconscious) condition. It then starts a [Short Rest](short-rest-xphb.md), at the end of which that condition ends on it. The condition ends early if the creature regains any Hit Points or if someone takes an action to administer first aid to it, making a successful DC 10 Wisdom ([Medicine](0.%20DM%20Screen/skills.md#Medicine)) check.
...
> 
> Spells and many other effects in the game fill a specific area that is defined by the rules, like the 15-foot [Cube](cube-area-of-effect-xphb.md) of the [Thunderwave](thunderwave-xphb.md) spell. See the "rules glossary" for more on areas of effect.
^15-areas-of-effect
...
![](011-01-012-combat-example.webp#center)