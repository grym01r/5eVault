...
See also: [Two-Weapon Fighting](0.%20DM%20Screen/actions.md#Two-Weapon%20Fighting)
...
If an item requires an action to activate, that action isn't a function of the [[#Utilize]] action.
...
Some magic items allow the user to cast a spell from the item, often by expending charges from it. The spell is cast at the lowest possible spell and caster level, doesn't expend any of the user's spell slots, and requires no components unless the item's description says otherwise. The spell uses its normal casting time, range, and duration, and the user of the item must concentrate if the spell requires [concentration](0.%20DM%20Screen/conditions.md#Concentration). Certain items make exceptions to these rules, changing the casting time, duration, or other parts of a spell.
...
Attacker makes attack roll contested by target's [[Skills#Athletics|Athletics (Strength)]] or [[Skills#Acrobatics|Acrobatics (Dexterity)]]  check. If successful, no damage, but target drops weapon or item to the ground. Attacker has disadvantage if target item is held with two hands. Target has advantage if larger than attacker, or disadvantage if smaller.
...
If you take the Disengage action, your movement doesn't provoke [Opportunity Attacks](0.%20DM%20Screen/actions.md#Opportunity%20Attack) for the rest of the current turn.
...
|---------------|-------------|
| Charisma ([Deception](0.%20DM%20Screen/skills.md#Deception)) | Deceiving a monster that understands you |
| Charisma ([Intimidation](0.%20DM%20Screen/skills.md#Intimidation)) | Intimidating a monster |
| Charisma ([Performance](0.%20DM%20Screen/skills.md#Performance)) | Amusing a monster |
| Charisma ([Persuasion](0.%20DM%20Screen/skills.md#Persuasion)) | Persuading a monster that understands you |
| Wisdom ([Animal Handling](0.%20DM%20Screen/skills.md#Animal%20Handling)) | Gently coaxing a Beast or Monstrosity |
^influence-checks
...
If you cast a spell that has a casting time of 1 minute or longer, you must take the Magic action on each turn of that casting, and you must maintain [Concentration](0.%20DM%20Screen/conditions.md#Concentration) while you do so. If your [Concentration](0.%20DM%20Screen/conditions.md#Concentration) is broken, the spell fails, but you don't expend a spell slot.
...
- **Duration:** 1 action or bonus action
...
|-------|-----------------|
| [Insight](0.%20DM%20Screen/skills.md#Insight) | Creature's state of mind |
| [Medicine](0.%20DM%20Screen/skills.md#Medicine) | Creature's ailment or cause of death |
| [Perception](0.%20DM%20Screen/skills.md#Perception) | Concealed creature or object |
| [Survival](0.%20DM%20Screen/skills.md#Survival) | Tracks or food |
^search
...
| Skill | Areas |
|-------|-------|
| [Arcana](0.%20DM%20Screen/skills.md#Arcana) | Spells, magic items, eldritch symbols, magical traditions, planes of existence, and certain creatures (Aberrations, Constructs, Elementals, Fey, and Monstrosities) |
| [History](0.%20DM%20Screen/skills.md#History) | Historic events and people, ancient civilizations, wars, and certain creatures (Giants and Humanoids) |
| [Investigation](0.%20DM%20Screen/skills.md#Investigation) | Traps, ciphers, riddles, and gadgetry |
| [Nature](0.%20DM%20Screen/skills.md#Nature) | Terrain, flora, weather, and certain creatures (Beasts, Dragons, Oozes, and Plants) |
| [Religion](0.%20DM%20Screen/skills.md#Religion) | Deities, religious hierarchies and rites, holy symbols, cults, and certain creatures (Celestials, Fiends, and Undead) |
^areas-of-knowledge
...
## Tumble
_Dungeon Masters Guide (2014), page 272_
...
You normally interact with an object while doing something else, such as when you draw a sword as part of the [Attack](0.%20DM%20Screen/actions.md#Attack) action. When an object requires an action for its use, you take the Utilize action.
