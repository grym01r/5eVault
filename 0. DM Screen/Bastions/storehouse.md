...
A Storehouse is a cool, dark space meant to contain trade goods objects from the "[Trade Goods](trade-goods-xdmg.md)" table in "chapter 7" and from "chapter 6" of the "Player's Handbook".
