...
> [!NOTE|div-m] Parent Location: `INPUT[inlineListSuggester(optionQuery(#Hub),optionQuery(#Region),optionQuery(#Place),optionQuery(#PointofInterest)):Container]`
...
const excludedRarities = ["artifact", "legendary", "very rare", "rare"];
